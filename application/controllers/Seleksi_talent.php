...
class Seleksi_talent extends CI_Controller {
	public $user_id;
	...
	public function index($summary_field='',$summary_value='')
	{
		if ($this->user_id)
		{
			...
			$data['title']		= "Seleksi Calon Talent - Admin ";
			$data['content']	= "seleksi_talent/index" ;
	...
	public function data()
	{
		if ($this->user_id)
		{
			$data['title']		= "Data Calon Talent";
			$data['content']	= "seleksi_talent/data" ;
			$data['user_picture'] = $this->user_picture;
			$data['foto_pegawai'] = $this->foto_pegawai;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['user_id'] = $this->id_pegawai;
			$data['active_menu'] = "seleksi_talent";
	...
	public function add()
	{
		if ($this->user_id)
		{
			...
			$data['content']	= "seleksi_talent/add" ;
			$data['user_picture'] = $this->user_picture;
			$data['foto_pegawai'] = $this->foto_pegawai;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
	...
	public function detail_talent()
	{
		if ($this->user_id)
		{
			...
			$data['content']	= "seleksi_talent/detail_talent" ;
			$data['user_picture'] = $this->user_picture;
			$data['foto_pegawai'] = $this->foto_pegawai;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
	...
	public function status()
	{
		if ($this->user_id)
		{
			$data['title']		= "Status Seleksi Talent";
			$data['content']	= "seleksi_talent/status" ;
			$data['user_picture'] = $this->user_picture;
			$data['foto_pegawai'] = $this->foto_pegawai;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
	...
	public function peringkat()
	{
		if ($this->user_id)
		{
			$data['title']		= "Peringkat Hasil Seleksi";
			$data['content']	= "seleksi_talent/peringkat" ;
			$data['user_picture'] = $this->user_picture;
			$data['foto_pegawai'] = $this->foto_pegawai;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
