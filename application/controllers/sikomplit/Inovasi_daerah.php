...
class Inovasi_daerah extends CI_Controller
{
	...
	public function __construct()
	{
		...
		$this->load->model('inovasi_daerah_model', 'iim');
	...
	public function index()
	{
		if ($this->user_id) {
			...
			$data['content']	= "inovasi_daerah/index";
	...
	public function add()
	{
		if ($this->user_id) {
			...
			$data['content']	= "inovasi_daerah/add";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "inovasi_daerah";
	...
	public function edit($id)
	{
		if ($this->user_id) {
			...
			$data['content']	= "inovasi_daerah/edit";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "inovasi_daerah";
	...
	public function indikator($id)
	{
		if ($this->user_id) {
			...
			$data['content']	= "inovasi_daerah/indikator";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "inovasi_daerah";
	...
	public function detail($id)
	{
		if ($this->user_id) {
			...
			$data['content']	= "inovasi_daerah/detail";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "inovasi_daerah";
