...
class Parameter_penilaian_indeks_inovasi extends CI_Controller 
{
	...
	public function index()
	{
		if ($this->user_id)
		{
			...
			$data['content']	= "sikomplit/parameter_penilaian_indeks_inovasi/index" ;
	...
	public function add()
	{
		if ($this->user_id)
		{
			...
			$data['content']	= "sikomplit/parameter_penilaian_indeks_inovasi/add" ;
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "parameter_penilaian_indeks_inovasi";
	...
	public function edit($id)
	{
		if ($this->user_id)
		{
			...
			$data['content']	= "sikomplit/parameter_penilaian_indeks_inovasi/edit" ;
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "parameter_penilaian_indeks_inovasi";
	...
	public function detail($id)
	{
		if ($this->user_id) {
			...
			$data['content']	= "sikomplit/parameter_penilaian_indeks_inovasi/detail" ;
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "parameter_penilaian_indeks_inovasi";
