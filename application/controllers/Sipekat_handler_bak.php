...
class Sipekat_handler_bak extends CI_Controller
{
    public $user_id;
    ...
    function tes()
    {
        ...
        var_dump(file_put_contents('data/sipekat/tmp/' . $file, "Test 1"));
//file_get_contents('https://sipekat.sumedangkab.go.id/data/template_dokumen/tmp/' . $file)));
    }
