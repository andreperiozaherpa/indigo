	...
	public function tambah()
	{
		if ($this->user_id) {
			...
			if (!empty($_POST)) {
				...
				if (!$this->upload->do_upload('renstra')) {
					$_POST['renstra'] = "";
				} else {
					$_POST['renstra'] = $this->upload->data('file_name');
				}

				if (!$this->upload->do_upload('rkt')) {
					$_POST['rkt'] = "";
				} else {
					$_POST['rkt'] = $this->upload->data('file_name');
				}

				if (!$this->upload->do_upload('pk')) {
					$_POST['pk'] = "";
				} else {
					$_POST['pk'] = $this->upload->data('file_name');
				}

				if (!$this->upload->do_upload('lkj')) {
					$_POST['lkj'] = "";
				} else {
					$_POST['lkj'] = $this->upload->data('file_name');
				}
	...
	public function upload_berkas($id, $col)
	{
		if ($this->user_id) {
			...
			if (!$this->upload->do_upload('userfile')) {
				...
				$_POST[$col] = $this->upload->data('file_name');
			}
