...
class Program extends CI_Controller
{
	...
	public function save()
    {
        if($this->input->is_ajax_request()  )
        {
            if($_POST)
            {
                ...
                {
                    $id_program_rpjmd = null;// $post_data['id_program_rpjmd'];
					$dt = array(
					...
					if($this->input->post("action")=="edit"){
                        ...
                        $id_program_rpjmd = $this->db->insert_id();
                    ...
                    if($id_program_rpjmd)
                    {
                        $this->db->where("id_program_rpjmd",$id_program_rpjmd)->delete("sc_rpjmd_program_sasaran_indikator");
                        $ids_indikator_sasaran_rpjmd = explode(",", $post_data['ids_indikator_sasaran_rpjmd']);
                        foreach($ids_indikator_sasaran_rpjmd as $key => $value)
                        {
                            $this->db
                            ->set("id_program_rpjmd",$id_program_rpjmd)
                            ->set("id_indikator_sasaran_rpjmd",$value)
                            ->insert("sc_rpjmd_program_sasaran_indikator");
                        }
                    }
                }
                else{
	...
	public function detail($token = null)
	{
        ...
        if(!$token || !$detail)
        {
            ...
            $param_['where']['id_program_rpjmd'] = $detail->id_program_rpjmd;
            $sasaran_ = $this->Program_model->get_sasaran_indikator($param_)->result();
            $nama_indikator_sasaran_rpjmd = "";
            $ids_indikator_sasaran_rpjmd = array();
            foreach($sasaran_ as $row)
            {
                $nama_indikator_sasaran_rpjmd .= "- ". $row->nama_indikator_sasaran_rpjmd."<br>";
                $ids_indikator_sasaran_rpjmd[] = $row->id_indikator_sasaran_rpjmd;
            }
            $detail->nama_indikator_sasaran_rpjmd = $nama_indikator_sasaran_rpjmd;
            $detail->ids_indikator_sasaran_rpjmd = $ids_indikator_sasaran_rpjmd;
        }
        ...
        $data['dt_skpd'] = $this->db->where_in("jenis_skpd",["skpd","kecamatan"])->get("ref_skpd")->result();
        ...
        $param_indikator['where']['indikator.id_program_rpjmd'] = $detail->id_program_rpjmd;
        $param_indikator['str_where'] = "(indikator.sumber_pagu is null OR indikator.sumber_pagu='0')";
		$data['dt_indikator'] = $this->Program_indikator_model->get($param_indikator)->result();

        //echo "<pre>";print_r($data['dt_indikator']);die;
