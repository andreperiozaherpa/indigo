                ...
                if($dt_tujuan->num_rows()==0)
                {
                    ...
                    foreach($dt_tujuan->result() as $k => $row){
                        ...
                        if($dt_indikator->num_rows()==0)
                        {
                            ...
                            {
                                $row_tahun = '';
                                foreach($dt_tahun as $t0 =>$t2)
                                {
                                    $target_tahun = 'target_tahun_'.($t0+1);
                                    $row_tahun .= '<td>'.$ind->$target_tahun.'</td>';
                                }
                                $indikator .= '
                                <tr>
                                    ...
                                    '.$row_tahun.'
                                    <td>'.$ind->target_akhir.'</td>
                                    <td>'.$ind->satuan_desc.'</td>
