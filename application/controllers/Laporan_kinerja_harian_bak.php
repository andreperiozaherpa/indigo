        ...
        if ($this->user_id) {
            ...
            if (!empty($_POST)) {
                ...
                if ($type == 'add') {
                    ...
                    // die;
                    // }
                    if (($tanggal <= $cut_off) && $id_skpd != 16) {
                        $data['message'] =  'Pengisian LKH hanya bisa dilakukan maksimal 3 hari kebelakang';
                        ...
                        if (!$error_upload) {
                            ...
                            if ($insert) {
					            ...
					            redirect("laporan_kinerja_harian");
            ...
            if ($this->user_level != 'Administrator') {
                ...
                if (!empty($atasan)) {
                    ...
                    if ($this->session->userdata('kepala_skpd') == "Y" && $pegawai->jabatan != 'Sekretaris Daerah') {
                        ...
                        $data['pegawai'][0] = $this->master_pegawai_model->get_by_id(77);
                    } else {
