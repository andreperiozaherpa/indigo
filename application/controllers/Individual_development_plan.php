...
class Individual_development_plan extends CI_Controller {
	public $user_id;
	...
	public function index($summary_field='',$summary_value='')
	{
		if ($this->user_id)
		{
			...
			$data['title']		= "Individual Development Plan - Admin ";
			$data['content']	= "individual_development_plan/index" ;
	...
	public function add()
	{
		if ($this->user_id)
		{
			$data['title']		= "Formulir IDP";
			$data['content']	= "individual_development_plan/add" ;
			$data['user_picture'] = $this->user_picture;
