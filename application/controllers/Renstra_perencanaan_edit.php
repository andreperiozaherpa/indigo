...
class Renstra_perencanaan_edit extends CI_Controller {
	public $user_id;
	...
	public function view($id_skpd)
	{
		if ($this->user_id)
		{
			...
			$data['content']	= "renstra/perencanaan/view_edit" ;
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
	...
	function get_iku_ss_by_unit_kerja($id=null)
	{
		...
		$data['iku_ss_renstra'] = $this->renstra_perencanaan_model->get_iku_ss_by_unit_kerja($id);
	...
	function get_iku_sp_by_unit_kerja($id=null)
	{
		...
		$data['iku_sp_renstra'] = $this->renstra_perencanaan_model->get_iku_sp_by_unit_kerja($id);
		echo '<option value="">Pilih Sasaran</option>';
	...
	function get_iku_sk_by_unit_kerja($id=null)
	{
		...
		$data['iku_sk_renstra'] = $this->renstra_perencanaan_model->get_iku_sk_by_unit_kerja($id);
		echo '<option value="">Pilih Sasaran</option>';
	...
	public function detail($jenis_s,$id_ss,$id_iku)
	{
		if ($this->user_id)
		{
	...
	public function edit($jenis_s,$id_ss,$id_iku)
	{
		if ($this->user_id)
		{
			...
			$data['unit_kerja'] = $this->renstra_perencanaan_model->get_unit_kerja_by_id_skpd($data['detail']->id_skpd);
