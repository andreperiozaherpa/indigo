...
class Skp_perencanaan extends CI_Controller
{
	public $user_id;
	public $id_skpd;
	...
	public function index()
	{
		if ($this->user_id) {
			...
			if ($this->user_level != "Operator" AND $this->user_level != "Administrator") {
				...
				$data['title']		= "SKP Perencanaan - Admin ";
				$data['content']	= "skp_perencanaan/list";
				$data['user_picture'] = $this->user_picture;
				$data['full_name']		= $this->full_name;
				$data['user_level']		= $this->user_level;
				$data['active_menu']		= 'Skp_perencanaan';
	...
	public function pegawai($id_pegawai)
	{
		if ($this->user_id) {
			$data['title']		= "SKP Perencanaan - Admin ";
			$data['content']	= "skp_perencanaan/index";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "Skp_perencanaan";
	...
	public function detail($tahun)
	{
		if ($this->user_id) {
			$data['title']		= "SKP Perencanaan - Admin ";
			$data['content']	= "skp_perencanaan/detail";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "Skp_perencanaan";
	...
	public function detail_bulanan($tahun)
	{
		if ($this->user_id) {
			$data['title']		= "SKP Perencanaan - Admin ";
			$data['content']	= "skp_perencanaan/detail_bulanan";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "Skp_perencanaan";
	...
	public function cetak($tahun,$penilaian=false)
	{
		if ($this->user_id) {
			$data['title']		= "SKP Perencanaan - Admin ";
			$data['content']	= "skp_perencanaan/cetak";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "Skp_perencanaan";
			...
			if ($penilaian) {
				$this->load->view('admin/skp_perencanaan/cetak_penilaian', $data);
			} else {
				$this->load->view('admin/skp_perencanaan/cetak', $data);
			}
		} else {
			redirect('admin');
		}
	...
	public function kesenjangan_kinerja($tahun)
	{
		if ($this->user_id) {
			$data['title']		= "SKP Perencanaan - Admin ";
			$data['content']	= "skp_perencanaan/kesenjangan_kinerja";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "Skp_perencanaan";
	...
	public function cetak_bulanan($tahun,$bulan,$penilaian=false)
	{
		if ($this->user_id) {
			$data['title']		= "SKP Perencanaan - Admin ";
			$data['content']	= "skp_perencanaan/cetak_bulanan";
			$data['user_picture'] = $this->user_picture;
			$data['full_name']		= $this->full_name;
			$data['user_level']		= $this->user_level;
			$data['active_menu'] = "Skp_perencanaan";
			...
			if ($penilaian) {
				$this->load->view('admin/skp_perencanaan/cetak_penilaian_bulanan', $data);
			} else {
				$this->load->view('admin/skp_perencanaan/cetak_bulanan', $data);
			}
		} else {
			redirect('admin');
		}
	...
	{
		$data['title']		= "SKP Perencanaan - Admin ";
		$data['content']	= "skp_perencanaan/detail_pegawai";
		$data['user_picture'] = $this->user_picture;
		$data['full_name']		= $this->full_name;
		$data['user_level']		= $this->user_level;
		$data['active_menu'] = "Skp_perencanaan";
