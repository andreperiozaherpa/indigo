...
class Lembar_kerja_evaluasi extends CI_Controller
{
    ...
    public function setting_zi()
    {
        if ($this->user_id) {
            ...
            $id_skpd = $this->session->userdata('id_skpd');
            $id_pegawai = $this->session->userdata('id_pegawai');
            $data['pokja'] = $this->lembar_kerja_evaluasi_model->get_pokja_filter($tahun, $id_skpd, $jenis_lke)->result();
            $data['indikator'] = $this->lembar_kerja_evaluasi_model->get_lke_indikator($jenis_lke)->result();
            $data['pegawai'] = $this->lembar_kerja_evaluasi_model->get_pegawai($id_skpd)->result();
            $tahun = date('Y');
            $data['tahun'] = $tahun;
            $this->load->view('admin/index', $data);
        } else {
    ...
    public function setting_rb()
    {
        if ($this->user_id) {
            $data['nama'] = 'SETTING RB';
            $data['title']        = "Laporan Kerja Evaluasi - " . $data['nama'];
            $data['content']    = "lembar_kerja_evaluasi/setting_pengisi_lke_rb";
            $data['user_picture'] = $this->user_picture;
            $data['full_name']        = $this->full_name;
            $data['user_level']        = $this->user_level;
            $data['active_menu'] = "lembar_kerja_evaluasi";
    ...
    public function pokja_filter_zi()
    {
        $tahun = $this->input->post('tahun');
        $data['tahun'] = $tahun;
        if ($this->user_id) {
            ...
            $jenis_lke ="zi_wbk";
            $data['pokja'] = $this->lembar_kerja_evaluasi_model->get_pokja_filter($tahun, $id_skpd, $jenis_lke)->result();
            $data['indikator'] = $this->lembar_kerja_evaluasi_model->get_lke_indikator_filter($tahun, $jenis_lke)->result();
            $data['pegawai'] = $this->lembar_kerja_evaluasi_model->get_pegawai($id_skpd)->result();
            $this->load->view('admin/index', $data);
        } else {
            redirect('admin');
    ...
    public function pokja_filter_rb()
    {
        $tahun = $this->input->post('tahun');
        $data['tahun'] = $tahun;
        if ($this->user_id) {
    ...
    public function verifikasi_atasan($jenis_lke = '')
    {
        if (!empty($jenis_lke)) {
            $data['nama'] = $jenis_lke == 'rb' ? 'Reformasi Birokrasi' : 'ZI-WBK';
            $data['title']        = "Koreksi Laporan Kerja Evaluasi - " . $data['nama'];
            $data['content']    = "lembar_kerja_evaluasi/verifikasi_atasan";
            $data['user_picture'] = $this->user_picture;
            $data['full_name']        = $this->full_name;
            $data['user_level']        = $this->user_level;
            $data['active_menu'] = "lembar_kerja_evaluasi";
            ...
            $level = $this->user_level;
            if ($level == "User") {
                $data['list'] = $this->lembar_kerja_evaluasi_model->skpd_ref_by_id($id_skpd)->result();
            }elseif($level == "Administrator") {
                $data['list'] = $this->lembar_kerja_evaluasi_model->skpd_ref()->result();
            }
    ...
    public function verifikasi_atasan_detail($jenis_lke, $id_skpd, $tahun)
    {
        if ($this->user_id) {
            $data['nama'] = $jenis_lke == 'rb' ? 'Reformasi Birokrasi' : 'ZI-WBK';
            $data['title']        = "Laporan Kerja Evaluasi - " . $data['nama'];
            $data['content']    = "lembar_kerja_evaluasi/verifikasi_atasan_detail";
            $data['user_picture'] = $this->user_picture;
            $data['full_name']        = $this->full_name;
            $data['user_level']        = $this->user_level;
            $data['active_menu'] = "lembar_kerja_evaluasi";
    ...
    function verifikasi_atasan_proses()
	{

		$jenis_pengisi = "skpd";
		$tanggal_buka = "2022-01-01 00:00:00";
        $tanggal_tutup = date("Y-m-d");
        $tahun = $this->input->post('id_skpd');
        $status = "sudah_verifikasi";
        $id_skpd = $this->input->post('id_skpd');
        $id_lke_pengaturan = $this->input->post('id_lke_pengaturan');
        $jenis_lke = $this->input->post('jenis_lke');

		$data = array(
			'jenis_pengisi' => $jenis_pengisi,
        ...
        $where = array(
            'id_lke_pengaturan' => $id_lke_pengaturan,
            
        );

        $this->lembar_kerja_evaluasi_model->update_data($where, $data, 'lke_pengaturan');
        

		//$this->lembar_kerja_evaluasi_model->input_data($data, 'lke_pengaturan');

		redirect('lembar_kerja_evaluasi/verifikasi_atasan/'.$jenis_lke);
	}
