...
class Surat_internal extends CI_Controller
{
	...
	public function index()
	{
		if ($this->user_id) {
			...
			// $data['content']	= "naskah/surat_internal/masuk/index" ;
	...
	public function detail_surat_masuk($id, $testing = "")
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/masuk/detail";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
	...
	public function tambah_surat_masuk()
	{
		if ($this->user_id) {
			$data['title'] = "Surat internal";
			$data['content'] = "naskah/surat_internal/masuk/add";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
			$data['active_menu'] = "surat_internal";
	...
	public function surat_keluar($summary_field = '', $summary_value = '')
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/keluar/index";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
			$data['active_menu'] = "surat_internal";
	...
	public function kategori_surat_keluar()
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/keluar/kategori";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
	...
	public function tambah_surat_keluar($id_ref_surat, $testing = 0)
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/keluar/add";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
			...
			if (!empty($_POST)) {
				...
				$not_required = array('_wysihtml5_mode', 'draft', 'download', 'tembusan_surat', 'lampiran_surat', 'jenis_sasaran_tautan', 'id_sasaran_tautan', 'id_unit_kerja_tautan', 'id_iku_tautan', 'id_renaksi_tautan', 'check_tautan', 'nomer_surat_lengkap');
				...
				if ($cekform) {
					...
					//					$template->setValue('nomer_surat', $sk->nomer_surat_lengkap);
					...
					if ($id_ref_surat == 903 && isset($_POST['id_kerja_luar_kantor'])) {
						...
						$template->setValue('nomor_surat', $sk->nomer_surat_lengkap);
					...
					$data['type'] = 'success';
					$data['messages'] = '<i class="ti-check"></i> Surat Keluar berhasil ditambahkan, klik <a style="color:#fff;font-weight:bold" target="blank" href="' . base_url('naskah/surat_internal/detail_surat_keluar/' . $in) . '">disini</a> untuk melihat detail surat.';
			...
			$d_pegawai2 = $this->master_pegawai_model->get_by_id_skpd($id_skpd, true);
			//			$data['pegawai'] = array_merge($d_pegawai1, $d_pegawai2);
			$data['pegawai'] = $d_pegawai1;
...
//			$data['pegawai_tembusan'] = $this->master_pegawai_model->get_by_id_skpd(33, true);
			$data['pegawai1'] = $this->master_pegawai_model->get_by_id(10848);
			$data['pegawai_tembusan'] = $this->master_pegawai_model->get_by_id_skpd(1206, true);
	...
	public function edit_surat_keluar($id_ref_surat, $id_surat_keluar)
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/keluar/edit";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
			...
			if (!empty($_POST)) {
				$not_required = array('_wysihtml5_mode', 'draft', 'download', 'tembusan_surat', 'nomer_surat_lengkap');
				$cekform = isFormEmpty($not_required, $_POST);
				if ($cekform) {
					$data['type'] = 'warning';
					$data['messages'] = 'Ada form yang belum diisi';
	...
	public function detail_surat_keluar($id_surat_keluar)
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/keluar/detail";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
	...
	public function verifikasi_surat($summary_field = '', $summary_value = '')
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/verifikasi/index";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
	...
	public function verifikasi_surat_detail($id_surat_keluar, $testing = "")
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/verifikasi/detail";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
			$data['active_menu'] = "surat internal";
	...
	public function tanda_tangan($summary_field = '', $summary_value = '')
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/tanda_tangan/index";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
	...
	public function tanda_tangan_detail($id_surat_keluar, $testing = "")
	{
		if ($this->user_id) {
			...
			$data['content'] = "naskah/surat_internal/tanda_tangan/detail";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
			$data['active_menu'] = "surat internal";
...
//            );
			...
			if (!empty($_POST)) {
				if (isset($_POST['terima'])) {
					...
					if (!$ttd['error']) {
						...
						// edited by Dinar
						// set condition for get last nomor_urut
						$where = array(
							//                            'jenis_surat'       => $data['detail']->jenis_surat,
							'tipe_kendali' => 'keluar',
							'skpd' => $data['detail']->id_skpd,
						...
						$update = $this->kartu_kendali->update_entry($kartu_kendali_data, $kartu_kendali_id);
						// end edit Dinar
	...
	public function kendali_masuk()
	{
		if ($this->user_id) {
			$data['title'] = "Kartu Kendali Naskah Masuk - Internal ";
			$data['content'] = "surat_internal/kendali";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
			$data['active_menu'] = "surat_internal/kendali_keluar";
			$data['type'] = "Masuk";

			$where = array(
				'status_register' => 'Y',
				'id_skpd_pengirim' => $this->session->userdata('id_skpd')
			);
			$data['letters'] = $this->surat_keluar->get_all_wheres($where);
	...
	public function kendali_keluar()
	{
		if ($this->user_id) {
			$data['title'] = "Kartu Kendali Naskah Keluar - Internal ";
			$data['content'] = "naskah/surat_internal/kendali";
			$data['user_picture'] = $this->user_picture;
			$data['full_name'] = $this->full_name;
			$data['user_level'] = $this->user_level;
			$data['active_menu'] = "surat_internal/kendali_keluar";
			...
			$data['letters'] = $this->surat_keluar_model->get_all_wheres($where, 0);
			echo json_encode($data);
			die;
	...
	public function get_kendali()
	{
		$jenis_surat = $this->input->post('jenisSurat');
		$type = $this->input->post('type'); // masuk / keluar
		...
		// grab data
		if ($type == "masuk") {
			// get data from surat_masuk

		} else {
			// get data from surat_keluar
