...
class HTMLtoOpenXML {
	...
	/**
	 * public constructor of singleton.
	 */
	...
	public function getOpenXML($text) {
		$text = "<w:p><w:r><w:t>$text</w:t></w:r></w:p>";
		return $text;
	}
	
	public function processListStyle($input) {
