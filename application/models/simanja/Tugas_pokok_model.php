...
class Tugas_pokok_model extends CI_Model
{
	...
	{
		$this->db->order_by('simanja_tugas_pokok.created_at','DESC');
		$query = $this->db->get('simanja_tugas_pokok');
		return $query->result();
	}

	public function get_by_id($id){
		return $this->db->get_where('simanja_tugas_pokok',array('id'=>$id))->row();
	}

	public function get_by_id_skpd($id_skpd){
		return $this->db->get_where('simanja_tugas_pokok',array('id_skpd'=>$id_skpd))->result();
	}
	...
	public function delete_ref($id = NULL)
	{
		...
		// redirect('tugas_pokok');
	}

	public function cek($data){
		$q = $this->db->get_where('simanja_tugas_pokok',array('id_skpd'=>$data['id_skpd'],'id_unit_kerja'=>$data['id_unit_kerja'],'nama_jabatan'=>$data['nama_jabatan'],'jenis_jabatan'=>$data['jenis_jabatan']))->row();
		return $q;
	}
	...
	public function get($param)
	{
		...
		$rs = $this->db->get("simanja_tugas_pokok jabatan");
		return $rs;
	}
	...
	public function insert_excel($data){
		$insert = $this->db->insert_batch('simanja_tugas_pokok', $data);
		if($insert){
			return true;
		}
	}
