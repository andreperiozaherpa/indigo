...
class Sasaran_model extends CI_Model
{
    ...
    public function get($param=null)
    {
        ...
        $this->db->join("sc_rpjmd_sasaran rpjmd_sasaran","sasaran.id_sasaran_rpjmd = rpjmd_sasaran.id_sasaran_rpjmd","left");
        ...
        $this->db->select("sasaran.*,
            ...
            rpjmd_sasaran.nama_sasaran_rpjmd,
    ...
    public function delete($id)
    {
        ...
        $this->Cascading->delete_sasaran_renstra($id);
...
//        ->where("flag","sasaran")
        ...
        // delete unit kerja
        $this->db->where("id_sasaran_renstra",$id)->delete("sc_renstra_sasaran_unit_kerja");
    ...
    public function getUnitKerja($id_sasaran_renstra)
    {
        $rs = $this->db->where("id_sasaran_renstra",$id_sasaran_renstra)->get("sc_renstra_sasaran_unit_kerja")->result();
        if($rs)
        {
            $unit_kerja = array();
            foreach($rs as $row)
