...
class Program_model extends CI_Model
{
    ...
    public function get($param=null)
    {
        ...
        $this->db->join("sc_rpjmd_sasaran sasaran","sasaran.id_sasaran_rpjmd = program.id_sasaran_rpjmd","left");
        ...
        $this->db->select("*, urusan.nama_urusan as 'nama_urusan' ");

        $this->db->order_by("ref_program.kode_program","ASC");
    ...
    public function get_sasaran_indikator($param=null)
    {
        ...
        $this->db->join("sc_rpjmd_sasaran_indikator sasaran_indikator","sasaran_indikator.id_indikator_sasaran_rpjmd = indikator.id_indikator_sasaran_rpjmd","left");
        
        $query = $this->db->get("sc_rpjmd_program_sasaran_indikator indikator");
