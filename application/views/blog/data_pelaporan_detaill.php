	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<h2>Data dan Pelaporan</h2><span>Detail Modul</span>

				<!-- Breadcrumbs -->
				<nav id="breadcrumbs">
					<ul>
						<li><a href="<?php echo base_url();?>">Beranda</a></li>
						<li><a href="<?php echo base_url('modul');?>">Data dan Pelaporan</a></li>
	...
	<div class="row">
		<div class="col-lg-9 col-md-8 padding-right-30">
			...
			<div class="blog-post">
				...
				<!-- Img -->
				<a href="<?=base_url()."modul/download/{$row->id_berkas}"?>" target="_blank" class="post-img" style="min-height: 265px;">
