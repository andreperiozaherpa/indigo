  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <h2 class="putih">Layanan Interaktif</h2>
    ...
    <div id="content">
      <div class="container">
        ...
        <div class="col-sm-12 col-md-12" style="margin-bottom:120px;margin-top: 30px; ">
          <div class="white-box">
            <center>
              ...
              <h3>SIMONSIKAT v 2.5 Soon</h3>
              <h4>Layanan ini sedang di kembangkan</h4>
              <p style="margin-top: 70px">
                <img style="width: 150px" src="<?php echo base_url()."data/logo/app-store-badge.png" ?>">
                <img style="width: 175px" src="<?php echo base_url()."data/logo/google-play-badge.png" ?>">
              </p>
            </center>
          </div>
        </div>
