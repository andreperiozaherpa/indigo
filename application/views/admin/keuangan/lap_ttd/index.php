<div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form method="POST">
                        <div class="col-md-3 b-r">
							<a href="<?=base_url();?>keuangan/lap_operasional/add">
   ...
   <?php foreach ($list1 as $l) {
        ...
        if ($l->status == "Selesai") {
            ...
            $label   = "danger";
            if ($l->ttd_pegawai_2_skpd == "ditolak") {
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <br>
                                <address>
                                    <a href="<?=base_url();?>keuangan/lap_operasional/detail/<?=encode($l->id_laporan_operasional);?>">
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <br>
                                <address>
                                    <a href="<?=base_url();?>keuangan/lap_realisasi_anggaran/detail/<?=encode($l->id_laporan_realisasi_anggaran);?>">
                                        <button class="fcbtn btn btn-primary btn-outline btn-1b btn-block">Detail
                                            Laporan</button>
