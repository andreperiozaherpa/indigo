<div class="container-fluid">
    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<?= base_url(); ?>keuangan/lap_neraca">Lap. neraca</a></li>
                <li><a href="<?= base_url(); ?>keuangan/lap_neraca/detail">Detail</a></li>
    ...
    <div class="col-md-12">
        <a href="<?= base_url(); ?>keuangan/lap_neraca" class="pull-right btn btn-primary btn-outline"><i
                                ...
                                <div class="col-md-12 col-sm-6">
                                    <div class="white-box">
                                        ...
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                <div class="user-img"> <img
                                                        src="<?= base_url(); ?>data/foto/pegawai/<?= empty($detail->foto3) ? 'user-default.png' : $detail->foto3 ?>"
                                                        style="width:40px;height:40px; object-fit: cover;" alt="user"
                                                        class="img-circle"> <span
                                                        class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5><?=$detail->nama_3_bpkad;?></h5> <span
                                                        class="mail-desc"><?=$detail->jabatan_3_bpkad;?></span> <span
                                                        class="label label-rounded <?=label_status($detail->ttd_pegawai_3_bpkad)?>"><?=$detail->ttd_pegawai_3_bpkad;?></span>
                                                </div>
                                            </a>
                                    ...
                                    <div class="white-box">
                                        ...
                                        <div class="message-center">
                                            ...
                                            <a href="#">
                                                <div class="user-img"> <img
                                                        src="<?= base_url(); ?>data/foto/pegawai/<?= empty($detail->foto7) ? 'user-default.png' : $detail->foto7 ?>"
                                                        style="width:40px;height:40px; object-fit: cover;" alt="user"
                                                        class="img-circle"> <span
                                                        class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5><?=$detail->nama_3_skpd;?></h5> <span
                                                        class="mail-desc"><?=$detail->jabatan_3_skpd;?></span> <span
                                                        class="label label-rounded <?=label_status($detail->ttd_pegawai_3_skpd)?>"><?=$detail->ttd_pegawai_3_skpd;?></span>
                                                </div>
                                            </a>
        ...
        <div class="">
            <div class="panel panel-default">
                ...
                <div class="panel-footer">
                    ...
                    <?php if (
                        ($detail->ttd_pegawai_3_skpd == "belum" AND $this->session->userdata('id_pegawai') == $detail->id_pegawai_3_skpd) OR
                        ($detail->ttd_pegawai_2_skpd == "belum" AND $this->session->userdata('id_pegawai') == $detail->id_pegawai_2_skpd AND $detail->ttd_pegawai_3_skpd == "setuju") OR
                        ...
                        ($detail->ttd_pegawai_3_bpkad == "belum" AND $this->session->userdata('id_pegawai') == $detail->id_pegawai_3_bpkad AND $detail->status_verifikasi == "setuju") OR
                        ($detail->ttd_pegawai_2_bpkad == "belum" AND $this->session->userdata('id_pegawai') == $detail->id_pegawai_2_bpkad AND $detail->ttd_pegawai_3_bpkad == "setuju") OR
...
function reset_dokumen() {
    swal({
        ...
        if (isConfirm) {
            location.href =
                "<?= base_url(); ?>keuangan/lap_neraca/reset_ulang/<?=encode($detail->id_laporan_neraca);?>";
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?=base_url()."keuangan/lap_neraca/delete/".$detail->id_laporan_neraca;?>"
