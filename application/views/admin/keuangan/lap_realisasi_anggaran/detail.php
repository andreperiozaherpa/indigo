<div class="container-fluid">
    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<?= base_url(); ?>keuangan/lap_realisasi_anggaran">Lap. Realisasi Anggaran</a></li>
                <li><a href="<?= base_url(); ?>keuangan/lap_realisasi_anggaran/detail">Detail</a></li>
    ...
    <div class="col-md-12">
        <a href="<?= base_url(); ?>keuangan/lap_realisasi_anggaran" class="pull-right btn btn-primary btn-outline"><i class="ti-back-left"></i> Kembali</a><br><br>
    </div>
    <?php if (@$detail){ ?>
    <div class="col-md-3">
        <div class="row">
                            ...
                            <div class="panel-body" style="border-top: solid 5px #6003C8">
                                <div class="row b-b">
                                    <div class="text-center">
                                        <p>
                                            <img src="https://e-office.sumedangkab.go.id/data/logo/skpd/sumedang.png" alt="user" width="200px">

                                        </p>
                                        <p>
                                            <?php if ($detail->status != "Selesai"): ?>
                                            <span class="text-danger">
                                                <i style="border-radius: 50%;color: #fff;padding: 5px;" class="icon-close bg-danger"></i> <?=$detail->status;?> </span>
                                            <?php else: ?>
                                            <span class="text-success">
                                                <i style="border-radius: 50%;color: #fff;padding: 5px;" class="icon-check bg-success"></i> <?=$detail->status;?> </span>
                                            <?php endif ?>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <a href="<?= base_url(); ?>data/keuangan/tmp/<?=$detail->file_draft;?>" class="btn btn-primary btn-block btn-outline"><i class="ti-download"></i> Download Lampiran</a>
                                <?php if ($detail->status != "Selesai"): ?>
                                <hr>
                                <?php if (in_array('keuangan', explode(';', $this->session->userdata('user_privileges'))) OR $this->session->userdata('level') == "Administrator"): ?>
                                <a href="<?= base_url(); ?>keuangan/lap_realisasi_anggaran/edit/<?=encode($detail->id_laporan_realisasi_anggaran);?>" class="btn btn-info btn-block btn-outline"><i class="ti-pencil"></i> Edit BA</a>
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal" onclick="delete_ss_(<?=$detail->id_laporan_realisasi_anggaran;?>)" class="btn btn-danger btn-block btn-outline"><i class="fa fa-trash"></i> Hapus BA</a>
                                ...
                                <?php 
                                    if($detail->file_signed_draft){
                                        ?>
                                        <a style="color:white" href="<?=base_url('data/keuangan/'.$detail->file_signed_draft)?>" class="btn btn-primary btn-sm btn-block" target="blank">Download Draft</a>
                                        <?php
                                    }
                                ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_content">
                                <div class="col-md-12 col-sm-6">
                                    <div class="white-box">
                                        <h4 class="box-title">Penandatangan - BKAD</h4>
                                        <div class="message-center">
                                            <a href="#">
                                                <div class="user-img"> <img src="<?= base_url(); ?>data/foto/pegawai/<?= empty($detail->foto1) ? 'user-default.png' : $detail->foto1 ?>" alt="user" style="width:40px;height:40px; object-fit: cover;" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5><?=$detail->nama_1_bpkad;?></h5> <span class="mail-desc"><?=$detail->jabatan_1_bpkad;?></span><span class="label label-rounded <?=label_status($detail->ttd_pegawai_1_bpkad)?>"><?=$detail->ttd_pegawai_1_bpkad;?></span>
                                                </div>
                                            </a>
                                            <a href="#" class="b-none">
                                                <div class="user-img"> <img src="<?= base_url(); ?>data/foto/pegawai/<?= empty($detail->foto2) ? 'user-default.png' : $detail->foto2 ?>" style="width:40px;height:40px; object-fit: cover;" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5><?=$detail->nama_2_bpkad;?></h5> <span class="mail-desc"><?=$detail->jabatan_2_bpkad;?></span> <span class="label label-rounded <?=label_status($detail->ttd_pegawai_2_bpkad)?>"><?=$detail->ttd_pegawai_2_bpkad;?></span>
                                                </div>
                                            </a>
                                    ...
                                    <div class="white-box">
                                        ...
                                        <div class="message-center">
                                            <a href="#">
                                                <div class="user-img"> <img src="https://sarerea.sumedangkab.go.id/data/logo/e.png" alt="user" style="width:40px;height:40px; object-fit: cover;" class="img-circle"></div>
                                                <div class="mail-contnet">
                                                    <h5>PEMROSES</h5> <span class="mail-desc"></span> <span class="label label-rounded <?=label_status($detail->status_verifikasi)?>"><?=$detail->status_verifikasi;?></span>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="white-box">
                                        ...
                                        <div class="message-center">
                                        <a href="#">
                                                <div class="user-img"> <img src="<?= base_url(); ?>data/foto/pegawai/<?= empty($detail->foto5) ? 'user-default.png' : $detail->foto5 ?>" style="width:40px;height:40px; object-fit: cover;" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5><?=$detail->nama_1_skpd;?></h5> <span class="mail-desc"><?=$detail->jabatan_1_skpd;?></span> <span class="label label-rounded <?=label_status($detail->ttd_pegawai_1_skpd)?>"><?=$detail->ttd_pegawai_1_skpd;?></span>
                                                </div>
                                            </a>
                                            <a href="#">
                                                <div class="user-img"> <img src="<?= base_url(); ?>data/foto/pegawai/<?= empty($detail->foto6) ? 'user-default.png' : $detail->foto6 ?>" style="width:40px;height:40px; object-fit: cover;" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                                                <div class="mail-contnet">
                                                    <h5><?=$detail->nama_2_skpd;?></h5> <span class="mail-desc"><?=$detail->jabatan_2_skpd;?></span> <span class="label label-rounded <?=label_status($detail->ttd_pegawai_2_skpd)?>"><?=$detail->ttd_pegawai_2_skpd;?></span>
                                                </div>
                                            </a>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-body" style="border-top: solid 5px #6003C8">
                        ...
                        <h3 style="color: #6003C8" class="box-title"><span style="color: #222">Berita Acara Rekonsiliasi Laporan Realisasi Anggaran </span></h3>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="border-top: solid 5px #ff6849">
                    <blockquote class="alert alert-danger"><i class="icon-close"></i> Laporan Ditolak: <br/>dengan alasan - <?=$detail->alasan_penolakan?></blockquote>
                </div>
            </div>
        </div>
        <?php endif ?>
                    ...
                    <?php endif ?>
                                ...
                                <?php 
                                    if($detail->file_signed){
                                        ?>
                                        <a style="color:white" href="<?=base_url('data/keuangan/'.$detail->file_signed)?>" class="btn btn-primary btn-sm btn-block" target="blank">DOWNLOAD SURAT</a>
                                        <?php
                                    }
                                ?>
                </div>
    ...
    <?php }else{ ?>
        <div class="alert alert-danger">Maaf, data yang anda cari tidak ditemukan, mohon kembali ke halaman sebelumnya.</div>
    <?php } ?>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form method="POST" enctype="multipart/form-data" id="ttdForm" onsubmit="$('#passphrase').block();swal('Proses Penandatanganan','Mohon tunggu, jangan tutup laman ini ketika sistem sedang melakukan penandatanganan dokumen anda.','success')">
...
function reset_dokumen() {
    swal({
        ...
        if (isConfirm) {
            location.href =
                "<?= base_url(); ?>keuangan/lap_realisasi_anggaran/reset_ulang/<?=encode($detail->id_laporan_realisasi_anggaran);?>";
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary" type="submit" name="tolak"><span class="btn-label"><i class="ti-close"></i></span>Tolak Surat</button>
          </form>
        </div>
      </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?=base_url()."keuangan/lap_realisasi_anggaran/delete/".$detail->id_laporan_realisasi_anggaran;?>" class="btn btn-primary">Ya</a>
      </div>
    </div>
