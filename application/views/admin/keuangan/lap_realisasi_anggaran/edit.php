                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="number" name="pendapatan_asli" id="pendapatan_asli" value="<?=$detail->pendapatan_asli;?>" onkeyup="perhitungan()" onchange="perhitungan()" required class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="pendapatan_transfer" id="pendapatan_transfer" value="<?=$detail->pendapatan_transfer;?>" onkeyup="perhitungan()" onchange="perhitungan()" required class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="pendapatan_lain" id="pendapatan_lain" value="<?= $detail->pendapatan_lain; ?>" onkeyup="perhitungan()" onchange="perhitungan()" required class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="total_pendapatan" value="<?= $detail->total_pendapatan; ?>" id="total_pendapatan" onkeyup="perhitungan()" class="form-control " readonly>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_operasi" value="<?= $detail->belanja_operasi; ?>" id="belanja_operasi" onkeyup="perhitungan()" class="form-control ">
                                                            </div>
                                                        </div> -->
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_pegawai" value="<?= $detail->belanja_pegawai; ?>" id="belanja_pegawai" onkeyup="perhitungan()" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_barang_jasa" value="<?= $detail->belanja_barang_jasa; ?>" id="belanja_barang_jasa" onkeyup="perhitungan()" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_bunga" value="<?= $detail->belanja_bunga; ?>" id="belanja_bunga" onkeyup="perhitungan()" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_hibah" value="<?= $detail->belanja_hibah; ?>" id="belanja_hibah" onkeyup="perhitungan()" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_bantuan_sosial" value="<?= $detail->belanja_bantuan_sosial; ?>" onkeyup="perhitungan()" id="belanja_bantuan_sosial" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="jumlah_belanja_operasi" value="<?= $detail->jumlah_belanja_operasi; ?>" onkeyup="perhitungan()" id="jumlah_belanja_operasi" class="form-control " readonly>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_modal" value="<?= $detail->belanja_modal; ?>" onkeyup="perhitungan()" id="belanja_modal" class="form-control ">
                                                            </div>
                                                        </div> -->
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_m_tanah" value="<?= $detail->belanja_m_tanah; ?>" onkeyup="perhitungan()" id="belanja_m_tanah" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_m_peralatan_mesin" value="<?= $detail->belanja_m_peralatan_mesin; ?>" onkeyup="perhitungan()" id="belanja_m_peralatan_mesin" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_m_gedung_bangunan" value="<?= $detail->belanja_m_gedung_bangunan; ?>" onkeyup="perhitungan()" id="belanja_m_gedung_bangunan" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_m_jalan" value="<?= $detail->belanja_m_jalan; ?>" onkeyup="perhitungan()" id="belanja_m_jalan" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_m_aset_tetap" value="<?= $detail->belanja_m_aset_tetap; ?>" onkeyup="perhitungan()" id="belanja_m_aset_tetap" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_m_aset_lainya" value="<?= $detail->belanja_m_aset_lainya; ?>" onkeyup="perhitungan()" id="belanja_m_aset_lainya" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="jumlah_modal_belanja" value="<?= $detail->jumlah_modal_belanja; ?>" onkeyup="perhitungan()" id="jumlah_modal_belanja" class="form-control " readonly>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="belanja_tak_terduga" value="<?= $detail->belanja_tak_terduga; ?>" onkeyup="perhitungan()" id="belanja_tak_terduga" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="transfer" value="<?= $detail->transfer; ?>" onkeyup="perhitungan()" id="transfer" class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="total_belanja_transfer" value="<?= $detail->total_belanja_transfer; ?>" onkeyup="perhitungan()" id="total_belanja_transfer" class="form-control " readonly>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="surplus" id="surplus" value="<?= $detail->surplus; ?>" onkeyup="perhitungan()" class="form-control " readonly>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="penerimaan_pembiayaan" id="penerimaan_pembiayaan" value="<?= $detail->penerimaan_pembiayaan; ?>" onkeyup="perhitungan()" onchange="perhitungan()" required class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="pengeluaran_pembiayaan" id="pengeluaran_pembiayaan" value="<?= $detail->pengeluaran_pembiayaan; ?>" onkeyup="perhitungan()" onchange="perhitungan()" required class="form-control ">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <div class="input-group-addon">Rp.</div>
                                                                <input type="number" name="pembiayaan_bersih" id="pembiayaan_bersih" value="<?= $detail->pembiayaan_bersih; ?>" onkeyup="perhitungan()" onchange="perhitungan()" required class="form-control " readonly>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                            ...
                            <div class="col-md-12  p-t-10">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12" style="padding-top:40px;">
                                        <div class="form-group">
                                            <label class="col-sm-12">Lampiran <code>File PDF LRA print out dari Aplikasi SIPASTI</code><a href="<?= base_url('data/keuangan/' . $detail->file_draft) ?>" class="btn btn-sm btn-default pull-right" target="_blank">Download</a></label>
                                            <div class="col-sm-12">
