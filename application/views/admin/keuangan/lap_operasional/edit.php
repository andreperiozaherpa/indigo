                    ...
                    <div class="wizard-content">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input id="pendapatan_asli_sekarang" name="pendapatan_asli_sekarang" value="<?=$detail->pendapatan_asli_sekarang;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="pendapatan_asli_awal" name="pendapatan_asli_awal" value="<?=$detail->pendapatan_asli_awal;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="total_pendapatan_asli" name="total_pendapatan_asli" value="<?=$detail->total_pendapatan_asli;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="pendapatan_transfer_sekarang" name="pendapatan_transfer_sekarang" value="<?=$detail->pendapatan_transfer_sekarang;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="pendapatan_transfer_awal" name="pendapatan_transfer_awal" value="<?=$detail->pendapatan_transfer_awal;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="total_pendapatan_transfer" name="total_pendapatan_transfer" value="<?=$detail->total_pendapatan_transfer;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="pendapatan_lain_sekarang" name="pendapatan_lain_sekarang" value="<?=$detail->pendapatan_lain_sekarang;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="pendapatan_lain_awal" name="pendapatan_lain_awal" value="<?=$detail->pendapatan_lain_awal;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="total_pendapatan_lain" name="total_pendapatan_lain" value="<?=$detail->total_pendapatan_lain;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="pendapatan_surplus_sekarang" name="pendapatan_surplus_sekarang" value="<?=$detail->pendapatan_surplus_sekarang;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="pendapatan_surplus_awal" name="pendapatan_surplus_awal" value="<?=$detail->pendapatan_surplus_awal;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input id="total_pendapatan_surplus" name="total_pendapatan_surplus" value="<?=$detail->total_pendapatan_surplus;?>" onkeyup="perhitungan()" onchange="perhitungan()" required type="number" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" id="total_pendapatan_lo_sekarang" value="<?=$detail->total_pendapatan_lo_sekarang;?>" name="total_pendapatan_lo_sekarang" onkeyup="perhitungan()" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" id="total_pendapatan_lo_awal" value="<?=$detail->total_pendapatan_lo_awal;?>" name="total_pendapatan_lo_awal" onkeyup="perhitungan()" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" id="total_pendapatan1_lo" value="<?=$detail->total_pendapatan1_lo;?>" name="total_pendapatan1_lo" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_pegawai_sekarang" value="<?=$detail->beban_pegawai_sekarang;?>"  onkeyup="perhitungan()" id="beban_pegawai_sekarang" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_pegawai_awal" value="<?=$detail->beban_pegawai_awal;?>" onkeyup="perhitungan()" id="beban_pegawai_awal" class="form-control">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_pegawai" value="<?=$detail->total_beban_pegawai;?>" onkeyup="perhitungan()" id="total_beban_pegawai" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_barangjasa_sekarang" value="<?=$detail->beban_barangjasa_sekarang;?>" onkeyup="perhitungan()" id="beban_barangjasa_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_barangjasa_awal" value="<?=$detail->beban_barangjasa_awal;?>" onkeyup="perhitungan()" id="beban_barangjasa_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_barangjasa" value="<?=$detail->total_barangjasa;?>" onkeyup="perhitungan()" id="total_barangjasa" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_bunga_sekarang" value="<?=$detail->beban_bunga_sekarang;?>" onkeyup="perhitungan()" id="beban_bunga_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_bunga_awal" value="<?=$detail->beban_bunga_awal;?>" onkeyup="perhitungan()" id="beban_bunga_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_bunga" value="<?=$detail->total_bunga;?>" onkeyup="perhitungan()" id="total_bunga" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_hibah_sekarang" value="<?=$detail->beban_hibah_sekarang;?>" onkeyup="perhitungan()" id="beban_hibah_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_hibah_awal" value="<?=$detail->beban_hibah_awal;?>" onkeyup="perhitungan()" id="beban_hibah_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_hibah" value="<?=$detail->total_beban_hibah;?>" onkeyup="perhitungan()" id="total_beban_hibah" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_bantuansosial_sekarang" value="<?=$detail->beban_bantuansosial_sekarang;?>" onkeyup="perhitungan()" id="beban_bantuansosial_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_bantuansosial_awal" value="<?=$detail->beban_bantuansosial_awal;?>" onkeyup="perhitungan()" id="beban_bantuansosial_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_bantuansosial" value="<?=$detail->total_bantuansosial;?>" onkeyup="perhitungan()" id="total_bantuansosial" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_penyisihanpiutang_sekarang" value="<?=$detail->beban_penyisihanpiutang_sekarang;?>" onkeyup="perhitungan()" id="beban_penyisihanpiutang_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_penyisihanpiutang_awal" value="<?=$detail->beban_penyisihanpiutang_awal;?>" onkeyup="perhitungan()" id="beban_penyisihanpiutang_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_penyisihanpiutang" value="<?=$detail->total_penyisihanpiutang;?>" onkeyup="perhitungan()" id="total_penyisihanpiutang" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_lain_sekarang" value="<?=$detail->beban_lain_sekarang;?>" onkeyup="perhitungan()" id="beban_lain_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_lain_awal"  value="<?=$detail->beban_lain_awal;?>" onkeyup="perhitungan()" id="beban_lain_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_lain" value="<?=$detail->total_beban_lain;?>" onkeyup="perhitungan()" id="total_beban_lain" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="jumlah_beban_operasi_sekarang" value="<?=$detail->jumlah_beban_operasi_sekarang;?>" onkeyup="perhitungan()"  id="jumlah_beban_operasi_sekarang" class="form-control" readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="jumlah_beban_operasi_awal" value="<?=$detail->jumlah_beban_operasi_awal;?>" onkeyup="perhitungan()"  id="jumlah_beban_operasi_awal"  class="form-control" readonly >
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_operasi" value="<?=$detail->total_beban_operasi;?>" onkeyup="perhitungan()"  id="total_beban_operasi" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_penyusutan_sekarang" value="<?=$detail->beban_penyusutan_sekarang;?>" onkeyup="perhitungan()" id="beban_penyusutan_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_penyusutan_awal" value="<?=$detail->beban_penyusutan_awal;?>" onkeyup="perhitungan()" id="beban_penyusutan_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_penyusutan" value="<?=$detail->total_beban_penyusutan;?>" onkeyup="perhitungan()" id="total_beban_penyusutan" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_transfer_sekarang" value="<?=$detail->beban_transfer_sekarang;?>" onkeyup="perhitungan()" id="beban_transfer_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_transfer_awal" value="<?=$detail->beban_transfer_awal;?>" onkeyup="perhitungan()" id="beban_transfer_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_transfer" value="<?=$detail->total_beban_transfer;?>" onkeyup="perhitungan()"  id="total_beban_transfer" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_takterduga_sekarang" value="<?=$detail->beban_takterduga_sekarang;?>"  onkeyup="perhitungan()" id="beban_takterduga_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="beban_takterduga_awal" value="<?=$detail->beban_takterduga_awal;?>"  onkeyup="perhitungan()" id="beban_takterduga_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_takterduga" value="<?=$detail->total_beban_takterduga;?>"  onkeyup="perhitungan()" id="total_beban_takterduga" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="defisit_keg_nonopera_sekarang" value="<?=$detail->defisit_keg_nonopera_sekarang;?>" onkeyup="perhitungan()" id="defisit_keg_nonopera_sekarang" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="defisit_keg_nonopera_awal" value="<?=$detail->defisit_keg_nonopera_awal;?>" onkeyup="perhitungan()" id="defisit_keg_nonopera_awal" class="form-control ">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_defisit_keg_nonopera" value="<?=$detail->total_defisit_keg_nonopera;?>" onkeyup="perhitungan()" id="total_defisit_keg_nonopera" id class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_sekarang" value="<?=$detail->total_beban_sekarang;?>"  id="total_beban_sekarang" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_awal" value="<?=$detail->total_beban_awal;?>"  id="total_beban_awal" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="total_beban_akhir" value="<?=$detail->total_beban_akhir;?>" id="total_beban_akhir" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="surplus_sekarang" value="<?=$detail->surplus_sekarang;?>"  onkeyup="perhitungan()" id="surplus_sekarang" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="surplus_awal" value="<?=$detail->surplus_awal;?>" onkeyup="perhitungan()" id="surplus_awal" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td> 
                                                <div class="form-group">
                                                        <div class="input-group">
                                                            <div class="input-group-addon">Rp.</div>
                                                            <input type="number" name="surplus_akhir" value="<?=$detail->surplus_akhir;?>" onkeyup="perhitungan()" id="surplus_akhir" class="form-control " readonly>
                                                        </div>
                                                    </div>
                                                </td>
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-12" style="padding-top:40px;">
                                    <div class="form-group">
                                        <label class="col-sm-12">Lampiran <code>File PDF LO print out dari Aplikasi SIPASTI</code> <a href="<?=base_url('data/keuangan/'.$detail->file_draft)?>" class="btn btn-sm btn-default pull-right" target="_blank">Download</a></label>
                                        <div class="col-sm-12">
