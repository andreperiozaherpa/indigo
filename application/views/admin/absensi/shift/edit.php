		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<form role="form" class="form-horizontal " method='post' enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control" value="<?=$detail->nama_shift;?>" id='nama_shift' name='nama_shift' placeholder="">
						</div>
					</div>
          ...
          <div class="form-group">
              ...
              <div class="input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                  <input type="text" class="form-control" value="<?=$detail->jam_masuk;?>" name="jam_masuk">
          ...
          <div class="form-group">
						...
						<div class="col-sm-7">
              <div class="input-group clockpicker " data-placement="bottom" data-align="top" data-autoclose="true">
                  <input type="text" class="form-control" value="<?=$detail->jam_pulang;?>" name="jam_pulang">
                  <span class="input-group-addon"> <span class="glyphicon glyphicon-time"></span> </span>
              </div>
						</div>
					</div>
          ...
          foreach ($hariArr as $key => $value):
            $id = $key + 1;
            $hari = "hari".$id;
            $checked = ($detail->$hari=="Y") ? "checked" : "";
            ?>
          <div class="form-group">
						<label for="hari<?=$id;?>" class="col-sm-5  control-label"><?=$value;?></label>
						<div class="col-sm-7">
              <input type="checkbox" <?= $checked;?> value="Y" name="hari<?=$id;?>" id="hari<?=$id;?>" class="js-switch" data-color="#6164c1" data-size="small" />
						</div>
					</div>
        <?php endforeach?>
					<div class="form-group">
