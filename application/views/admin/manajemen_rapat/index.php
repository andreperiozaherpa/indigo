<div class="container-fluid">
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Manajemen Rapat</h4>
        </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
    ...
    <div class="row">
        <div class="col-md-3">
            <a href="<?= base_url('manajemen_rapat/add') ?>" class="btn btn-primary btn-block m-t-40"><i class="ti-plus"></i> Buat Jadwal Rapat</a>
        </div>
        <div class="col-md-9">
            <div class="white-box">
                <form>
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" value="<?=!empty($filter) && isset($filter['tema_rapat']) ? $filter['tema_rapat'] : null ?>" name="tema_rapat" placeholder="Cari Tema Rapat ...">
                    </div>
                    <div class="col-md-3">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="display: block;"><i class="ti-time text-purple"></i> <?= stime($l->jam) ?></span>
                                </td>
                                <td><span class="label label-<?= $l->jenis_rapat == 'online' ? 'info' : 'warning' ?>"><?= ucwords($l->jenis_rapat) ?></span></td>
                                <td>
                                ...
                                <td><a href="<?= base_url('manajemen_rapat/detail/' . $l->id_rapat) ?>" class="btn btn-primary"><i class="ti-eye"></i> Detail</a> </td>
                            </tr>
                        <?php $no++;
                        } ?>
                    </tbody>
