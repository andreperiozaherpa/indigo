 <div id="main-content" class="container-fluid">
  ...
  <div class="row bg-title">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h4 class="page-title">Sasaran Kegiatan</h4>
    </div>
    <!-- /.page title -->
    <!-- .breadcrumb -->
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
     ...
     <ol class="breadcrumb">
        ...
        <li class="active">Sasaran Kegiatan</li>
      </ol>
    </div>
    <!-- /.breadcrumb -->
  </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="data-title">Tambah Sasaran Kegiatan</h4>
          </div>
          <div class="modal-body">
           ...
           <div class="form-group">
            <label for="data-id_sasaran_program" class="control-label">Sasaran Program</label>
            <select id="data-id_sasaran_program" class="form-control" name="id_sasaran_program" required>
              <?php foreach ($sasaran_program as $value): ?>
                <option value="<?=$value->id_sasaran_program?>"><?=$value->sasaran_program?></option>
              <?php endforeach ?>
            </select>
          </div>

            <div class="form-group">
            <label for="data-kode_sasaran_kegiatan" class="control-label">Kode</label>
            <input id="data-kode_sasaran_kegiatan" type="text" class="form-control" name="kode_sasaran_kegiatan" value="SK-<?=$this->session->userdata('kode_unit_kerja')?>." readonly required>
          </div>

          <div class="form-group">
            <label for="data-sasaran_kegiatan" class="control-label">Sasaran Kegiatan</label>
            <textarea id="data-sasaran_kegiatan" class="form-control" name="sasaran_kegiatan" required></textarea>
          </div>
<?php
    ...
    <div class="white-box">
      <div class="row">
        <div class="col-md-3 b-r">
             ...
             <button type="button" onclick="new_data();" class="btn btn-primary btn-block e m-t-20"  data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Tambah Sasaran Kegiatan</button>
...
<div class="col-md-12">
 ...
 <div class="panel panel-primary block6">
          <div class="panel-heading">Diposisi Sasaran Program
...
<div class="col-md-4 col-sm-6">
        <div style="background-color: #4e2a84;padding:10px">
          <div class="pull-left">
            <div class="btn-group m-r-10">
              ...
              <ul role="menu" class="dropdown-menu animated flipInX">
                <li><a  href="#!" onclick="edit_data('<?=$value->id_sasaran_kegiatan;?>');" >Edit</a></li>
                <li><a href="#!" onclick="delete_data('<?=$value->id_sasaran_kegiatan;?>');"  >Hapus</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <center>
                <img style="width:60%;margin-top:-20px;" src="<?=base_url()."data/images/sk.png";?>" alt="user" class="img-responsive">
              </center>
            </div>
          </div>
        </div>
       <a href="<?=base_url('sasaran_kegiatan/detail/'.$value->id_sasaran_strategis.'')?>">
         <div class="white-box">
           <div class="row">
            <div class="col-md-12 text-center m-t-10">
              <h3 class="box-title m-b-0">Sasaran Program Atasan</h3>
          ...
          <div class="row">
            <div class="col-md-6 text-center b-r">
              <h3 class="box-title m-b-0">Kode SK</h3>
          ...
          <div class="row">
            <div class="col-md-12 text-center m-t-10">
              <h3 class="box-title m-b-0">Nama Sasaran Kegiatan</h3>
              <small><?=$value->sasaran_program?></small>
            </div>
          </div>
...
<script type="text/javascript">
  ...
  function new_data() {
    ...
    var kode = "SK-<?=$this->session->userdata('kode_unit_kerja')?>.";
    $.ajax({
      url:"<?php echo base_url('sasaran_kegiatan/get_kode');?>",
      type:"POST",
      data: "kode="+kode,
      dataType: "text",

      success:function(resp){
        $("#data-kode_sasaran_kegiatan").val(resp);
      },
  ...
  function add_data() {
    ...
    $.ajax({
      url:"<?php echo base_url('sasaran_kegiatan/add_data');?>",
      type:"POST",
  ...
  function edit_data(id) {
    ...
    $.ajax({
      url:"<?php echo base_url('sasaran_kegiatan/get_data');?>/"+id,
      type:"GET",
      dataType: "json",
      cache: false,
      ...
      success:function(resp){
        ...
        if (resp == false) {
          ...
          if (resp[0].id_sasaran_program) { $("#data-id_sasaran_program").val(resp[0].id_sasaran_program); }
          if (resp[0].kode_sasaran_kegiatan) { $("#data-kode_sasaran_kegiatan").val(resp[0].kode_sasaran_kegiatan); }
          if (resp[0].sasaran_kegiatan) { $("#data-sasaran_kegiatan").val(resp[0].sasaran_kegiatan); }
        }
      },
      error:function(event, textStatus, errorThrown) {
        alert('Error Message: '+ textStatus + ' , HTTP Error: '+ errorThrown);
  ...
  function save_data(id) {
    ...
    $.ajax({
      url:"<?php echo base_url('sasaran_kegiatan/update_data');?>/"+id,
      type:"POST",
      data: $('#data-form').serialize(),
      ...
      success:function(resp){
        ...
        if (resp == false) {
          ...
          swal({   
            ...
            $.ajax({
              url:"<?php echo base_url('sasaran_kegiatan/delete_data');?>/"+resp[0].id_sasaran_kegiatan,
              type:"GET",
              dataType: "json",
              cache: false,
      ...
      success:function(resp){
        ...
        if (resp == false) {
          ...
          swal({   
            ...
            $.ajax({
              url:"<?php echo base_url('sasaran_kegiatan/verifikasi_data');?>/"+resp[0].id_sasaran_kegiatan,
              type:"GET",
              dataType: "json",
              cache: false,
      ...
      success:function(resp){
        ...
        if (resp == false) {
          ...
          swal({   
            ...
            $.ajax({
              url:"<?php echo base_url('sasaran_kegiatan/batal_verifikasi_data');?>/"+resp[0].id_sasaran_kegiatan,
              type:"GET",
              dataType: "json",
              cache: false,
