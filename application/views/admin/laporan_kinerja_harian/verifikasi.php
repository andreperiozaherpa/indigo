                    ...
                    <table class="table color-table primary-table" id="tableSimple">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" width="10%">Penilaian</th>
                            ...
                            ?>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php if($l->rating):?>
                                            <span class="fa fa-star <?= ($l->rating>=1) ? "checked" : "" ;?>"></span>
                                            <span class="fa fa-star <?= ($l->rating>=2) ? "checked" : "" ;?>"></span>
                                            <span class="fa fa-star <?= ($l->rating>=3) ? "checked" : "" ;?>"></span>
                                            <span class="fa fa-star <?= ($l->rating>=4) ? "checked" : "" ;?>"></span>
                                            <span class="fa fa-star <?= ($l->rating>=5) ? "checked" : "" ;?>"></span>
                                            <p><?= ($l->komentar) ?  '"'.$l->komentar.'"' : '';?></p>
                                            <?php endif?>
                                        </td>
                                        <td class="text-center">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="javascript:void(0)" onclick="saveVerifikasi('Verifikasi')" id="btnVerifikasi" class="btn btn-primary waves-effect text-left">Verifikasi</a>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
