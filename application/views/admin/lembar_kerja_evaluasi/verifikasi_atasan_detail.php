                ...
                <div class="row">
                    <form method="POST">
                        <div class="col-md-3 b-r">
                            <center><img style="width: 80%" src="<?php echo base_url() . "data/logo/skpd/sumedang.png"; ?>" alt="user" class="img-circle" /> </center>
                        </div>
                        <div class="col-md-9">
                                    ...
                                    <div class="panel-body">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td style="width: 120px;">Jenis LKE </td>
                                                    <td>:</td>
                                                    <td> <strong><?php if ($jenis_lke == 'zi_wbk') {
                                                                        echo "<b style='color:#4285F4;'>ZI WBK</b>";
                                                                    } elseif ($jenis_lke == 'rb') {
                                                                        echo "<b style='color:#4285F4;'>Reformasi Birokrasi</b>";
                                                                    } ?></strong>
                                                <tr>
                                                    <td style="width: 120px;">Tahun LKE </td>
                                                    <td>:</td>
        ...
        <div class="col-md-12">
            <div class="white-box">
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                                                    ...
                                                                    <div class="panel-heading" role="tab" id="heading<?= $n3 ?>">
                                                                        <h4 class="panel-title">
                                                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion<?= $n2 ?>" href="#collapse<?= $n3 ?>" aria-expanded="true" aria-controls="collapse<?= $n3 ?>">
                                                                                <?= normal_string($i3->nama_indikator) ?> (<?= normal_string($i->tahun) ?>) <span class="label label-white"><?= $i3->nilai ?></span> <span class="label label-success"><?= $i3->nilai_koreksi ?></span>
                                                                            </a>
                                                                        </h4>
                                                                    </div>
                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="panel-group" id="accordion<?= $n3 ?>" role="tablist" aria-multiselectable="true">
                                                                                ...
                                                                                foreach ($indikator4 as $n4 => $i4) {
                                                                                    $n4 = "level4" . $n3 . $n4;
                                                                                    $pengaturan_waktu = $this->lembar_kerja_evaluasi_model->get_setting_waktu_verif('skpd', $i4->tahun, $id_skpd, $i4->jenis_lke);
                                                                                ?>
                                                                                        ...
                                                                                        <div class="panel-heading" role="tab" id="heading<?= $n4 ?>">
                                                                                            <h4 class="panel-title">
                                                                                                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion<?= $n3 ?>" href="#collapse<?= $n4 ?>" aria-expanded="true" aria-controls="collapse<?= $n4 ?>">
                                                                                                    <?= normal_string($i4->nama_indikator) ?> (<?= normal_string($i->tahun) ?>) <span class="label label-white"><?= $i4->nilai ?></span> <span class="label label-success"><?= $i4->nilai_koreksi ?></span>
                                                                                                </a>
                                                                                            </h4>
                                                                                        </div>
                    ...
                    <?php
                    if($pengaturan_waktu->status=="sudah_verifikasi"){
                        echo "SUDAH DIVeriFiKASI";
                        
                    }else{
                        ?>
                        <a class="btn btn-sm btn-success" href="javascript:void(0);" data-toggle="modal" data-target="#modalVerifikasi" >Verifikasi</a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myLargeModalLabel">Silahkan Approve untuk Verifikasi</h4>
            </div>
            <div class="modal-body">
                <div id="message"></div>
                <form  action="<?= base_url('lembar_kerja_evaluasi/verifikasi_atasan_proses/') ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_lke_pengaturan" value="<?= $pengaturan_waktu->id_lke_pengaturan ?>">
                    <input type="hidden" name="id_skpd" value="<?= $id_skpd ?>">
                    <input type="hidden" name="tahun" value="<?= $i->tahun ?>">
                    <input type="hidden" name="jenis_lke" value="<?= $i->jenis_lke ?>">
                </div>
            <div class="modal-footer">
                <a href="javascript:void(0)" data-dismiss="modal" class="btn btn-default waves-effect text-left">Batal</a>
                <button type="submit" class="btn btn-primary waves-effect text-left">Approve</button>
                </form>
            </div>
        </div>
        <!-- /.modal-content -->
