                                                                        ...
                                                                        <div class="panel-body">
                                                                            ...
                                                                            <div class="panel-group" id="accordion<?= $n3 ?>" role="tablist" aria-multiselectable="true">
                                                                                ...
                                                                                foreach ($indikator4 as $n4 => $i4) {
                                                                                    $n4 = "level4" . $n3 . $n4;
                                                                                    $pengaturan_waktu = $this->lembar_kerja_evaluasi_model->get_setting_waktu('penilai', $i4->tahun);
                                                                                ?>
                                                                                                                        ...
                                                                                                                        <td class="text-center">
                                                                                                                            <?php if ($j->jawaban !== "Belum diisi") { ?>
                                                                                                                                ...
                                                                                                                                <?php if ($j->jawaban_koreksi == "Belum diisi") { ?>
                                                                                                                                    ...
                                                                                                                                    <?php } else {
                                                                                                                                        echo '<span class="btn btn-block mb-2 btn-sm btn-danger">Belum waktunya Koreksi</span>'; ?>
                                                                                                                                    <?php } ?>
                                                                                                                                <?php } else { ?>
