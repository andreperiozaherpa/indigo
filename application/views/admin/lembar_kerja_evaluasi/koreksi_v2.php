...
<input type="text" class="form-control" placeholder="Cari berdasarkan Nama SKPD" name="nama_skpd" value="<?= ($filter) ? $filter_data['nama_skpd'] : '' ?>">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <h3 style="text-align:center;">DAFTAR KOREKSI LKE SKPD - <?= $nama ?> Tahun <?= $year ?></h3><br>
                <hr>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a class="btn btn-small btn-primary" href="<?php echo base_url(); ?>lembar_kerja_evaluasi/koreksi_detail/<?= $jenis_lke . "/" . $rows->id_skpd . "/" . $year ?>">Detail</a></td>
                                </tr>
                            <?php
                                $no++;
                            } ?>
