                  ...
                  <div class="x_content">
                    <br />     <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 " style="text-align:center;">
                          <a href="<?=base_url('ref_pekerjaan/add')?>" > <button type="submit" class="btn btn-success">+ | Tambah pekerjaan</button></a>
                        </div>
                      </div>
                      <br>
                      ...
                      <tbody>
                        ...
                        $no=1; foreach($item as $i){ ?>
                          ...
                          <td>
                            ...
                            <a href="<?=site_url('ref_pekerjaan/edit/'.$i->id_pekerjaan.'')?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a  title='Delete' onclick='delete_(<?=$i->id_pekerjaan?>)' class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
