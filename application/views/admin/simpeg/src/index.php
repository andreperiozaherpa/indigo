...
<html lang="en">
<head>
	<?php $this->load->view('admin/simpeg/src/head');?>
	<style type="text/css">
		.marginleft2px{
			margin-left: 2px;
		}
...
<body>
	...
	<div id="wrapper">
        <!-- Navigation -->
        	<?php $this->load->view('admin/simpeg/src/top_nav');?>
        <!-- Left navbar-header -->
        	<?php $this->load->view('admin/simpeg/src/menu');?>
        ...
        <!-- /#page-wrapper -->
        <?php $this->load->view('admin/simpeg/src/footer');
	...
	<?php $this->load->view('admin/simpeg/src/bottom');?>
