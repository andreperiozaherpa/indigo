          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                      ...
                      <ol class="breadcrumb">
						  <li><a href="#">Home</a></li>
						  <li><a href="<?php echo base_url()."konfirmasi_pendidikan" ; ?> ">Verifikasi</a></li>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Verifikasi <small>Riwayat Pendidikan</small></h2>
...
<table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td><?=$result->nama_jenjangpendidikan;?></td>
                          <td><?=$result->nama_tempatpendidikan;?></td>
						  <td><?=$result->nama_jurusan;?></td>
                          <td><?= date('Y',strtotime($result->tgl_sk)) ;?></td>
						  <td><?=$result->nomor_sk;?></td>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-6">
						  ...
						  <?php
							if ($result->status==0){
								$btn = '
								<a class="btn btn-success pull-left" href="'.base_url().'konfirmasi_pendidikan/ubah_status/'.$result->id.'/1">Setujui Riwayat</a>
								<a class="btn btn-warning pull-left" href="'.base_url().'konfirmasi_pendidikan/ubah_status/'.$result->id.'/2">Tolak Riwayat</a>
								
								';
							}
							else if ($result->status==1){
								$btn = '
								<a class="btn btn-warning pull-left" href="'.base_url().'konfirmasi_pendidikan/ubah_status/'.$result->id.'/0">Batalkan verifikasi</a>
                        ...
                        <div class="col-xs-6">
						  ...
						  ?>
						  <a class="btn btn-default pull-right"  href="<?= base_url();?>konfirmasi_pendidikan">Kembali</a>
                        </div>
                        <!-- /.col -->
                      </div>
                      <!-- /.row -->
