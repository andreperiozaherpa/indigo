<div class="container-fluid">
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Edit kategori berkas </h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <li>	
                <a href="<?php echo base_url();?>ref_kategori_berkas">kategori berkas </a>
            </li>
            <li class="active">		
                <strong>Edit</strong>
            </li>
               ...
               <div class="col-md-12">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-group">
                       <label class="control-label"> kategori berkas </label>
                       <input type="text" id="firstName" value="<?php echo $data->kategori_berkas ?>" name="kategori_berkas" class="form-control" placeholder="">
                   </div>
