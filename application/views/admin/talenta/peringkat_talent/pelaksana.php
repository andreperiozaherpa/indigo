                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="rumpun" id="rumpun">
                                    ...
                                    <?php
                                    foreach ($rumpun as $r) {
                                        $selected = $r->rumpun == $selected_rumpun ? ' selected' : '';
                                        echo '<option value="' . $r->rumpun . '"' . $selected . '>' . $r->rumpun . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <center>
                    ...
                    <p>Rumpun : <b><?= empty($selected_rumpun) ? 'Semua Rumpun' : $selected_rumpun ?></b></b></p>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="text-align: center;">Rumpun : <b><?= empty($selected_rumpun) ? 'Semua Rumpun' : $selected_rumpun ?></b></b></p>
                <div class="table-responsive">
        ...
        transform: rotate(-180deg);">Kompetensi</span></td>
                                <td style="background-color:#fad859;color:black;"><b><?= isset($count_kuadran[4]) ? $count_kuadran[4] : 0 ?></b></td>
                                <td style="background-color:#049372;color:white;"><b><?= isset($count_kuadran[7]) ? $count_kuadran[7] : 0 ?></b></td>
                                <td style="background-color:#1e824c;color:white;"><b><?= $count_kuadran[9] ?></b></td>
                            </tr>
                            <tr>
                                <td style="background-color:#f03434;color:white;"><b><?= isset( $count_kuadran[2]) ? $count_kuadran[2] : 0 ?></b></td>
                                <td style="background-color:#fad859;color:black;"><b><?= isset( $count_kuadran[5]) ? $count_kuadran[5] : 0 ?></b></td>
                                <td style="background-color:#049372;color:white;"><b><?= isset( $count_kuadran[8]) ? $count_kuadran[8] : 0 ?></b></td>
                            </tr>
                            <tr>
                                <td style="background-color:#f03434;color:white;"><b><?= isset( $count_kuadran[1]) ? $count_kuadran[1] : 0 ?></b></td>
                                <td style="background-color:#f03434;color:white;"><b><?= isset( $count_kuadran[3]) ? $count_kuadran[3] : 0 ?></b></td>
                                <td style="background-color:#fad859;color:black;"><b><?= isset( $count_kuadran[6]) ? $count_kuadran[6] : 0 ?></b></td>
                            </tr>
                            <tr>
