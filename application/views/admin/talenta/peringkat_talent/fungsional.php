                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="jabatan" id="jabatan">
                                    ...
                                    foreach ($jabatan as $r) {
                                        $selected = $r->jabatan == $selected_jabatan ? ' selected' : '';
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <center>
                    ...
                    <p>Jabatan : <b><?= empty($selected_jabatan) ? 'Semua Jabatan' : $selected_jabatan ?></b></b></p>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="text-align: center;">Jabatan : <b><?= empty($selected_jabatan) ? 'Semua Jabatan' : $selected_jabatan ?></b></b></p>
                <div class="table-responsive">
