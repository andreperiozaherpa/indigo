<div class="container-fluid">
	...
	<div class="row">
		<div class="col-sm-12">
			<a href="<?=base_url('talenta/kebutuhan').'/detail/'.$id_kebutuhan;?>" class="btn btn-primary btn-outline pull-right">Kembali</a>
			<br><br><br>
			<div class="white-box">
					...
					<div class="col-md-12">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<select class="form-control select2" name="eselon" id="eselon" disabled onchange="get_persyaratan()">
							...
							<div class="form-group">
								...
								<select class="form-control select2" id="id_skpd" disabled name="id_skpd" onchange="get_jabatan()">
									<option value=""><?= $nama_skpd;?></option>
							...
							<div class="form-group">
								...
								<select class="form-control select2" disabled name="id_jabatan" id="id_jabatan">
									<option value=""><?= $nama_jabatan;?></option>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="datepicker"  name="tanggal_buka" placeholder="Pilih Tanggal" value="<?= !empty($tanggal_buka) ? $tanggal_buka : "" ;?>">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" id="datepicker" name="tanggal_tutup" placeholder="Pilih Tanggal" value="<?= !empty($tanggal_tutup) ? $tanggal_tutup : "" ;?>" >
