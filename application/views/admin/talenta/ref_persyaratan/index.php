							...
							<form method="POST">
								...
								<div class="form-group">
									<div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
										<a href='<?php echo base_url('talenta/persyaratan') ?>' class="btn btn-default">Ulangi</a>
							...
							<table class="table table-striped datatable" id="myTable">
								...
								<tbody>
									...
									<tr>
										...
										<td><?=$p->persyaratan?></td>
										<td>
											<a href='/talenta/persyaratan/edit/<?=$p->id_persyaratan;?>' class='btn-xs' title='Edit' data-toggle="tooltip" data-original-title="Edit">

												<i class="fa fa-pencil text-inverse m-r-10"></i> 
											</a>
											<a class='btn-xs' title='Delete'  onclick='delete_("<?= $p->id_persyaratan;?>")' data-toggle="tooltip" data-original-title="Close">
	...
	<script type="text/javascript">
		function delete_(id)
		{
			swal({   
				...
				window.location = "<?php echo base_url();?>talenta/persyaratan/delete/"+id;
