		...
		<div class="col-lg-6 col-md-4 col-sm-4 col-xs-12">
			...
			<div class="row">
				<div class="col-md-8 col-xs-12">
					<div class="white-box">
						<div class="row">
								<a target="_blank" href="<?=base_url();?>talenta/assessment/download/<?=$detail->id_pendaftaran;?>" style="color:grey"><i class="fa fa-file-pdf-o pull-right"></i></a>
						</div>
						<div class="row">
							<h5 class="text-center"><b>LAPORAN HASIL Profilling Kompetensi Eselon <?=$detail->eselon;?></b></h5>
							<br>
