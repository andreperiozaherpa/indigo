				...
				<div class="white-box" style="height:350px;width:auto;">
					<div class="row b-b" style="height:120px;">
						<div class="col-md-4 col-xs-4 b-r text-center" style="height:120px;">
							<br>
							<img src="<?=base_url('data/foto/pegawai/').'/'.$row->foto_pegawai?>" alt="user" style=" object-fit: cover;
				  width: 80px;
				  ...
				  ">
					...
					<div class="row b-b" style="height:130px;">
						<div class="text-center">
							<br>
							<b><i class="fa fa-users"></i> SKPD</b>
							<br>
							<small><?= $row->nama_skpd;?></small><br>
					...
					<div class="row">
						<br>
						<a href="<?= base_url()."talenta/assessment/detail/".$row->id_pendaftaran;?>">
