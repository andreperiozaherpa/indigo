							...
							<div class="col-md-6">
								<table class="table table-bordered">
									...
									<tr>
										...
										<td><?= $detail->perilaku;?></td>
										<td><?= $detail->sasaran_kinerja;?></td>
									</tr>
								</table>
							</div>
						</div>
				...
				<div class="col-md-4 col-xs-12">
					<div class="white-box">
						<?php 
							...
							$image = '<img src="https://e-office.sumedangkab.go.id/data/foto/pegawai/'.$pegawai[0]["foto_pegawai"].'" alt="user-img" style=" object-fit: cover;width: 40px;height: 40px;border-radius: 50%;">';
						?>
						<div class="table-responsive">
