                            ...
                            <div class="row">
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-right"><a href="<?php echo base_url('manage_project/list_worksheet/'.$pr->project_id); ?>" class="fcbtn btn btn-xs btn-info btn-outline btn-1c pull-right"><i class="fa fa-list"></i> Job List</a></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="text-right">
                                        <button class="btn btn-info" type="submit"> Close Project </button>
