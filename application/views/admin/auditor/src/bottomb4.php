    ...
    <script src="<?php echo base_url()."asset/auditor/" ;?>app-assets/vendors/js/forms/select/select2.full.min.js"></script>
    <script src="<?php echo base_url()."asset/auditor/" ;?>app-assets/vendors/js/pickers/flatpickr/flatpickr.min.js"></script>
    ...
    <script src="<?php echo base_url()."asset/auditor/" ;?>app-assets/vendors/js/editors/quill/quill.min.js"></script>
    <script src="<?php echo base_url()."asset/auditor/" ;?>app-assets/vendors/js/forms/validation/jquery.validate.min.js"></script>
    <!-- END: Page Vendor JS-->
