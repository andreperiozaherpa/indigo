    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      ...
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          ...
          <li><a href="<?=base_url('surat_internal/surat_keluar')?>">Surat Keluar</a></li>       
              ...
              <div class="panel-body" style="border-top: solid 3px #6003c8">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <br>
                    <address>
                      <a href="<?php echo base_url('surat_internal/tambah_surat_keluar/'.$l->id_ref_surat.'');?>" class="btn btn-primary btn-1b btn-block" style="color: white"><i class="ti-pencil"></i> Buat Surat</a>
                    </address>
                  </div>
                </div>
              </div>
