...
<div class="col-md-12">
  <a href="<?=base_url('surat_internal/surat_masuk')?>" class="pull-right btn btn-primary btn-outline"><i class="ti-back-left"></i> Kembali</a><br><br>
</div>
   <div class="col-md-3">
    <div class="row">
          ...
          <div class="col-md-12 col-sm-6" >
            <div class="panel panel-primary">
              <div class="panel-body" style="border-top: solid 5px #6003C8">
                ...
                <!-- <a href="<?php echo base_url('surat_internal/edit_surat_masuk/'.$detail->id_surat_masuk) ?>" class="btn btn-info btn-block btn-outline"><i class="ti-pencil"></i> Edit Surat</a> -->
