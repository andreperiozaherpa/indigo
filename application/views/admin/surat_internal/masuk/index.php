...
<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Surat Masuk Internal</h4> </div>
			...
			<div class="col-md-4">
				<div class="row">
					 <div id="tambahSuratEksternal" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel2" aria-hidden="true" style="display: none;">
					...
					<div class="row" >
						...
						<div class="row">
							<div class="col-md-3 text-center b-r">
								...
								<a style="color: #6003c8" href="<?=base_url('surat_internal/surat_masuk')?>">Total Surat</a>
							</div>
							<div class="col-md-3 text-center b-r">
								<h3 class="box-title m-b-0"><?=count($unread)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_internal/surat_masuk')?>/status_surat/Belum Dibaca">Belum dibaca</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($read)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_internal/surat_masuk')?>/status_surat/Sudah Dibaca">Sudah dibaca</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($mustread)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_internal/surat_masuk')?>/status_surat/Perlu Tanggapan">Perlu tanggapan</a>
							</div>
						</div>
						</div>
					</div>
							...
							<div class="mail col-md-4">
									...
									<div class="white-box body">
										...
										<div class="mail-footer">
											<a href="<?php echo base_url('surat_internal/detail_surat_masuk/'.$l->id_surat_masuk);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
										</div>
									</div>
								</div>
							</div>
