...
<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Verifikasi Surat Keluar Internal</h4> </div>
					...
					<div class="row" >
						...
						<div class="col-md-10 col-sm-10"  >
							...
							<div class="col-md-3 text-center b-r">
								...
								<a style="color: #6003c8" href="<?=base_url('surat_internal/verifikasi_surat')?>">Total Surat</a>
							</div>
								<div class="col-md-3 text-center b-r">
									<h3 class="box-title m-b-0"><?= count($sudah_diverifikasi);?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_internal/verifikasi_surat')?>/status_verifikasi/sudah_diverifikasi">Sudah Diverifikasi</a>
								</div>

								<div class="col-md-3 text-center b-r">
									<h3 class="box-title m-b-0"><?= count($menunggu_verifikasi);?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_internal/verifikasi_surat')?>/status_verifikasi/menunggu_verifikasi/">Menunggu Verifikasi</a>
								</div>
								<div class="col-md-3 text-center b-r">
									<h3 class="box-title m-b-0"><?= count($ditolak);?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_internal/verifikasi_surat')?>/status_verifikasi/ditolak/">Ditolak</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="mail col-md-4">
									...
									<div class="row">
										...
										<div class="mail-footer">
											<a href="<?php echo base_url('surat_internal/verifikasi_surat_detail/'.$l->id_surat_keluar);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
										</div>
									</div>
								</div>
							</div>
