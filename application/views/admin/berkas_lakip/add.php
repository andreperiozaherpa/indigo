  ...
  <div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?= base_url();?>berkas_skpd">Berkas Tahunan</a></li>
 ...
 <div class="form-group">
    ...
    <select name="id_skpd" class="form-control" required>
      ...
      <?php 
      foreach($skpd as $r){
        if ($this->input->get('id_skpd') == $r->id_skpd) {
          $selected = "selected";
        } else {
          $selected = "";
        }
 ...
 <div class="form-group">
    ...
    <select name="tahun_berkas_lakip" class="form-control" required>
 ...
 <div class="form-group">
  ...
  <input type="file" name='lainnya' id="input-file-now-custom-3" class="dropify" data-label="<i class='glyphicon glyphicon-file'></i> Browse" />
</div>


</div>
<div class="pull-right">
  <a href="<?=base_url('berkas_skpd')?>" class="btn btn-default ">Batal</a>
