			...
			<div class="white-box">
				<div class="row">
						<div class="col-md-3 b-r">
							<a href="<?php echo base_url() . "master_pegawai/dewan_add"; ?>">
								<button class="btn btn-primary m-t-15 btn-block">Tambah Anggota</button>
							</a>
						</div>
					<form method="POST">
						<div class="col-md-2">
						...
						<div class="col-md-2">
							<div class="form-group">
								<label>NPA</label>
								<input type="text" class="form-control" placeholder="Cari berdasarkan NPA" name="nip" value="<?= ($filter) ? $filter_data['nip'] : '' ?>">
							</div>
						</div>
						<?php
  ...
  ">
								...
								<div class="col-md-12">
									<div style="display: table;" class="row b-t m-t-10 m-b-10">
										<div style="display: table-row;" class="col-md-12 b-r text-center">
											<div style="display: table-cell;width:1200px;text-align:center;vertical-align:middle;height: 75px;"><span><?= $l->jabatan ?></span></div>
											<small style="color:#6003c8;display: block;font-weight: 500"><i data-icon="&#xe030;" class="linea-icon linea-aerrow"></i> Jabatan</small>
										</div>
									</div>

									<a href="<?php echo base_url() . "master_pegawai/dewan_view/" . $l->id_pegawai; ?>">
