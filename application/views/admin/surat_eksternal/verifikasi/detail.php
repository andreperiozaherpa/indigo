...
<div class="container-fluid">
  ...
  <div class="col-md-12">
    <a href="<?= base_url('surat_eksternal/verifikasi_surat') ?>" class="pull-right btn btn-primary btn-outline"><i class="ti-back-left"></i> Kembali</a><br><br>
  </div>
  <div class="col-md-3">
    <div class="row">
  ...
  <div class="col-md-9">
    ...
    <div class="row">
        ...
        <div class="white-box">
          <div class="row" style="margin-bottom: 15px">
            <span style="float: left">
              <h5 class="box-title"><i style="color:#fff;background-color: #6003C8;padding: 5px;border-radius: 50%" class="ti-medall"></i> <span style="border-bottom: solid 2px #6003C8">Sudah disetujui juga oleh</span></h5>
            </span>
      ...
      <div class="white-box">
        ...
        ?>
          <a href="<?= base_url('data/surat_eksternal/keluar/' . $detail->file_draft_surat . '') ?>" class="btn btn-primary" type="button"><span class="btn-label"><i class="ti-cloud-down"></i></span> Download Draf Surat</a>
          <?php
          if ($detail->status_verifikasi == 'sudah_diverifikasi' or $detail->id_pegawai_verifikasi != $this->session->userdata('id_pegawai')) {
          ?>
