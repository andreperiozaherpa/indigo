						...
						<div class="col-md-10 col-sm-10"  >
							...
							<div class="row">
								<div class="col-md-3 text-center b-r">
									...
									<a style="color: #6003c8" href="<?=base_url('surat_eksternal/tanda_tangan')?>">Total Surat</a>
								</div>
								<div class="col-md-3 text-center b-r">
									<h3 class="box-title m-b-0"><?=count($sign);?> </h3>
									<a style="color: #6003c8" href="<?=base_url('surat_eksternal/tanda_tangan')?>/status_ttd/sudah_ditandatangani">Sudah Ditandatangani</a>
								</div>
								<div class="col-md-3 text-center b-r ">
									<h3 class="box-title m-b-0"><?=count($unsign);?> </h3>
									<a style="color: #6003c8" href="<?=base_url('surat_eksternal/tanda_tangan')?>/status_ttd/menunggu_verifikasi">Menunggu Ditandatangani</a>
								</div>
								<div class="col-md-3 text-center b-r ">
									<h3 class="box-title m-b-0"><?=count($tolak);?> </h3>
									<a style="color: #6003c8" href="<?=base_url('surat_eksternal/tanda_tangan')?>/status_ttd/ditolak">Ditolak</a>
								</div>
							</div>
						</div>
					</div>
									...
									<div class="white-box body">
										...
										<h4 class="mail-title"><?=strlen($l->perihal)>=70 ? substr($l->perihal,0,70)."..." : $l->perihal?></h4>
											...
											<div class="mail-footer">
												<a href="<?php echo base_url('surat_eksternal/tanda_tangan_detail/'.$l->id_surat_keluar);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
											</div>
										</div>
									</div>
								</div>
