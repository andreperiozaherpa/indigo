...
<div class="container-fluid">
  ...
  <div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h4 class="page-title">Detail Tandatangan Surat Eksternal</h4>
    </div>
  ...
  <div class="col-md-12">
    <a href="<?= base_url('surat_eksternal/tanda_tangan') ?>" class="pull-right btn btn-primary btn-outline"><i class="ti-back-left"></i> Kembali</a><br><br>
  </div>
  <div class="col-md-3">
    <div class="row">
              ...
              <div class="panel panel-primary">
                <div class="panel-body">
                  ...
                  <div class="text-center">
                    ...
                    <a target="blank" href="<?= base_url('data/surat_eksternal/lampiran/' . $detail->file_lampiran . '') ?>" style="color: #fff" class="btn btn-primary btn-block"><i class="ti-cloud-down"></i> Download Lampiran</a>
                  </div>
                </div>
              </div>
            <?php } ?>
  ...
  <div class="col-md-9">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          if ($detail->status_ttd == "sudah_ditandatangani") {
            ...
            $ext = explode('.', $name)[1];
            if ($ext == "docx") {
              $viewer = "https://view.officeapps.live.com/op/embed.aspx?src=" . base_url('data/surat_eksternal/keluar/' . $detail->file_verifikasi . '');
            } else {
              $viewer = "https://docs.google.com/viewer?url=" . base_url('data/surat_eksternal/draf_pdf/' . $detail->file_verifikasi . '');
            }
            $m_icon = "ti-info";
            $m_alert = "danger";
    ...
    <div class="white-box">
      <div class="row" style="margin-bottom: 15px">
        <span style="float: left">
          ...
          if ($detail->status_ttd == 'sudah_ditandatangani') {
            ...
            $a_type = 'warning';
            $icon = 'ti-time';
            $a_message = '<i class="ti-time"></i> Surat ini memerlukan Tanda Tangan Anda';
          }
          ?>
          <h5 class="box-title"><i style="color:#fff;background-color: #6003C8;padding: 5px;border-radius: 50%" class="ti-check-box"></i> <span style="border-bottom: solid 2px #6003C8">Tandatangan Surat</span></h5></span>
        <span style="float: right;text-align: center;margin-top: -10px;">
          <p style="display: block;margin:2px">Status Tandatangan</p>
      ...
      <?php
      if ($detail->status_ttd == 'ditolak') {
      ?>
        <div class="row">
          <div class="col-md-12">
            <b>Alasan Penolakan</b> : <span class="text-danger" style="font-weight: 400"><?= $detail->alasan_penolakan_ttd ?></span>
          </div>
        </div>
        <br>
      <?php
      ...
      <?php if ($detail->file_ttd) { ?>
        <a href="<?= base_url('data/surat_eksternal/ttd/' . $detail->file_ttd . '') ?>" class="btn btn-primary" type="button"><span class="btn-label"><i class="ti-cloud-down"></i></span> Download Surat Selesai TTD</a>

      <?php } else {
      ?>

        <a href="<?= base_url('data/surat_eksternal/draf_pdf/' . $detail->file_verifikasi . '') ?>" class="btn btn-primary" type="button"><span class="btn-label"><i class="ti-cloud-down"></i></span> Download Surat</a>
      <?php
      } ?>
    </div>
