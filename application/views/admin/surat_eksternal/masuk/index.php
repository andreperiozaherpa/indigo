	...
	<div class="row bg-title">
		...
		<div class="col-md-4">
			<div class="row">
				...
				<a href="<?php echo base_url('surat_eksternal/tambah_surat_masuk');?>" style="font-size: 15px;" class="btn btn-lg btn-rounded btn-primary btn-block"><span class="btn-label"><i data-icon="&#xe003;" class="linea-icon linea-elaborate"></i></span>Tambah Surat Masuk Eksternal</a>
			</div>
			</div>
		</div>
		<div class="col-md-8">
							...
							<div class="mail col-md-4">
									...
									<div class="white-box body">
										...
										<div class="mail-footer">
											<a href="<?php echo base_url('surat_eksternal/detail_surat_masuk/'.$l->id_surat_masuk);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
										</div>
									</div>
								</div>
							</div>
