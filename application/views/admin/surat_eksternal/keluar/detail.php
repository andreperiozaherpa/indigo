...
<div class="container-fluid">
  ...
  <div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h4 class="page-title">Detail Surat Keluar Eksternal</h4> </div>
    ...
    <div class="col-md-12">
      <a href="<?=base_url('surat_eksternal/surat_keluar')?>" class="pull-right btn btn-primary btn-outline"><i class="ti-back-left"></i> Kembali</a>
              ...
              <div class="panel panel-primary">
                <div class="panel-body" style="border-top: solid 5px #6003C8">
                  ...
                  <?php 
                    if($status_surat=='belum_diupload'){
                      ?>
                      <a href="<?=base_url('surat_eksternal/buat_ulang_surat/'.$detail->id_surat_keluar)?>" class="btn btn-info btn-block" style="color: #fff !important"><i class="ti-reload"></i> Refresh Surat</a>
                      <?php
                    }
                  ?>
                </div>
