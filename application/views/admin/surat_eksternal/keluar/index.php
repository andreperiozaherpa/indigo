...
<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Surat Keluar eksternal</h4> </div>
		...
		<div class="col-md-4">
			<div class="row">
				<div style="height: 120px;display: table-cell;vertical-align: middle;width: 999px">
					<a href="<?php echo base_url('surat_eksternal/kategori_surat_keluar');?>" style="font-size: 15px;" class="btn btn-lg btn-rounded btn-primary btn-block"><span class="btn-label"><i data-icon="&#xe003;" class="linea-icon linea-elaborate"></i></span>Tambah Surat Keluar Eksternal</a>
				</div>
			</div>
		</div>
		<div class="col-md-8">
								...
								<div class="white-box body">
									<div class="row">
										...
										<div class="mail-footer">
											<a href="<?php echo base_url('surat_eksternal/detail_surat_keluar/'.$l->id_surat_keluar);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
										</div>
									</div>
								</div>
							</div>
