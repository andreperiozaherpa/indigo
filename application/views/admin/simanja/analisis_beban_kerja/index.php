    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="formRef">
          ...
          <div class="form-group">
            <label for="message-text" class="control-label">Unit Kerja Eselon I</label>
            <select class="form-control select2" name="id_unit_kerja_eselon_i">
              <option value="">-- Pilih --</option>
          ...
          <div class="form-group">
            <label for="message-text" class="control-label">Unit Kerja Eselon II</label>
            <select class="form-control select2" name="id_unit_kerja_eselon_ii">
              <option value="">-- Pilih --</option>
              <?php foreach($jabatan as $i){ ?>
                <option value="<?=$i->id?>"><?=$i->nama?></option>
              <?php } ?>
          ...
          <div class="form-group">
            <label for="message-text" class="control-label">Unit Kerja Eselon III</label>
            <select class="form-control select2" name="id_unit_kerja_eselon_iii">
              <option value="">-- Pilih --</option>
              <?php foreach($jabatan as $i){ ?>
                <option value="<?=$i->id?>"><?=$i->nama?></option>
              <?php } ?>
          ...
          <div class="form-group">
            <label for="message-text" class="control-label">Unit Kerja Eselon IV</label>
            <select class="form-control select2" name="id_unit_kerja_eselon_iv">
              <option value="">-- Pilih --</option>
              <?php foreach($jabatan as $i){ ?>
                <option value="<?=$i->id?>"><?=$i->nama?></option>
              <?php } ?>
          ...
          <div class="form-group">
            ...
            <input type="text" name="urutan" class="form-control" placeholder="Masukkan Urutan Jabatan" <?=$disabled?>>
          </div>
          <div class="form-group">
  ...
  function editRef(id) {
    ...
    $.ajax({
      ...
      success: function(data) {
        ...
        $('[name="id_unit_kerja_eselon_i"]').val(data.id_unit_kerja_eselon_i);
        $('[name="id_unit_kerja_eselon_ii"]').val(data.id_unit_kerja_eselon_ii);
        $('[name="id_unit_kerja_eselon_iii"]').val(data.id_unit_kerja_eselon_iii);
        $('[name="id_unit_kerja_eselon_iv"]').val(data.id_unit_kerja_eselon_iv);
