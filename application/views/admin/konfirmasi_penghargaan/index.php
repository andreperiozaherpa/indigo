<div class="col-md-4 col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <a href='<?= base_url();?>konfirmasi_penghargaan' class="btn btn-primary">Reset</a>
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Daftar Riwayat penghargaan</h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                  ...
                  <div class="x_content">
						...
						if ($result)
						{
							...
							foreach ($result as $row){
								if ($row->status==0)
									...
									if ($row->status!=2){
										$opsi = "<a href=".base_url(). "konfirmasi_penghargaan/view/$row->id class='btn btn-primary btn-xs'><i class='fa fa-book'></i> View </a>";
									}
									else{
					...
					<div class='row'>
						...
						<?php
							...
							$config['base_url'] = base_url(). 'konfirmasi_penghargaan/index/';
...
var tableContainer;
  ...
  function hapus(id,berkas)
  {
    if (confirm("Apakah anda yakin akan menghapus data?")){
		window.location.href = "<?= base_url();?>konfirmasi_penghargaan/delete/"+id+"/"+berkas;
	}
  }
</script>