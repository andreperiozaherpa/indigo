          ...
          <form method="POST">
            ...
            <div class="col-md-9">
              <div class="panel panel-primary">
                <div class="panel-heading"><?= $pegawai->kepala_skpd == "Y" ? $detail_skpd->nama_skpd : $detail_unit_kerja->nama_unit_kerja ?>
                        ...
                        <table class="table">
                          ...
                          ?>
                            ...
                            <tr>
                              <td style="width: 120px;">Nama Kepala </td>
                              <td>:</td>
                              <td> <strong><?= $kepala_unit_kerja->nama_lengkap ?></strong>
                            </tr>
                            <tr>
                              <td style="width: 120px;">Nama SKPD </td>
                              <td>:</td>
                              <td> <strong><?= $detail_skpd->nama_skpd ?></strong>
                            </tr>
                          <?php
                            }
                          ?>
  ...
  <div class="row">
    ...
    for ($tahun = 2019; $tahun <= 2023; $tahun++) {
      if ($pegawai->jenis_pegawai == "staff"||$pegawai->jenis_pegawai == "") {
        ...
        <div class="col-md-12">
          <a href="<?= base_url(); ?>skp_perencanaan/detail/<?= $tahun ?>">
            <div class="panel panel-primary">
