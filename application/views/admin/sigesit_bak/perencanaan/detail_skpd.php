<div id="main-content" class="container-fluid">
   ...
   <div class="row">
      ...
      <div class="col-md-12">
         <div class="white-box">
             <a href="<?=base_url();?>sigesit/perencanaan/tambah">
            <button type="button"class="btn btn-primary e"><i class="fa fa-plus"></i> Tambah Perencanaan </button>
             </a>
            <table class="table">
               <thead>
                  <tr>
               ...
               <tbody id="row-data">
                  <tr>
                   ...
                   <td>20.000.000</td>
                   <td> - </td>
                   <td> <a href="<?=base_url();?>sigesit/perencanaan/detail_perencanaan"><button class="btn btn-outline btn-primary"> Detail</button></a></td>
                </tr>
               </tbody>
            </table>
         </div>
