<div class="container-fluid">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="white-box">
				<h3 class="box-title">Tambah Parameter Penilaian</h3>
				...
				<?php } ?>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="indikator" id="" value="<?=set_value('indikator')?>" placeholder="Masukan indikator penilaian">
					...
					<div class="form-group">
						...
						<textarea name="definisi_operasional" class="form-control" id="" cols="30" rows="3">
							<?=set_value('definisi_operasional')?>
						</textarea>
						<small class="text-danger">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" name="bobot" id="" value="<?=set_value('bobot')?>" placeholder="Masukan bobot penilaian">
						<small class="text-danger">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="informasi_inputan" id="" value="<?=set_value('informasi_inputan')?>" placeholder="Masukan informasi penginputan">
						<small class="text-danger">
					...
					<div class="form-group">
						...
						<input type="number" class="form-control" name="urutan" id="" value="<?=set_value('urutan')?>" placeholder="Masukan urutan">
						<small class="text-danger">
