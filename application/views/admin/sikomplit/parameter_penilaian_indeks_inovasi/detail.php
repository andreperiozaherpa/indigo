							...
							<div class="row m-b">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<p style="line-height: 0"><?=$detail->rancang_bangun?></p>
									</div>
									<div class="form-group">
										<label>Tujuan</label>
										<p style="line-height: 0"><?=$detail->tujuan?></p>
									</div>
									<div class="form-group">
										<label>Manfaat</label>
										<p style="line-height: 0"><?=$detail->manfaat?></p>
									</div>
									<div class="form-group">
										<label>Hasil</label>
										<p style="line-height: 0"><?=$detail->hasil?></p>
									</div>
