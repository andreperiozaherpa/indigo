...
<input type="text" class="form-control" placeholder="Cari berdasarkan Nama SKPD" name="nama_skpd" value="<?= ($filter) ? $filter_data['nama_skpd'] : '' ?>">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="white-box">
                <h3 style="text-align:center;">DAFTAR KOREKSI LKE SKPD - <?= $nama ?> Tahun <?= $tahun_lke ?></h3><br>
                <hr>
                <a href="<?php echo base_url(); ?>lembar_kerja_evaluasi/export_koreksi_filter/<?= $jenis_lke . "/" . $tahun_lke ?>" class="btn btn-md btn-success">Export Excel</a>
                <hr>
                    ...
                    <table id="myTable" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($list as $rows) {
                                $nilai = 0;
                                $nilai_koreksi = 0;
                                $indikator = $this->lembar_kerja_evaluasi_model->get_indikator_filter($jenis_lke, 1, $tahun_lke, $rows->id_skpd);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $nilai ?></td>
                                    <td><?= $nilai_koreksi ?></td>
                                    <td><a class="btn btn-small btn-primary" href="<?php echo base_url(); ?>lembar_kerja_evaluasi/koreksi_detail_filter/<?= $jenis_lke . "/" . $tahun_lke . "/" . $rows->id_skpd ?>">Detail</a></td>
                                </tr>
