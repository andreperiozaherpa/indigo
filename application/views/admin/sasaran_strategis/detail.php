          ...
          <table class="table table-striped table-hover">
            <thead>
             ...
             <tbody>
              ...
              <?php endforeach;?>
              <?php if ($this->session->userdata('level_unit_kerja') == 0 || $this->session->userdata('level') == "Administrator"): ?>
              <tr>
                <td colspan="9">
                  <a href="<?=base_url('sasaran_strategis/indikator/'.$detail->id_sasaran_strategis.'')?>" class="btn btn-info e pull-right"><i class="fa fa-edit"></i> Tambah/Ubah Indikator</a>
                </td>
              </tr>
              <?php endif;?>
          </tbody>
