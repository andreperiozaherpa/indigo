      ...
      <div class="col-md-6">
        <div class="white-box">
          ...
          <div class="form-group">
            ...
            <select name="tahun_rkt" class="form-control" disabled>
          ...
          <div class="form-group">
            ...
            <select name="id_renstra" class="form-control" disabled>
          ...
          <div class="form-group">
            ...
            <input name="nama_kegiatan" type="text" value="<?=$item->nama_kegiatan?>"  class="form-control" placeholder="" disabled>
          </div>


          <div class="form-group">
            <label class="control-label">Indikator Keluaran (Output)</label>
            <input name="indikator_keluaran" type="text" value="<?=$item->indikator_keluaran?>" class="form-control" placeholder="" disabled>
          </div>

          <div class="form-group">
            <label class="control-label">Indikator hasil (Outcome)</label>
            <input name="indikator_hasil" type="text" value="<?=$item->indikator_hasil?>" class="form-control" placeholder="" disabled>
          </div>
          ...
          <div class="row">
            <div class="col-md-6">
             <div class="form-group">
              ...
              <input name="target" type="number" value="<?=$item->target?>" class="form-control" placeholder="" disabled>
            </div>
          </div>
          <div class="col-md-6">
           ...
           <div class="form-group">
            ...
            <select name="id_satuan_target" class="form-control" disabled>
      ...
      <div class="row">
        <div class="col-md-6">
         <div class="form-group">
          ...
          <input name="waktu" value="<?=$item->waktu?>" type="number" class="form-control" placeholder="" disabled>
        </div>
      </div>
      <div class="col-md-6">
       ...
       <div class="form-group">
        ...
        <select name="satuan_waktu" class="form-control" disabled>
 ...
 <div class="form-group">
  ...
  <input name="anggaran" value="<?=$item->anggaran?>" type="text" class="form-control" placeholder="" disabled>
</div>
...
<div class="row">
 <div class="form-group">
   <div class="col-md-12">
    ...
    <select name="id_unit_penanggungjawab" class="form-control" disabled>
...
<div class="pull-right">
  <a href="<?=base_url('ref_rkt')?>" class="btn btn-default ">Kembali</a>
</div>
</div>
