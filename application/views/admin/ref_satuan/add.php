<div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Tambah Satuan Kegiatan</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
							...
							<li>	
								<a href="<?php echo base_url();?>ref_satuan">Satuan Kegiatan</a>
							</li>
							<li class="active">		
			...
			<div class="panel-body">
				...
				<div class='alert alert-$message_type'>$message</div>";?>
                   ...
                   <div class="form-group">
                	<label class="control-label"> Satuan Kegiatan</label>
				...
				<div class="form-group">
					...
					Aktif 
					<input type="checkbox" name="status" value="aktif" checked class="js-switch" data-color="#f96262" data-size="medium" /> 
