<?php foreach ($item as $key) {
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel white-box">
                  ...
                  <div class="x_content">
                  <form method="post" action="<?php echo base_url()."ref_agama/update/".$id;?>">
                    <table class="table table-striped">
                      
                      <tbody>

                        <tr>
                          <td>Nama agama</td><td>  <input type="text" name="nama" class="form-control" placeholder="nama agama" value="<?php echo $nama;?>" required></td></tr>
                                                <tr> 
						 <td>Status </td>
						 <td>
							<?php
