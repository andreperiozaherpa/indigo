        ...
        <div class="col-md-12">
            <div class="white-box">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label>SKPD</label>
                        <select name="id_skpd" id="id_skpd" class="form-control select2">
                            <?php 
                    ...
                    <div class="col-md-2">
                        ...
                        <button type="submit" onclick="filter()" class="btn btn-primary btn-outline">Filter</button>
                    </div>
                    </form>
                    <?php } ?>
                    <div class="col-md-7">
                        <span style="display: block;">&nbsp;</span>
                        <a href="<?= base_url('sicerdas/renstra/laporan?download=1&id_skpd='.$detail_skpd->id_skpd) ?>" class="btn btn-primary pull-right" style="margin-left:10px">Download Laporan Renstra</a>
...
<script>
    ...
    function filter(){
        ...
        window.location = "<?=base_url();?>/sicerdas/renstra/laporan?id_skpd="+id_skpd;
    }
</script>