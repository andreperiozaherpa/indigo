...
<div id="main-content" class="container-fluid">
   ...
   <div class="row">
      ...
      <div class="col-md-12">
         <div class="white-box">
            <button type="button" onclick="add();" class="btn btn-primary e" ><i class="fa fa-plus"></i> Tambah Sasaran  / Tujuan OPD</button>
            <table class="table">
               <thead>
                  <tr>
                     <th width="50px">No.</th>
         ...
         <div class="modal-body">
            <form id="form-data" >
               ...
               <div class="form-group">
                  ...
                  <select id="id_sasaran_rpjmd" name="id_sasaran_rpjmd" class="form-control select2 input_select" >
                     <option value="">Pilih</option>
                  </select>
