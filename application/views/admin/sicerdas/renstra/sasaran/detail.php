      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form id="form-data" >
               ...
               <div class="form-group">
                  <label for="id_indikator_tujuan" class="control-label">Tujuan OPD</label>
                  <select id="id_sasaran_rpjmd" name="id_sasaran_rpjmd" class="form-control select2_ input_select" >
                     <option value="">Pilih</option>
                     ...
                     <div class="form-group" style="display:none;">
                        <label class="">Unit Penanggung Jawab</label>
                           ...
                           <?php foreach($dt_unit_kerja as $key=>$value){
                              ...
                              $checked = ($unit_kerja && in_array($value->id_unit_kerja,$unit_kerja)) ? "checked" : "";
...
<script type="text/javascript">
  ...
  var id_indikator = 0;
  var rowData = {};
  var id_kepala_skpd = "<?= ($dt_skpd->kepala) ? $dt_skpd->kepala->id_pegawai : 0;?>";
  ...
  function edit_sasaran()
   ...
   function add()
   {
    ...
    {
      $("#cascading_"+i).val([id_kepala_skpd]).trigger("change");
    }
