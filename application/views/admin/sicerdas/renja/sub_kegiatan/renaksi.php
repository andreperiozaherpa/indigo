...
<div class="container-fluid">
	...
	<div class="row bg-title">
     ...
     <div class="row">
       <div class="col-md-12">
        <a href="#" style="margin-bottom: 10px;" class="btn btn-primary btn-outline pull-right"><i class="ti-back-left"></i> Kembali</a>
      </div>
    </div>
            ...
            <div class="panel-wrapper collapse in" aria-expanded="true">
             <div class="panel panel-primary">
              ...
              <div class="panel-body">
                <table class="table">
                  <tr><td style="width: 120px;">Nama Kepala </td><td>:</td><td> Nandang Koswara<strong></strong></tr>
  ...
  <div class="row">
        ...
        <div class="panel panel-body">
          <form class="form-horizontal">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <p class="form-control-static">Sub kegiatan 1 </p>
              </div>
            </div>
            <div class="form-group">
              <label class="col-md-12">Indikator Sub Kegiatan</label>
              <div class="col-md-9">
                <p class="form-control-static"> Indikator Sub Kegiatan 1 </p>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6">
                ...
                <div class="col-md-9">
                  <p class="form-control-static"> Dokumen </p>
                </div>
              </div>
              <div class="col-md-6">
                <label class="col-sm-12">Anggaran</label>
                <div class="col-md-9">
                  <p class="form-control-static"> 10.000.000 </p>
                </div>
              </div>
            </div>
    ...
    <div class="panel panel-primary">
        <div class="panel panel-heading">
          Rencana Aksi
          <a href="javascript:void(0)" class="btn btn-default m-1-5 pull-right " style="position:relative;bottom:6px;color: #6003C8 !important" onclick="tambahRenaksi()"><i class="ti-plus"></i> Tambah Renaksi</a>
        </div>
        <div class="panel panel-body ">
                        <div class="row b-t m-t-50" style="margin-top: 0px;padding-top: 30px">
               <p><strong style="padding-top:20px;">Rencana Aksi 1.</strong> Membuat Perencanaan <a style="margin-left: 10px;color:white;" href="javascript:void(0)" onclick="hapusRenaksi(3)" class="btn btn-danger pull-right "><i class="ti-trash"></i> Hapus</a><a href="javascript:void(0)" class="btn btn-primary pull-right " style="color:white;" onclick="editRenaksi('ss',3)"><i class="ti-pencil"></i> Edit</a></p>
               <br>
               <div class="table-responsive">
                <table class="table color-table muted-table">
                  ...
                  <tbody>
                        ...
                        <td style="text-align: center"><span class="label label-primary"><i class="ti-check"></i> Dijadwalkan</span></td>
                        ...
                        <td class=" " style="text-align: center">
                                                      <a href="javascript:void(0)" class="btn btn-primary" style="color:white;" onclick="updateRenaksiDetail('ss',25,0)"><i class="ti-eye"></i> Update Capaian</a>
                                                    </td>
                      </tr>
                                          <tr>
                        <td style="text-align: center">Februari</td>
                        <td style="text-align: center"><span class="label label-danger"><i class="ti-close"></i> Tidak Dijadwalkan</span></td>
                        <td style="text-align: center" class="danger">0</td>
                        <td style="text-align: center" class="danger">0</td>
                        <td style="text-align: center" class="danger">0</td>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" method="POST" enctype='multipart/form-data'>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="checkbox" name="perhitungan_capaian_renaksi" id="rPerhitungan" value="manual" checked class="js-switch" onchange="toggleCapaian()" data-color="#6003c8" data-size="small" /> Hitung Capaian Manual
                </div>
              </div>
    ...
    <script type="text/javascript">
      ...
      function updateRenaksiDetail(jenis,id_target_renaksi,is_inisiatif=0){
        var id_kepala = "<?=$id_kepala?>";

        if(id_kepala==0){
          alert('Kepala SKPD/Unit Kerja tidak ditemukan');
        }else{
          $.getJSON( "<?=base_url('renja_perencanaan/get_target_renaksi/')?>/"+jenis+"/"+id_target_renaksi+"/"+is_inisiatif, function(data) {
