               ...
               <form method="POST">
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Cari berdasarkan Nama Tujuan OPD" name="search" id="search" onkeyup="loadPagination(1)" value="">
                     </div>
                  </div>
                  <div class="col-md-3">
                     <div class="form-group">
         ...
         <div class="modal-body">
            <form id="form-data" >
               ...
               <div class="form-group">
                  ...
                  <textarea id="nama_sasaran_rpjmd" class="form-control input_text" name="nama_sasaran_rpjmd" ></textarea>
