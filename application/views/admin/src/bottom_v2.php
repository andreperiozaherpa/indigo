...
<script src="<?php echo base_url() . "asset/pixel/"; ?>plugins/bower_components/ion-rangeslider/js/ion-rangeSlider/ion.rangeSlider.min.js"></script>
<?php endif?>
...
<script type="text/javascript">
	...
	{
		var num = parseFloat(el.value.replaceAll(",",""));
		var cur = (num>0) ? num.toLocaleString("en-US") : '';
		$("#"+el.id).val(cur);
	}
	$(document).ready(function() {
		...
		<?php if(in_array("rangeslider_sigesit",$plugins)) :?>
		if(document.getElementById('range_usia_1') != null){
			$("#range_usia_1").ionRangeSlider({
				type: "double",
				grid: true,
				min: 10,
				max: 150,
		...
		if(document.getElementById('range_usia_2') != null){
			$("#range_usia_2").ionRangeSlider({
				type: "double",
				grid: true,
				min: 10,
				max: 150,
...
?>
	...
	<script type="text/javascript">
						...
						onadd: function(fld) {
							...
							if (tbl !== '') {
								$.post("<?php echo base_url(); ?>ref_surat/get_columnn/" + tbl, {}, function(obj) {
									...
									$.post("<?php echo base_url(); ?>ref_surat/get_reference_value/" + name + "/<?= $this->uri->segment(3) ?>", {}, function(obj) {
						...
						onadd: function(fld) {
							...
							if (tbl !== '') {
								$.post("<?php echo base_url(); ?>ref_surat/get_columnn/" + tbl, {}, function(obj) {
									...
									$.post("<?php echo base_url(); ?>ref_surat/get_selected/label/" + name + "/<?= $this->uri->segment(3) ?>", {}, function(obj) {
										$(".fld-t_label", fld).val(obj);
									});
									$.post("<?php echo base_url(); ?>ref_surat/get_selected/value/" + name + "/<?= $this->uri->segment(3) ?>", {}, function(obj) {
						...
						onadd: function(fld) {
							...
							if (tbl !== '') {
								$.post("<?php echo base_url(); ?>ref_surat/get_columnn/" + tbl, {}, function(obj) {
									$(".fld-t_value", fld).html(obj);
									$(".fld-t_label", fld).html(obj);
									$.post("<?php echo base_url(); ?>ref_surat/get_selected/label/" + name, {}, function(obj) {
										$(".fld-t_label", fld).val(obj);
									});
									$.post("<?php echo base_url(); ?>ref_surat/get_selected/value/" + name, {}, function(obj) {
										$(".fld-t_value", fld).val(obj);
									});
								});
							}
		...
		setInterval(function() {
			$('#data').val(formBuilder.actions.getData('json', true));
		}, 1000);
			...
			?>
					$("[name='<?= $f->re_r_value ?>'").change(function() {
						...
						?>
							...
							$.post("<?php echo base_url(); ?>ref_surat/get_reference/<?= $f->reference_field ?>/" + reference_value + "/<?= $d->re_table ?>/<?= $d->re_value ?>", {}, function(obj) {
...
<?php if(in_array("tableExport",$plugins)) :?>
<script type="text/javascript" src="<?php echo base_url() . "asset/pixel/"; ?>/plugins/bower_components/tableExport/libs/FileSaver/FileSaver.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() . "asset/pixel/"; ?>/plugins/bower_components/tableExport/libs/js-xlsx/xlsx.core.min.js"></script>
<script type="text/javascript" src="<?php echo base_url() . "asset/pixel/"; ?>/plugins/bower_components/tableExport/tableExport.min.js"></script>
...
<?php if(in_array("zoomscroll",$plugins)) :?>
...
<?php
if ($this->uri->segment(1) == 'dashboard_user' && $this->session->userdata('level') == 'User') {
...
<?php if ($this->router->fetch_class() == 'simpeg'){?>
	<script type="text/javascript">
		setTimeout(function(){ $('#collapse-menu').click(); }, 100);
	</script>
<?php } ?>
