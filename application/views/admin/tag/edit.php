			...
			<div class="panel-body">
				...
				<form role="form" class="form-horizontal " method='post' enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type='hidden'  value='<?php echo $tag_name;?>'  name='old_tag' />
							<input type="text" id='tag_name' value='<?php echo $tag_name;?>' class="form-control" name='tag_name' placeholder="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<p ><?php echo base_url();?>tag/<label id='slug'><?php echo $tag_slug;?></label></p>
							<input type="hidden" value='<?php echo $tag_slug;?>' class="form-control" id='tag_slug' name='tag_slug' placeholder="">
						</div>
					</div>
					<div class="form-group">
