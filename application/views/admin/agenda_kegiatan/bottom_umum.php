<script type="text/javascript">
  ...
  $(document).on('submit', '#form_create', function(){
      ...
      var eventData;
      $.ajax({
          url     : backend_url+'agenda_umum/save',
          ...
          success: function(data)
          {
              if(data.status)
              {
                  eventData = {
                      id          : data.id,
                      id_pegawai  : $('#create_modal input[name=id_pegawai]').val(),
                      id_skpd     : $('#create_modal input[name=id_skpd]').val(),
  ...
  function deleteData(event)
  {
      $('#create_modal .delete_calendar').click(function(){
          $.ajax({
              url     : backend_url+'agenda_umum/delete',
              type    : 'POST',
              data    : 'id='+event.id,
              dataType: 'JSON',
              beforeSend: function()
