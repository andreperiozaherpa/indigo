                    ...
                    <br />
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 " style="text-align:center;">
                          <a href="<?php echo base_url(). "pengajuan_mutasi/add" ;?>" > <button type="submit" class="btn btn-success">+ | Tambah pengajuan mutasi</button></a>
                        </div>
                      </div>
                      <br>
                    <br>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <a href='<?= base_url();?>pengajuan_mutasi' class="btn btn-primary">Reset</a>
                  ...
                  <div class="x_content">
							...
							foreach ($result as $row){
								if ($row->status==0)
									...
									if ($row->status!=3){ // 3 = ditolak
										$opsi = "<a href=".base_url(). "pengajuan_mutasi/view/$row->id class='btn btn-primary btn-xs'><i class='fa fa-book'></i> View </a>";
										if ($row->status==0) {
											$opsi .= "<a href=".base_url(). "pengajuan_mutasi/edit/$row->id class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Edit </a>";
										}
									}
									else{
					...
					<div class='row'>
						...
						<?php
							...
							$config['base_url'] = base_url(). 'pengajuan_mutasi/index/';
