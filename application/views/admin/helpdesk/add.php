		...
		<div class="col-md-12">
			<div class="white-box">
				...
				<div class="form-group">
					<label>Subjek</label>
					<input type="text" name="subjek" value="<?= set_value('subjek') ?>" class="form-control" placeholder="Masukkan Subjek Bantuan">
				</div>
				<div class="form-group">
				...
				?>
					<div class="form-group">
						...
						<input type="text" value="<?= set_value('tanggal_absensi') ?>" id="datepicker" class="form-control" name="tanggal_absensi" placeholder="Tanggal Absensi">
					</div>
					<div class="form-group">
						<labe>Jenis Absen</labe>
				...
				<div class="form-group" id="bug" style="<?= set_value('kategori') == 'bug' ? 'display: block' : 'display: none' ?>">
					<label>URL Bug</label>
					<input type="text" value="<?= set_value('url_bug') ?>" class="form-control" name="url_bug" placeholder="Masukkan URL Bug">
				</div>
				<div class="form-group">
					<label>Deskripsi</label>
					<textarea rows="10" class="textarea_editor form-control" name="isi" placeholder="Uraikan masalah anda disini"><?= set_value('isi') ?></textarea>
				</div>
				<div class="form-group">
					<label>Lampiran</label><br>
					<p>
						<div class="alert alert-danger"><i class="ti-info"></i>Ekstensi file yang diizinkan jpg, jpeg, png, doc, docx, ppt, pptx, txt, xls, xlsx, pdf <br>Ukuran maksimal 3MB per file</div>
					</p>
