...
<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Reviu Renstra</h4> </div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="x_content">
					...
					<?php foreach($list as $l){
						...
						$status = $this->renstra_reviu_model->get_status_reviu_skpd($l->id_skpd);
						
						?>
						<div class="col-md-4 col-sm-6" > 
							<?= status_reviu_skpd($status) ?>
							<div class="white-box">
								...
								<div class="row">
									<div class="col-md-12">
										<br>
										<address>
											<a href="<?php echo base_url();?>renstra_reviu/view/<?=$l->id_skpd?>">
