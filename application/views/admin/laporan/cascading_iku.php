										...
										<div class="white-box">
											<div class="row">
												<div class="col-md-12 col-sm-12">
													...
													<h4>'.$i2->kode_indikator_bawahan.' - '.$i2->nama_indikator_bawahan.'</h4>
													<h5>Target : '.$i2->target_bawahan.'</h5>
												</div>
											</div>
										</div>
										<ul>';
														...
														<div class="white-box">
															<div class="row">
																<div class="col-md-12 col-sm-12">
																	...
																	<h4>'.$i3->kode_indikator_bawahan.' - '.$i3->nama_indikator_bawahan.'</h4>
																	<h5>Target : '.$i3->target_bawahan.'</h5>
																</div>
															</div>
														</div>
													</li>';
