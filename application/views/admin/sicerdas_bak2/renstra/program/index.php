      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select id="id_indikator_program_rpjmd" name="id_indikator_program_rpjmd" class="form-control select2 input_select">
              <option value="">Pilih</option>
            </select>
          ...
          <div class="form-group">
            ...
            <select id="id_indikator_sasaran_renstra" name="id_indikator_sasaran_renstra" class="form-control select2 input_select" >
              <option value="">Pilih</option>
            </select>
