<div id="main-content" class="container-fluid">
  ...
  <div class="row bg-title">
    ...
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h4 class="page-title">Renstra. Kegiatan</h4>
    </div>
    <!-- /.page title -->
    <!-- .breadcrumb -->
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
              ...
              <div class="panel-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="col-md-12 b-b">
                      <h3 class="box-title m-b-0">Sasaran Dari Renstra</h3>
                      <p><?=$detail->nama_sasaran_renstra;?></p>
                    </div>

                    <div class="col-md-12 b-b">
                      <h3 class="box-title m-b-0">Indikator Sasaran Renstra</h3>
                      <p><?=$detail->nama_indikator_sasaran_renstra;?></p>
                    </div>

                    <div class="col-md-12 b-b">
                      <h3 class="box-title m-b-0">Program renstra</h3>
                      <p><?=$detail->kode_program .' - '. $detail->nama_program;?></p>
                    </div>

                    <div class="col-md-12">
                      <h3 class="box-title m-b-0 ">Indikator program</h3>
                      <p><?=$detail->nama_indikator_program_renstra;?></p>
                    </div>
          ...
          <div class="white-box">
            ...
            <strong>Nama Kegiatan :</strong> <?=$detail->kode_kegiatan.' - '. $detail->nama_kegiatan;?>
          ...
          <div class="col-md-12 text-right">
            <a class="btn btn-default" href="<?=base_url();?>sicerdas/renstra/kegiatan?token=<?= md5("SC".$dt_skpd->id_skpd) ;?>">Kembali</a>
              ...
              <form  id="formIndikator" class="form-horizontal">
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                      <input type="text" name="nama_indikator_kegiatan" id="nama_indikator_kegiatan" class="form-control" placeholder="Masukkan Nama Indikator">
                      <div class="text-danger error" id="err_nama_indikator_kegiatan"></div>
                    </div>
                  </div>
                </div>
...
<script type="text/javascript">
  ...
  var rowData = {};
   ...
   function editIndikator(i)
   {
    ...
    $('#formIndikator')[0].reset();
    action = "edit";
    id_indikator = rowData[i].id_indikator_kegiatan;
    id_kegiatan = '<?=$detail->id_kegiatan;?>';
    reset_error();

    $("#nama_indikator_kegiatan").val(rowData[i].nama_indikator_kegiatan);
   ...
   function loadPagination(page_num) {
    ...
    $.ajax({
      url: "<?=base_url()?>sicerdas/renstra/kegiatan_indikator/get_list/" + page_num,
      type: 'post',
      dataType: 'json',
      data: {
   ...
   function saveIndikator()
   {
      ...
      $.ajax({
         url        : "<?=base_url()?>sicerdas/renstra/kegiatan_indikator/save",
         type       : 'post',
         dataType   : 'json',
         data       : formdata,
         processData:false,
   ...
   function hapusIndikator(id) {
    ...
    function(isConfirm) {
      if (isConfirm) {
        $.ajax({
          url        : "<?=base_url()?>sicerdas/renstra/kegiatan_indikator/delete",
          type       : 'post',
          dataType   : 'json',
          data       : {
            id      : id,
