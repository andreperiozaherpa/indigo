    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="id_sasaran_rpjmd" class="control-label"> Sasaran</label>
          ...
          <div class="form-group">
            ...
            <select id="id_indikator_sasaran_rpjmd" name="id_indikator_sasaran_rpjmd" class="form-control select2 input_select" >
              <option value="">Pilih</option>
             <?php foreach($dt_sasaran_indikator->result() as $row){
             	$selected = ($detail->id_indikator_sasaran_rpjmd == $row->id_indikator_sasaran_rpjmd) ? "selected" : "";
