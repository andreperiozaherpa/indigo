<div class="container-fluid">
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Laporan Sub Kegiatan</h4>
        </div>
    ...
    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="id_indikator_program_renstra" onchange="getKegiatan()"></select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="id_kegiatan" onchange="getIndikatorKegiatan()"></select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="id_kegiatan_indikator" onchange="loadPagination(1)"></select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input type="text" onkeyup="loadPagination(1)" placeholder="Cari Sub Kegiatan" class="form-control" name="search" id="search" />
                        </div>
                    </div>
        ...
        <div class="col-md-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="text-center box-title m-b-0" id="title">LAPORAN SUB KEGIATAN</h3>
...
<script type="text/javascript">
    ...
    var id_kegiatan = "<?= ($this->input->get("id_kegiatan")) ? $this->input->get("id_kegiatan")  : "" ;?>";
    var id_kegiatan_indikator = "<?= ($this->input->get("id_kegiatan_indikator")) ? $this->input->get("id_kegiatan_indikator")  : "" ;?>";
    ...
    function loadPagination(p) {
        ...
        if(!isloading)
        {
            isloading = false;
            $.ajax({
                url: "<?=base_url()?>kinerja/laporan/sub_kegiatan/get_list/" + page,
                type: 'post',
                dataType: 'json',
                data: {
                    tahun: $("#tahun").val(),
                    ...
                    id_kegiatan_indikator: $("#id_kegiatan_indikator").val()
                },
    ...
    function getKegiatan()
    {
      $("#id_kegiatan").html("");
      $.ajax({
         url: "<?=base_url()?>kinerja/laporan/sub_kegiatan/get_kegiatan",
         type: 'post',
         dataType: 'json',
         data: {
            id_indikator_program_renstra : $("#id_indikator_program_renstra").val(),
    ...
    function getIndikatorKegiatan()
    {
      $("#id_kegiatan_indikator").html("");
      $.ajax({
         url: "<?=base_url()?>kinerja/laporan/sub_kegiatan/get_indikator_kegiatan",
         type: 'post',
         dataType: 'json',
         data: {
            id_kegiatan : $("#id_kegiatan").val(),
            id_kegiatan_indikator: id_kegiatan_indikator
         },
         success: function (data) {
            $("#id_kegiatan_indikator").html(data.content).trigger("change");
         },
         error: function (xhr, status, error) {
            console.log(xhr.responseText);
            swal("Opps", "Terjadi kesalahan", "error");
    ...
    function download()
    {
        ...
        var link = "<?=base_url();?>kinerja/laporan/sub_kegiatan/download?tahun=" + tahun + "&bulan=" + bulan  + "&nama_skpd="+nama_skpd+'&id_skpd='+id_skpd;
