<div class="container-fluid">
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Arsip SKP Pegawai</h4>
        </div>
    ...
    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" id="tahun" onchange="loadPagination(1)">
                                ...
                                foreach($this->Globalvar->get_tahun() as $key=>$value)
                                {
                                    ...
                                    {
                                        $selected = ($this->input->get("tahun")==$value) ? "selected" : "" ;
                                    }
                                    else{
        ...
        <div class="col-md-12">
            <div class="white-box">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="text-center box-title m-b-0" id="title">ARSIP SKP PEGAWAI</h3>
                            ...
                            <table style="margin-top:50px" class="table table-striped_">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Tahun</th>
                                        <th>Tanggal Arsip</th>
                                        <th width="100px">SKP</th>
                                        <th width="100px">Dokumentasi Kerja</th>
                                        <th width="100px">LKH</th>
                                    </tr>
                                </thead>
                                <tbody id="row-data">
...
<script type="text/javascript">
    ...
    function loadPagination(p) {
        ...
        if(!isloading)
        {
            isloading = false;
            $.ajax({
                url: "<?=base_url()?>kinerja/skp/arsip/get_list/" + page,
                type: 'post',
                dataType: 'json',
                data: {
                    tahun: $("#tahun").val(),
