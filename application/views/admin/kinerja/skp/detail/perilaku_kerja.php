    ...
    <div class="white-box">
        <div class="row">
            <div class="col-md-12">
                ...
                <a class="btn btn-default btn-outline pull-right" target="_blank" href="<?=base_url();?>kinerja/skp/detail/perilaku/download/<?=$token;?>"><i class="fa fa-download"></i> download</a>                            
