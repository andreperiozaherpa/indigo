        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="table-responsive">
                    ...
                    <a class="btn btn-default btn-outline pull-right" target="_blank" href="<?=base_url();?>kinerja/skp/detail/lampiran/download/<?=$token;?>"><i class="fa fa-download"></i> download</a>                            
                    <div id="row-data-lampiran"></div>
                </div>
            </div>
        </div>
    </div>
