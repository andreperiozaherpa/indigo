<div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Tambah Instansi</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
							...
							<li>	
								<a href="<?php echo base_url();?>ref_instansi">Tambah Instansi</a>
							</li>
							<li class="active">		
		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
				...
				<div class="form-group">
               	 ...
               	 <div style="display: none" id="switch" class="form-group">
					...
					<input type="file" name='logo'  id="input-file-now-custom-3" class="dropify"  data-label="<i class='glyphicon glyphicon-file'></i> Browse" />
               	 </div>
