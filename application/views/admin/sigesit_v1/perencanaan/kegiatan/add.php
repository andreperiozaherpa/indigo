<div id="main-content" class="container-fluid">
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Tambah Perencanaan</h4>
        </div>
            ...
            <form id="form-data" class="form-horizontal" onSubmit="return false;">
                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                        ...
                                        <select class="form-control select2" id="id_ref_program" name="id_ref_program"
                                            ...
                                            <?php 
                                                foreach($dt_program as $row){
                                                    echo '<option value="'.$row->id_ref_program.'">'.$row->kode_program.' '.$row->nama_program.'</option>';
                                                }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" onkeyup="currency(this)" placeholder="" id="rencana_anggaran"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="white-box">
                            <div class="row ">
                                <h3>Penerima Bantuan(<span id="total_penerima">0</span> Orang)</h3>
            ...
            <div class="white-box_">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="<?=base_url();?>sigesit/perencanaan/detail/<?=$token;?>"><button class="btn btn-default btn-lg">Kembali</button></a>
    ...
    function loadPagination(page_num) {
        ...
        $.ajax({
            ...
            data: {
                ...
                usia_1 : usia.from,
                usia_2 : usia.to,
                kks : ($("#dtks_jenis_bantuan_KKS").prop("checked")==true) ? 1 : 0,
                pbi : ($("#dtks_jenis_bantuan_PBI").prop("checked")==true) ? 1 : 0,
                kip : ($("#dtks_jenis_bantuan_KIP").prop("checked")==true) ? 1 : 0,
                pkh : ($("#dtks_jenis_bantuan_PKH").prop("checked")==true) ? 1 : 0,
                bpnt : ($("#dtks_jenis_bantuan_BPNT").prop("checked")==true) ? 1 : 0,
            },
            success: function (data) {
                //console.log(data);
