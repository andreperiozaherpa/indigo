                                        ...
                                        <div class="panel-wrapper collapse in" aria-expanded="true" style="">
                                            <div class="panel-body">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name='date' value="<?php echo set_value('date',date('Y-m-d')); ?>" class="form-control mydatepicker" value="<?php echo date('Y-m-d');?>" data-format="yyyy-mm-dd">
                                                ...
                                                <p>Waktu</p>
                                                        <div class="input-group minimal">
                                                            ...
                                                            <input type="text" value="<?php echo set_value('time',date('H:i')); ?>" name='time' value="" class="form-control clockpicker" data-autoclose="true" />
                                                        </div>
                                                <br>
