              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
				...
				<form role="form" class="form-horizontal " method='post' enctype="multipart/form-data">
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td>Nama Sekolah</td><td>  <input type="text" class="form-control" name="nama_tempatpendidikan" placeholder="" value="<?php echo $nama_tempatpendidikan;?>"></td>
						</tr>
						<tr>
							<td>Level</td>
							<td>
					   ...
					   <a href="<?=base_url();?>ref_tempatpendidikan" class="btn btn-default">Kembali</a> 
					</form>
                  </div>
                </div>
              </div>
