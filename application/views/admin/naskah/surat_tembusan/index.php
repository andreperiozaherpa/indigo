...
<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Surat Tembusan</h4> </div>
					...
					<div class="col-md-10 col-sm-10"  >
						...
						<div class="row">
							...
							<div class="col-md-4 text-center b-r">
								...
								<a style="color: #6003c8" href="<?=base_url('surat_eksternal/surat_keluar')?>/status_surat/Belum Dibaca">Belum dibaca</a>
							</div>
							<div class="col-md-4 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($read)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_eksternal/surat_keluar')?>/status_surat/Sudah Dibaca">Sudah dibaca</a>
							</div>
						</div> 
					</div>
				</div>
				...
				<div class="x_content">
					...
					if(count($list) == 0){
						...
						<?php foreach($list as $l){
							...
							if($l->status_tembusan=='Sudah Dibaca'){
								$color1 = "success";
								$color2 = "#00c292";
								$icon = "icon-envelope-open";
								$icon2 = "icon-check";

							}elseif($l->status_tembusan=="Belum Dibaca"){
								$color1 = "danger";
								$color2 = "#F75B36";
							...
							<div class="mail col-md-4">
								<div class="mail-status <?=$color1?>">
									<i class="<?=$icon?>"></i> <?=$l->status_tembusan?>
								</div>
								...
								<div class="white-box body">
									<div class="row">
										...
										<div class="mail-footer">
											<a href="<?php echo base_url('surat_tembusan/detail/'.$l->id_surat_keluar_tembusan);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
										</div>
									</div>
								</div>
							</div>
