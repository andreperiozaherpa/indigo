                        ...
                        <?php if (!empty($files)) {
                            ...
                            foreach ($files as $file) { ?>
                                <tr>
                                    ...
                                    <td></td>
                                    <td>
                                        <a href="<?= base_url('arsip_dinamis/berkas_inaktif/view?x_slug=' . $file->slug . '&for=details') ?>" class="btn btn-sm btn-info"><i class="fa fa-info-circle"></i></a> 
...
<div class="modal fade" id="pinjamBerkas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <button type="submit" class="btn btn-primary waves-effect text-left">Pinjam</button>
      </div>
    </div>
  </div>
</div>
