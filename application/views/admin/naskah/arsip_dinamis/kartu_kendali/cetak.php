...
<div class="container-fluid">
    <table class="table" border="0">
        <tr>
            <td align="center" style="border-top: 0px; font-weight: bold; padding-bottom: 0px">
                ...
                <p style="margin-top: 0px; margin-bottom: 0px;"><?= $kendali->skpd->nama_skpd; ?></p>
            </td>
        </tr>
        <tr>
            <td style="text-align: center; border-top: 0; font-weight: bold; padding-bottom: 0; padding-top: 10px; text-transform: uppercase; text-decoration: underline;">
                KARTU KENDALI <?= $kendali->tipe_kendali; ?>
            </td>
        </tr>
    </table>
    <table class="table table-border" cellpadding="5" cellspacing="5">
        ...
        <tr>
            <td colspan="3">
                <label class="fw-bold">Kepada :</label>
                <p>
                    <?php
        ...
        <tr>
            ...
            <td>
                ...
                <p><?= tanggal($kendali->surat->tgl_surat); ?></p>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <label class="fw-bold">Lembar :</label>
                <p><?= (!empty($kendali->lembar)) ? $kendali->lembar : "-"; ?></p>
            </td>
        </tr>
    <table>
</div>
