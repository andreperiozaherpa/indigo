				...
				<div class="row">
					<form method="POST">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" id="" name="perihal" placeholder="Masukkan Perihal Surat"
											class="form-control" placeholder="" value="<?= ($filter) ? $perihal : '' ?>">
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" id="" name="hash_id"
											...
											placeholder="" value="<?= ($filter) ? $hash_id : '' ?>">
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label class="control-label">Tgl. Penerimaan Surat</label>
										<input type="text" class="form-control" name="tgl_penerimaan" id="datepicker"
											placeholder="Pilih Tanggal Penerimaan"
											value="<?= ($filter) ? $tgl_penerimaan : '' ?>">
									</div>
								</div>
							</div>
						</div>
						<div class="col-md-2 b-l text-center">
							<div class="form-group">
								<br>
								<button type="submit" name="filter_data"
									class="btn btn-primary m-t-5 btn-outline btn-block"><i class="ti-filter"></i>
									Filter</button>
							</div>
						</div>
					</form>
					...
					<div class="col-md-10 col-sm-10">
						...
						<div class="row">
							<div class="col-md-3 text-center b-r">
								...
								<a style="color: #6003c8" href="<?= base_url('naskah/penomoran_surat') ?>">Total Surat</a>
							</div>
							<div class="col-md-3 text-center b-r">
								<h3 class="box-title m-b-0">
									<?= count($registered) ?>
								...
								<a style="color: #6003c8"
									href="<?= base_url('naskah/penomoran_surat/index/status_penomoran/Y') ?>">Sudah
									Diregistrasi</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0">
								...
								<a style="color: #6003c8"
									href="<?= base_url('naskah/penomoran_surat/index/status_penomoran/N') ?>">Belum
									Diregistrasi</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0">
								...
								<a style="color: #6003c8"
									href="<?= base_url('naskah/penomoran_surat/index/status_penomoran/T') ?>">Ditolak</a>
							</div>
						</div>
					</div>
				</div>
								...
								text-overflow: ellipsis;width: 100%;">
									...
									<div style="width: 80%;">
										...
										<span class="label label-primary"><i class="fa fa fa-hashtag"></i>
											<?= $l->hash_id ?></span>
										<span class="label label-<?= $l->jenis_surat == 'internal' ? 'success' : 'danger' ?>"><i
												class="fa fa-tag"></i> <?= humanize($l->jenis_surat) ?></span>
									</div>
									<center>
									</center>
									...
									<div class="mail-receiver">
										<i class="icon-paper-plane"></i> <span class="text">Pembuat Surat</span> <span
									...
									<div class="mail-receiver">
										<i class="ti-calendar"></i> <span class="text">Tgl. Verifikasi</span> <span
											class="label label-primary pull-right"
											style="background-color: #fff;color: #6003C8;border:solid 1px #6003C8;border-radius: 0;"><?= tanggal($l->tgl_verifikasi) ?></span>
									</div>
									<div class="mail-footer">
										<a href="<?php echo base_url('naskah/penomoran_surat/detail/' . $l->id_surat_keluar); ?>"
