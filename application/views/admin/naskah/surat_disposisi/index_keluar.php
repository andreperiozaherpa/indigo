...
<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Surat Disposisi</h4> </div>
					...
					<div class="row" >
						...
						<div class="row">
							<div class="col-md-3 text-center b-r">
								...
								<a style="color: #6003c8" href="<?=base_url('surat_disposisi/internal')?>">Total Surat</a>
							</div>
							<div class="col-md-3 text-center b-r">
								<h3 class="box-title m-b-0"><?=count($unread)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_disposisi/internal')?>/status_surat/Belum Dibaca">Belum dibaca</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($read)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_disposisi/internal')?>/status_surat/Sudah Dibaca">Sudah dibaca</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($mustread)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_disposisi/internal')?>/status_surat/Perlu Tanggapan">Perlu tanggapan</a>
							</div>
						</div>
						</div>
					</div>
							...
							<div class="mail col-md-4">
									...
									<div class="white-box body">
										...
										<div class="mail-receiver">
											<i class="icon-people"></i> <span class="text">Penerima Disposisi</span><span class="label label-primary pull-right" style="background-color: #fff;color: #6003C8;border:solid 1px #6003C8;border-radius: 0;"><?=tanggal($l->tgl_input)?></span>
										</div>

										<?=strlen($l->nama_lengkap_penerima_disposisi)>=35 ? substr($l->nama_lengkap_penerima_disposisi,0,35)."..." : $l->nama_lengkap_penerima_disposisi?>

										<div class="mail-receiver">
											<i class="icon-paper-plane"></i> <span class="text">Pengirim Disposisi</span> <span class="label label-primary pull-right" style="background-color: #fff;color: #6003C8;border:solid 1px #6003C8;border-radius: 0;"><?=tanggal($l->tanggal_surat)?></span>
										</div>
										<?=strlen($l->nama_lengkap_disposisi)>=35 ? substr($l->nama_lengkap_disposisi,0,35)."..." : $l->nama_lengkap_disposisi?>
										<div class="mail-footer">
											<a href="<?php echo base_url('surat_disposisi/detail_keluar/'.$l->id_disposisi_masuk);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
										</div>
									</div>
								</div>
							</div>
