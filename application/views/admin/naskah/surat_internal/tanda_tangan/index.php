<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Tandatangan Surat Internal</h4>
		</div>
						...
						<div class="row">
							<div class="col-md-3 text-center b-r">
								...
								<a style="color: #6003c8"
									href="<?= base_url('naskah/surat_internal/tanda_tangan') ?>">Total Surat</a>
							</div>
							<div class="col-md-3 text-center b-r">
								<h3 class="box-title m-b-0">
									<?= count($sign); ?>
								...
								<a style="color: #6003c8"
									href="<?= base_url('naskah/surat_internal/tanda_tangan') ?>/status_ttd/sudah_ditandatangani">Sudah
									Ditandatangani</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0">
								...
								<a style="color: #6003c8"
									href="<?= base_url('naskah/surat_internal/tanda_tangan') ?>/status_ttd/menunggu_verifikasi">Menunggu
									Ditandatangani</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0">
								...
								<a style="color: #6003c8"
									href="<?= base_url('naskah/surat_internal/tanda_tangan') ?>/status_ttd/ditolak">Ditolak</a>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="white-box body">
									<div class="row">
										...
										<div class="mail-footer">
											<a href="<?php echo base_url('naskah/surat_internal/tanda_tangan_detail/' . $l->id_surat_keluar); ?>"
