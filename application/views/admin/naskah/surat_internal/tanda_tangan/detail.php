...
<div class="container-fluid">
  ...
  <div class="col-md-12">
    <a href="<?= base_url('naskah/surat_internal/tanda_tangan') ?>" class="pull-right btn btn-primary btn-outline"><i
    ...
    <div class="row">
      ...
      <div class="white-box">
        ...
        <?php } else {
          ...
          <a href="<?= base_url('data/surat_internal/draf_pdf/' . $detail->file_verifikasi . '') ?>"
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary" type="submit" name="kembali"><span class="btn-label"><i
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-primary" type="submit" name="tolak"><span class="btn-label"><i
                class="ti-close"></i></span>Tolak</button>
          </form>
        </div>
      </div>
