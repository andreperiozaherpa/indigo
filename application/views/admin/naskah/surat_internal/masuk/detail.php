...
<div class="col-md-12">
  <a href="<?=base_url('naskah/surat_internal/surat_masuk')?>" class="pull-right btn btn-primary btn-outline"><i class="ti-back-left"></i> Kembali</a><br><br>
</div>
   <div class="col-md-3">
    <div class="row">
          ...
          <div class="col-md-12 col-sm-6" >
            <div class="panel panel-primary">
              <div class="panel-body" style="border-top: solid 5px #6003C8">
                ...
                <hr>
                <a href="<?=base_url()?>/data/surat_internal/surat_masuk/<?=$detail->file_surat?>" class="btn btn-primary btn-block btn-outline"><i class="ti-download"></i> Download Surat</a>
                <!-- <a href="<?php echo base_url('naskah/surat_internal/edit_surat_masuk/'.$detail->id_surat_masuk) ?>" class="btn btn-info btn-block btn-outline"><i class="ti-pencil"></i> Edit Surat</a> -->
            ...
            <div class="row">
              <div class="panel panel-default">
                <div class="panel-body">
                  ...
                  <iframe src="https://docs.google.com/viewer?url=<?=base_url()?>/data/surat_internal/surat_masuk/<?=$detail->file_surat?>&embedded=true" width="100%"
                    height="700"
                  ...
                  <div class="row">
                    <div class="col-md-2">
                      <div class="panel panel-default text-center">
                        ...
                        <a href="<?=base_url()?>/data/surat_internal/lampiran/<?=$detail->lampiran?>" class="btn btn-primary btn-block"><i class="ti-download"></i> Download</a>
                      </div></div>
                    </div>
                  </div>
                <?php }else{
    ...
    <script type="text/javascript">
      ...
      function delete_ss_(id)
      {
        swal({
          ...
          window.location = "<?php echo base_url();?>surat_internal/hapus_surat_masuk/<?=$this->uri->segment(3)?>/"+id;
