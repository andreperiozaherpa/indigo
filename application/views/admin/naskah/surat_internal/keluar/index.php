	...
	<div class="row bg-title">
		...
		<div class="col-md-4">
			<div class="row">
				...
				<a href="<?php echo base_url('naskah/surat_internal/kategori_surat_keluar');?>" style="font-size: 15px;" class="btn btn-lg btn-rounded btn-primary btn-block"><span class="btn-label"><i data-icon="&#xe003;" class="linea-icon linea-elaborate"></i></span>Tambah Surat Keluar internal</a>
			</div>
			</div>
		</div>
		<div class="col-md-8">
					...
					<div class="col-md-10 col-sm-10"  >
						...
						<div class="row">
							<div class="col-md-3 text-center b-r">
								...
								<a style="color: #6003c8" href="<?=base_url('naskah/surat_internal/surat_keluar')?>">Total Surat</a>
							</div>
							<div class="col-md-3 text-center b-r">
								<h3 class="box-title m-b-0"><?=count($perlu_tanggapan)?></h3>
								<a style="color: #6003c8" href="<?=base_url('naskah/surat_internal/surat_keluar')?>/status_surat/perlu_tanggapan">Perlu tanggapan</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($dalam_proses)?></h3>
								<a style="color: #6003c8" href="<?=base_url('naskah/surat_internal/surat_keluar')?>/status_surat/dalam_proses">Dalam Proses</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($selesai)?></h3>
								<a style="color: #6003c8" href="<?=base_url('naskah/surat_internal/surat_keluar')?>/status_surat/selesai">Selesai</a>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="mail-status <?=$c1?>" style="background-color: <?=$c2?>">
									...
									<div class="white-box body">
										...
										<div style="width: 80%;">
											...
											<span class="label label-primary"><i class="fa fa fa-key"></i> <?= (!empty($l->surat_klasifikasi)) ? $l->surat_klasifikasi->kode_gabungan : '';?></span>
										</div>
										<center>
										</center>
										...
										foreach($penerima as $k => $p) {
											...
											if($p->jenis_surat=='internal'){
												$t = !empty($p->nama_lengkap) ? $p->nama_lengkap : '';
										...
										<div class="mail-footer">
											<a href="<?php echo base_url('naskah/surat_internal/detail_surat_keluar/'.$l->id_surat_keluar);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
										</div>
									</div>
								</div>
							</div>
