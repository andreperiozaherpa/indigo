...
<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Tandatangan Surat Internal</h4> </div>
						...
						<div class="col-md-10 col-sm-10"  >
							...
							<div class="row">
								<div class="col-md-3 text-center b-r">
									...
									<a style="color: #6003c8" href="<?=base_url('naskah/surat_eksternal/tanda_tangan')?>">Total Surat</a>
								</div>
								<div class="col-md-3 text-center b-r">
									<h3 class="box-title m-b-0"><?=count($sign);?> </h3>
									<a style="color: #6003c8" href="<?=base_url('naskah/surat_eksternal/tanda_tangan')?>/status_ttd/sudah_ditandatangani">Sudah Ditandatangani</a>
								</div>
								<div class="col-md-3 text-center b-r ">
									<h3 class="box-title m-b-0"><?=count($unsign);?> </h3>
									<a style="color: #6003c8" href="<?=base_url('naskah/surat_eksternal/tanda_tangan')?>/status_ttd/menunggu_verifikasi">Menunggu Ditandatangani</a>
								</div>
								<div class="col-md-3 text-center b-r ">
									<h3 class="box-title m-b-0"><?=count($tolak);?> </h3>
									<a style="color: #6003c8" href="<?=base_url('naskah/surat_eksternal/tanda_tangan')?>/status_ttd/ditolak">Ditolak</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="x_content">
						...
						if(count($list) == 0){
							...
							<?php foreach($list as $l){
								...
								if($l->status_ttd=='sudah_ditandatangani'){
									$color1 = "success";
									$color2 = "#00c292";
									$icon = 'icon-check';
									$icon2 = "icon-check";

								}elseif($l->status_ttd=="ditolak"){
									$color1 = "danger";
									$color2 = "#F75B36";
									$icon = "icon-close";
									$icon2 = "icon-close";

								}elseif($l->status_ttd=="menunggu_verifikasi"){
									$color1 = "warning";
									$color2 = "#f8c255";
									$icon = "icon-clock";
									$icon2 = "icon-info";
									$l->status_ttd = "menunggu_ditandatangani";
								}
								?>

								<div class="mail col-md-4">
									<div class="mail-status <?=$color1?>">
										<i class="<?=$icon2?>"></i> <?=normal_string($l->status_ttd)?>
									</div>
									...
									<div class="white-box body">
										...
										<h4 class="mail-title"><?=strlen($l->perihal)>=70 ? substr($l->perihal,0,70)."..." : $l->perihal?></h4>
											...
											<div class="mail-footer">
												<a href="<?php echo base_url('naskah/surat_eksternal/tanda_tangan_detail/'.$l->id_surat_keluar);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
											</div>
										</div>
									</div>
								</div>
