...
<div class="container-fluid">
  ...
  <div class="col-md-12">
    <a href="<?= base_url('naskah/surat_eksternal/tanda_tangan') ?>" class="pull-right btn btn-primary btn-outline"><i
                    ...
                    <p>
                      <span class="text-<?= $color1 ?>">
                        <i style="background-color: <?= $color2 ?>;border-radius: 50%;color: #fff;padding: 5px;"
                          class="<?= $icon2 ?>"></i>
                        <?= normal_string($detail->status_ttd) ?>
                      </span>
                    </p>
                  </div>
                </div>
    ...
    <div class="row">
      <div class="panel panel-default">
        ...
        <?php if ($detail->status_ttd == "menunggu_ditandatangani") { ?>
          <div class="panel-footer">
            <form method="POST">
              <a href="javascript:void(0)" class="btn btn-primary" data-toggle="modal" data-target="#passphrase"><span
                  class="btn-label"><i class="ti-check"></i></span> Tanda Tangani</a>
              <a href="javascript:void(0)" class="btn btn-danger" data-toggle="modal" data-target="#mdTolak"><span
                  class="btn-label"><i class="ti-close"></i></span>Tolak</a>
          </div>
          </form>
        </div>
      <?php } ?>
      <div class="white-box">
        <div class="row" style="margin-bottom: 15px">
          <span style="float: left">
            ...
            <h5 class="box-title"><i style="color:#fff;background-color: #6003C8;padding: 5px;border-radius: 50%"
                class="ti-check-box"></i> <span style="border-bottom: solid 2px #6003C8">Tandatangan Surat</span></h5>
          </span>
        ...
        <?php } else {
          ...
          <a href="<?= base_url('data/surat_eksternal/draf_pdf/' . $detail->file_verifikasi . '') ?>"
