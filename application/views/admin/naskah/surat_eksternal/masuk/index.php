	...
	<div class="row bg-title">
		...
		<div class="col-md-4">
			<div class="row">
				...
				<a href="<?php echo base_url('naskah/surat_eksternal/tambah_surat_masuk');?>" style="font-size: 15px;" class="btn btn-lg btn-rounded btn-primary btn-block"><span class="btn-label"><i data-icon="&#xe003;" class="linea-icon linea-elaborate"></i></span>Tambah Surat Masuk Eksternal</a>
			</div>
			</div>
		</div>
		<div class="col-md-8">
					...
					<div class="row" >
						...
						<div class="row">
							<div class="col-md-3 text-center b-r">
								...
								<a style="color: #6003c8" href="<?=base_url('naskah/surat_eksternal/surat_masuk')?>">Total Surat</a>
							</div>
							<div class="col-md-3 text-center b-r">
								<h3 class="box-title m-b-0"><?=count($unread)?></h3>
								<a style="color: #6003c8" href="<?=base_url('naskah/surat_eksternal/surat_masuk')?>/status_surat/Belum Dibaca">Belum dibaca</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($read)?></h3>
								<a style="color: #6003c8" href="<?=base_url('naskah/surat_eksternal/surat_masuk')?>/status_surat/Sudah Dibaca">Sudah dibaca</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($mustread)?></h3>
								<a style="color: #6003c8" href="<?=base_url('naskah/surat_eksternal/surat_masuk')?>/status_surat/Perlu Tanggapan">Perlu tanggapan</a>
							</div>
						</div>
						</div>
					</div>
							...
							<div class="mail col-md-4">
									...
									<div class="white-box body">
										...
										<div class="mail-footer">
											<a href="<?php echo base_url('naskah/surat_eksternal/detail_surat_masuk/'.$l->id_surat_masuk);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
										</div>
									</div>
								</div>
							</div>
