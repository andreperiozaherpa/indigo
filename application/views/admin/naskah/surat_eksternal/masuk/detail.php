...
<div class="container-fluid">
  ...
  <div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h4 class="page-title">Detail Surat Masuk Eksternal</h4>
    </div>
  ...
  <div class="col-md-12">
    <a href="<?= base_url('naskah/surat_eksternal/surat_masuk') ?>" class="pull-right btn btn-primary btn-outline"><i class="ti-back-left"></i> Kembali</a><br><br>
  </div>
  <div class="col-md-3">
    <div class="row">
          ...
          <div class="col-md-12 col-sm-6">
            <div class="panel panel-primary">
              <div class="panel-body" style="border-top: solid 5px #6003C8">
                ...
                <!-- <a href="<?php echo base_url('naskah/surat_eksternal/edit_surat_masuk/' . $detail->id_surat_masuk) ?>" class="btn btn-info btn-block btn-outline"><i class="ti-pencil"></i> Edit Surat</a> -->
                      ...
                      <div class="panel-body">
                        <div class="steamline">
                          ...
                          <?php if ($detail->tgl_dibaca) : ?>
                            ...
                            <hr>
                          <?php endif ?>
                          <?php $array_disposisi = array();
                          $array_disposisi_user = array();
                          if ($disposisi) : ?>
                            <div class="sl-item">
                              <div class="sl-left"><button type="button" class="btn btn-primary btn-circle  "></button></div>
                              <div class="sl-right">
                          ...
                          <?php endif ?>
                          <div class="text-center">
                            <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#disposisiTembusan" style="color:white;">Disposisikan Surat</a>
                          </div>
                        </div>
        ...
        <form class="form-horizontal" method="post">
          <div class="modal-body">
                                  ...
                                  <div class="panel-body">
                                    <div class="row">
                                      ...
                                      ?>
                                        ...
                                        ?>
                                          <div class="checkbox checkbox-primary col-md-6 checkbox-disposisi-internal" role="listitem" aria-labelledby="<?= strtoupper($value->nama_unit_kerja) . " " . strtoupper($row->nama_lengkap) . " " . strtoupper($row->jabatan) . " " . strtoupper($row->jenis_pegawai) ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-12">
                <?php
                foreach ($catatan_disposisi as $c) {
                ?>
                  <div class="checkbox checkbox-primary">
                    <input id="checkbox1" name="instruksi[]" type="checkbox" value="<?= $c ?>">
                    <label for="checkbox1"><?= $c ?></label>
                  </div>
                <?php } ?>

                <div class="checkbox checkbox-primary">
                  <input id="cbInstruksi" type="checkbox" value="lainnya" onclick="toggleInstruksi()">
                  <label for="checkbox1">Instruksi Lainnya</label>
                  <textarea name="instruksi[]" placeholder="Masukan catatan disposisi" id="frmInstruksi" class="form-control" style="display: none" disabled></textarea>
                </div>
              </div>
              <div class="col-md-12">
              </div>
  ...
  <script type="text/javascript">
    ...
    function delete_ss_(id) {
      swal({
        title: "Apakah anda yakin menghapus surat masuk ini",
        text: "jika data dihapus maka surat masuk di data disposisi dan tembusan ikut terhapus juga",
        type: "warning",
        ...
        window.location = "<?php echo base_url(); ?>surat_eksternal/hapus_surat_masuk/<?= $this->uri->segment(3) ?>/" + id;
    ...
    function search_disposisi(jenis) {
      ...
      for (i = 0; i < div.length; i++) {
        if (filter === "") {
          div[i].style.display = "";
          if (div[i].classList.contains("col-md-6")) {
            jumlah++;
          }
        } else {
    ...
    function select_disposisi(jenis, id, load = null) {
      if ($('#checkbox-disposisi-' + jenis + '-' + id).is(':checked')) {
        ...
        if (load) {
          $('#selected-disposisi-' + jenis + '-' + id).css('border-color', '#cdcdcd');
        }
        if (jenis == "internal") {
          selected_internal++;
    ...
    function select_disposisi_unit_kerja(id, load = null) {
      ...
      if ($('#checkbox-disposisi-' + jenis + '-' + id).is(':checked')) {
        $('#selected-disposisi-' + jenis + '-' + id).removeClass('hide');
        if (load) {
          $('#color-selected-disposisi-' + jenis + '-' + id).removeClass('bg-primary');
          $('#color-selected-disposisi-' + jenis + '-' + id).addClass('bg-default');
        }
