<div class="container-fluid">
  ...
  <div class="row bg-title">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h4 class="page-title">Pilih Kategori Surat Eksternal</h4>
    </div>
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
        <li>Surat Eksternal</li>
        <li><a href="<?= base_url('naskah/surat_eksternal/surat_keluar') ?>">Surat Keluar</a></li>
        ...
        <div class="row">
          ...
          <form method="POST">
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Cari berdasarkan Nama Surat" name="nama_surat"
                      value="<?= ($filter) ? $filter_data['nama_surat'] : '' ?>">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <br>
                <button type="submit" class="btn btn-primary m-t-5 btn-outline"><i class="ti-filter"></i>
                  Filter</button>
                <?php
                if ($filter) {
                  ?>
                ...
                <div class="panel-body" style="border-top: solid 3px #6003c8">
                  <div class="row b-b" style="min-height: 30px;">
                    ...
                    <div class="col-md-8 col-sm-8" style="height: 115px;">
                      <a href="javascript:void(0)" onclick="viewTemplate('<?= $l->template_file ?>')">
                        <h5 style="font-weight: 500" class="m-t-20"><?= $l->nama_surat ?></h5>
                      </a>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <br>
                      <address>
                        <a href="<?php echo base_url('naskah/surat_eksternal/tambah_surat_keluar/' . $l->id_ref_surat . ''); ?>"
                          class="btn btn-primary btn-1b btn-block" style="color: white"><i class="ti-pencil"></i> Buat
                          Surat</a>
                      </address>
                    </div>
                  </div>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <iframe id="docFrame" src="https://view.officeapps.live.com/op/embed.aspx?src=" width="100%" height="700"
