<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Verifikasi Surat Keluar Eksternal</h4>
		</div>
					...
					<div class="row">
						<div class="col-md-3 text-center b-r">
							...
							<a style="color: #6003c8"
								href="<?= base_url('naskah/surat_eksternal/verifikasi_surat') ?>">Total Surat</a>
						</div>
						<div class="col-md-3 text-center b-r">
							<h3 class="box-title m-b-0">
							...
							<a style="color: #6003c8"
								href="<?= base_url('naskah/surat_eksternal/verifikasi_surat') ?>/status_verifikasi/sudah_diverifikasi">Sudah
								Diverifikasi</a>
						</div>
						...
						<div class="col-md-3 text-center b-r">
							...
							<a style="color: #6003c8"
								href="<?= base_url('naskah/surat_eksternal/verifikasi_surat') ?>/status_verifikasi/menunggu_verifikasi/">Menunggu
								Verifikasi</a>
						</div>
						<div class="col-md-3 text-center b-r">
							<h3 class="box-title m-b-0">
							...
							<a style="color: #6003c8"
								href="<?= base_url('naskah/surat_eksternal/verifikasi_surat') ?>/status_verifikasi/ditolak/">Ditolak</a>
						</div>
					</div>
				</div>
			</div>
							...
							<div class="white-box body">
								<div class="row">
									...
									<div class="mail-footer">
										<a href="<?php echo base_url('naskah/surat_eksternal/verifikasi_surat_detail/' . $l->id_surat_keluar); ?>"
