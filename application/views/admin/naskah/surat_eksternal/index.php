										...
										<div class="col-md-12">
											...
											<address>
												<a href="<?php echo base_url();?>renstra_perencanaan/view">
													<a href="<?php echo base_url('surat_internal/verifikasi_surat_detail');?>" class="fcbtn btn btn-primary btn-outline btn-1b btn-block">Detail Surat</a>
												</a>
											</address>
										</div>
									</div>
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<address>
												<a href="<?php echo base_url();?>renstra_perencanaan/view">
													<a href="<?php echo base_url('surat_internal/verifikasi_surat_detail');?>" class="fcbtn btn btn-danger btn-outline btn-1b btn-block">Detail Surat</a>
												</a>
											</address>
										</div>
									</div>
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<address>
												<a href="<?php echo base_url();?>renstra_perencanaan/view">
													<a href="<?php echo base_url('surat_internal/verifikasi_surat_detail');?>" class="fcbtn btn btn-warning btn-outline btn-1b btn-block">Detail Surat</a>
												</a>
											</address>
										</div>
									</div>
