          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                      ...
                      <ol class="breadcrumb">
						  <li><a href="#">Home</a></li>
						  <li><a href="<?php echo base_url()."pengajuan_pensiun" ; ?> ">Pengajuan pensiun</a></li>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Pengajuan pensiun<small></small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <section class="content invoice">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-6">
                          <p class="lead">Keterangan pensiun :</p>
                         
                          <p class="text-muted well well-sm no-shadow" style="margin-top: 10px;">
                            <?=$data_pengajuan->keterangan_pengajuan;?>
                          </p>
						  
						  <a href="<?= base_url()."pengajuan_pensiun";?>" class="btn btn-default" style="margin-right: 5px;"><i class="fa fa-arrow-left"></i> Kembali</a>
						   <?php
						  if ($data_pengajuan->status==2){echo"
						  <a href='".base_url()."pengajuan_pensiun/cetak/$data_pengajuan->id' class='btn btn-default' >
                          ...
                          <div class="table-responsive">
                            <?php
								if ($data_pengajuan->status==0){
									echo'
										<a href="'.base_url().'pengajuan_pensiun/ubah_status/'.$data_pengajuan->id.'/1" class="btn btn-info pull-left"><i class="fa fa-check-square-o"></i> Proses Verifikasi</a>
									';
								}
								else if ($data_pengajuan->status==1){
									echo'
										<a href="'.base_url().'pengajuan_pensiun/ubah_status/'.$data_pengajuan->id.'/2" class="btn btn-success pull-left"><i class="fa fa-check"></i> Selesai</a>
										<a href="'.base_url().'pengajuan_pensiun/ubah_status/'.$data_pengajuan->id.'/3" class="btn btn-warning pull-left"><i class="fa fa-close"></i> Tolak</a>
									';
								}
								else if ($data_pengajuan->status==2){
									echo'
										<a href="'.base_url().'pengajuan_pensiun/ubah_status/'.$data_pengajuan->id.'/0" class="btn btn-warning pull-left"><i class="fa fa-mail-reply"></i> Batalkan Verifikasi</a>
									';
								}
...
function hapus(id,berkas)
  {
    if (confirm("Apakah anda yakin akan menghapus data?")){
		window.location.href = "<?= base_url();?>pengajuan_pensiun/delete/"+id+"/"+berkas;
	}
  }
