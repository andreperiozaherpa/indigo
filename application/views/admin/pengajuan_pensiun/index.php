<div class="col-md-4 col-xs-12">
                    ...
                    <br />
                      ...
                      <div class="form-group">
                        <div class="col-md-12 col-sm-12 col-xs-12 " style="text-align:center;">
                          <a href="<?php echo base_url(). "pengajuan_pensiun/add" ;?>" > <button type="submit" class="btn btn-success">+ | Tambah pengajuan pensiun</button></a>
                        </div>
                      </div>
                      <br>
                    <br>
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                          <a href='<?= base_url();?>pengajuan_pensiun' class="btn btn-primary">Reset</a>
              ...
              <div class="col-md-8 col-sm-8 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Daftar pengajuan pensiun </h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                  ...
                  <div class="x_content">
							...
							foreach ($result as $row){
								if ($row->status==0)
									...
									if ($row->status!=3){ // 3 = ditolak
										$opsi = "<a href=".base_url(). "pengajuan_pensiun/view/$row->id class='btn btn-primary btn-xs'><i class='fa fa-book'></i> View </a>";
										if ($row->status==0) {
											$opsi .= "<a href=".base_url(). "pengajuan_pensiun/edit/$row->id class='btn btn-info btn-xs'><i class='fa fa-pencil'></i> Edit </a>";
										}
									}
									else{
					...
					<div class='row'>
						...
						<?php
							...
							$config['base_url'] = base_url(). 'pengajuan_pensiun/index/';
