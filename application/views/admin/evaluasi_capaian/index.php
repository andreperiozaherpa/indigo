 	...
 	<div class="row bg-title">
 		...
 		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
 			...
 			<ol class="breadcrumb">
 				...
 				<li class="active">Evaluasi Capaian</li>
 			</ol>
 		</div>
 		<!-- /.breadcrumb -->
 	</div>
          ...
          <div class="pull-left">
            <div class="btn-group m-r-10">
              ...
              <ul role="menu" class="dropdown-menu animated flipInX">
                <li><a href="<?=base_url('evaluasi_capaian/detail_unitkerja/'.$row->id_rkt.'')?>" >Detail</a></li>
                <li><a href="#!" onclick="delete_('<?=$row->id_rkt;?>');"  >Hapus</a></li>
                <!-- <li><a href="#">Detail</a></li> -->
              </ul>
            </div>
          </div>
                <center><b style="line-height:40px;color: #fff">Evaluasi Capaian</b></center>
        </div>
        </div>
       <a href="<?=base_url('evaluasi_capaian/detail_unitkerja/'.$row->id_rkt.'')?>">
         <div class="white-box">
          <div class="row">
          ...
          <div class="row">
             ...
             <a href="<?=base_url('evaluasi_capaian/detail_unitkerja').'/'.$row->id_rkt.''?>" class="btn btn-primary btn-block">Evaluasi</a>
                          </div>
          </div>
