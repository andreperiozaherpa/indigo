...
<div class="container-fluid">
	...
	<div class="row bg-title">
											...
											<div class="col-md-4">
												<div class="row">
													<div class="form-group">
														...
														<input type="text" class="form-control" name="nama" placeholder="Nama Pengumuman" value="<?=isset($nama) ? $nama : NULL ;?>" style="width:90%">
													</div>
												</div>
											</div>
												<div class="col-md-8">
														<div class="row">
																<div class="form-group">
																		<label>Periode Pengumuman </label>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="col-md-3">
            <a href="<?php echo base_url('/pengumuman/add'); ?> " class="btn btn-primary"><i class="icon-plus"></i> Tambah Pengumuman </a>
          </div>
          <div class="col-md-9">
      ...
      <div class="row">
				...
				<div class="col-md-4">
					...
					<div class="white-box" style="min-height:200px;">
							<div class="col-md-10">
									<p>
										<small><?=tanggal($png->tanggal);?> </small>
									</p>
									<p>
										<b><?=$png->nama?></b>
									</p>
								...
								<div class="col-md-2">
									<div class="pull-right" style="margin-top:10px;">
										...
										<ul role="menu" class="dropdown-menu">
											<li>
												<a href="<?php echo base_url('pengumuman/ubah/'.$png->id_pengumuman); ?> "><i class="icon-pencil"></i> Edit</a>
											</li>
											<li>
												<a href="<?php echo base_url('pengumuman/delete/'.$png->id_pengumuman); ?> "><i class="icon-trash"></i> Hapus</a>
											</li>
										</ul>
								</div>
						</div>
						<div class="col-md-12">
							<a href="<?php echo base_url('pengumuman/detail/'.$png->id_pengumuman); ?> " class="btn btn-outline-secondary pull-right">Details..</a>
						</div>
							<br>
						</div>
					</div>
