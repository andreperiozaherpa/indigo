                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <ol class="breadcrumb">
							...
							<?php for ($i=0; $i < $level_unit_kerja; $i++): ?>
								<li>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <tr><td>Renstra </td> <td> : </td><td><?= $set_renstra;?></td></tr>
                          <tr><td>RKT </td> <td> : </td><td><?= $set_rkt;?></td></tr>
                          <tr><td>PK </td> <td> : </td><td><?= $set_pk;?></td></tr>
                          <tr><td>LKJ </td> <td> : </td><td><?= $set_lkj;?></td></tr>
