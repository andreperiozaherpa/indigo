...
<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Rencana Kerja SKPD</h4> </div>
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					<li class="active">Rencana Kerja SKPD</li>				</ol>
				</div>
				<!-- /.col-lg-12 -->
			</div>
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					...
					<div class="x_content">
						...
						<?php foreach($list as $l){
							...
							$j_ss = $this->renja_perencanaan_model->get_total_ss($l->id_skpd);
							$j_sp = $this->renja_perencanaan_model->get_total_sp($l->id_skpd);
							$j_sk = $this->renja_perencanaan_model->get_total_sk($l->id_skpd);
							$j_iku = $this->renja_perencanaan_model->get_total_iku($l->id_skpd);
						?>
							...
							<div class="white-box">
								...
								<div class="row">
									<div class="col-md-12">
										<br>
										<address>
											<a href="<?php echo base_url();?>renja_perencanaan/view/<?=$l->id_skpd?>">
