        ...
        <div class="panel panel-body ">
          ...
          if(empty($renaksi)){
            ...
            $no=1; foreach($renaksi as $r){
              $target = $this->renja_perencanaan_model->get_target_renaksi($jenis,$r->$cRenaksi,$is_inisiatif);
              ?>
                    ...
                    foreach($target as $t){
                      ...
                      <tr>
                        ...
                        <td class=" <?=$viewonly?>" style="text-align: center">
                          ...
                          if($t->status_jadwal=='dijadwalkan'){
                            ?>
                            <a href="javascript:void(0)" class="btn btn-primary" style="color:white;" onclick="updateRenaksiDetail('<?=$jenis?>',<?=$t->$cTaRenaksi?>,<?=$is_inisiatif?>)"><i class="ti-eye"></i> Update Capaian</a>
                            <?php
                          }else{
                            ?>
