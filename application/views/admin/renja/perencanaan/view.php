	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					<li><a href="<?=base_url('renja_perencanaan')?>">Rencana Kerja</a></li>				
...
<div class="row">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-wrapper collapse in" aria-expanded="true">
            <div class="panel-body">
             ...
             <?php
              $j_ss = $this->renja_perencanaan_model->get_total_ss($detail->id_skpd);
              $iku_ss = $this->renja_perencanaan_model->get_total_iku_ss($detail->id_skpd);

              $j_sp = $this->renja_perencanaan_model->get_total_sp($detail->id_skpd);
              $iku_sp = $this->renja_perencanaan_model->get_total_iku_sp($detail->id_skpd);

              $j_sk = $this->renja_perencanaan_model->get_total_sk($detail->id_skpd);
              $iku_sk = $this->renja_perencanaan_model->get_total_iku_sk($detail->id_skpd);

              $j_iku = $this->renja_perencanaan_model->get_total_iku($detail->id_skpd);
  ...
  <!-- <?=var_dump($rencana_kerja)?> -->
    <?php foreach ($rencana_kerja as $tahun => $rk) {
      ...
      ?>
    <a href="<?php echo base_url('renja_perencanaan/detail/'.$detail->id_skpd.'/'.$tahun);?>" style="color:#636e72">
      <div class="panel panel-primary">
          <div class="panel-heading">
          ...
          <div class="panel-wrapper collapse in" aria-expanded="true">
              <div class="panel-body">
                <div class="col-sm-2 b-r text-center" style="max-height:110px;">
                    <div data-label="<?=round($grafik_capaian[$tahun],1)?>%" class="css-bar css-bar-<?=$grafik_capaian[$tahun]>=100 ? 100 : roundfive($grafik_capaian[$tahun])?> css-bar-lg"></div>
                </div>
