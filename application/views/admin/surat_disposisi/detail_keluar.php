...
<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Surat Disposisi Keluar</h4> </div>
    ...
    <div class="col-md-12">
      <a href="<?=base_url('surat_disposisi/'.$detail->jenis_surat.'_keluar')?>" class="pull-right btn btn-primary btn-outline"><i class="ti-back-left"></i> Kembali</a><br><br>
    </div>
    <div class="col-md-3">
      <div class="row">
