					...
					<div class="col-md-10 col-sm-10"  >
						...
						<div class="row">
							<div class="col-md-3 text-center b-r">
								...
								<a style="color: #6003c8" href="<?=base_url('surat_disposisi/eksternal')?>">Total Surat</a>
							</div>
							<div class="col-md-3 text-center b-r">
								<h3 class="box-title m-b-0"><?=count($unread)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_disposisi/eksternal')?>/status_surat/Belum Dibaca">Belum dibaca</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($read)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_disposisi/eksternal')?>/status_surat/Sudah Dibaca">Sudah dibaca</a>
							</div>
							<div class="col-md-3 text-center b-r ">
								<h3 class="box-title m-b-0"><?=count($mustread)?></h3>
								<a style="color: #6003c8" href="<?=base_url('surat_disposisi/eksternal')?>/status_surat/Perlu Tanggapan">Perlu tanggapan</a>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="white-box body">
									<div class="row">
										...
										<div class="mail-footer">
											<a href="<?php echo base_url('surat_disposisi/detail/'.$l->id_disposisi_masuk);?>" class="btn btn-primary pull-right"><i class="ti-arrow-circle-right"></i> Detail Surat</a>
										</div>
									</div>
								</div>
							</div>
