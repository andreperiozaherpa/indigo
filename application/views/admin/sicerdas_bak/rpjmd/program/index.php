        ...
        <div class="white-box">
          <div class="row">
            <div class="col-md-3 b-r">
             ...
             <button type="button" onclick="new_data();" class="btn btn-primary btn-block e m-t-20" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Tambah Program </button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="data-id_tujuan" class="control-label"> Sasaran</label>
            <select id="data-id_tujuan" name="id_tujuan" class="form-control" required="">
          ...
          <div class="form-group">
            <label for="data-id_tujuan" class="control-label">Indikator Sasaran</label>
            <select id="data-id_tujuan" name="id_tujuan" class="form-control" required="">
          ...
          <div class="form-group">
            <label for="data-id_tujuan" class="control-label">Urusan</label>
            <select  name="id_tujuan" class="form-control select2" required="">
              <?php foreach($urusan as $u){
                echo"<option value='$u->id_urusan'>$u->nama_urusan</option>";
              }
              ?>
          ...
          <div class="form-group">
            <label for="data-id_tujuan" class="control-label">Sub Urusan</label>
            <select  name="id_tujuan" class="form-control select2" required="">
              <?php foreach($urusan as $u){
                echo"<option value='$u->id_urusan'>$u->nama_urusan</option>";
              }
          ...
          <div class="form-group">
            <label for="data-id_tujuan" class="control-label">Pilih Program</label>
            <select  name="id_tujuan" class="form-control select2"  required="">
  ...
  <table class="table">
    ...
    <tbody>
        <tr>
            ...
            <td><a href="<?=base_url();?>sicerdas/rpjmd_program/detail" class="btn btn-info" style="color:white;"><i class="ti-eye"></i> Detail</a></td>
        </tr>
