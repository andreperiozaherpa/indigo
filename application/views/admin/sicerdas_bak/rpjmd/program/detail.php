<div id="main-content" class="container-fluid">
	...
	<div class="row bg-title">
		...
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			...
			<ol class="breadcrumb">
				...
				<li><a href="https://e-office.sumedangkab.go.id/sasaran_rpjmd">Program RPJMD</a></li>
	...
	<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<div class="white-box">
						<div class="col-md-12">
							...
							<strong>Nama Program :</strong> Meningkatnya akses dan cakupan mutu layanan kesehatan
						</div>
						<hr>
						...
						<table class="table table-bordered table-striped table-hover table-responsive ">
							<thead>
								<tr style="">
									...
									<th colspan="2" style="text-align: center;vertical-align:middle"> 2019</th>
									<th colspan="2" style="text-align: center;vertical-align:middle"> 2020</th>
									<th colspan="2" style="text-align: center;vertical-align:middle"> 2021</th>
									<th colspan="2" style="text-align: center;vertical-align:middle"> 2022</th>
									<th colspan="2" style="text-align: center;vertical-align:middle"> 2023</th>
							...
							<form method="POST" id="formIndikator" class="form-horizontal">
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<div class="col-sm-12">
											...
											</div><select name="id_satuan" class="form-control select2" tabindex="-1" title="" style="display: none;">
												<option value="">Pilih Satuan Pengukuran</option>
												<option value="4">Lokasi</option>
												<option value="5">Kegiatan</option>
												<option value="6">Titik</option>
												<option value="7">Sasaran</option>
												<option value="8">SR</option>
												<option value="9">Kali</option>
												<option value="10">minggu sekali dalam setahun</option>
												<option value="11">Forum/Kampung</option>
												<option value="12">Kelompok</option>
												<option value="13">Orang</option>
												<option value="14">KK</option>
												<option value="15">Hektar</option>
												<option value="16">Unit</option>
												<option value="17">Ha</option>
												<option value="18">m3/detik</option>
												<option value="19">KM</option>
												<option value="20">Kecamatan</option>
												<option value="21">Route</option>
												<option value="22">Paket</option>
												<option value="23">Organisasi</option>
												<option value="24">Sekolah/Pesantren</option>
												<option value="25">Sekolah</option>
												<option value="26">Siswa/guru</option>
												<option value="27">Siswa</option>
												<option value="28">Peserta</option>
												<option value="29">Penyuluh</option>
												<option value="30">Tokoh</option>
												<option value="31">Responden</option>
												<option value="32">SR</option>
												<option value="33">Kali</option>
												<option value="34">minggu sekali dalam setahun</option>
												<option value="35">Forum/Kampung</option>
												<option value="36">Kelompok</option>
												<option value="37">Orang</option>
												<option value="38">KK</option>
												<option value="39">Hektar</option>
												<option value="40">Unit</option>
												<option value="41">Ha</option>
												<option value="42">m3/detik</option>
												<option value="43">KM</option>
												<option value="44">Kecamatan</option>
												<option value="45">Route</option>
												<option value="46">Paket</option>
												<option value="47">Organisasi</option>
												<option value="48">Sekolah/Pesantren</option>
												<option value="49">Sekolah</option>
												<option value="50">Siswa/guru</option>
												<option value="51">Siswa</option>
												<option value="52">Peserta</option>
												<option value="53">Penyuluh</option>
												<option value="54">Tokoh</option>
												<option value="55">Responden</option>
												<option value="56">Bulan</option>
												<option value="57">Minggu</option>
												<option value="58">Hari</option>
												<option value="59">%</option>
												<option value="60">Dokumen</option>
												<option value="61">jenis</option>
												<option value="62">Rp</option>
												<option value="63">indeks</option>
												<option value="64">program</option>
												<option value="65">perusahaan</option>
												<option value="66">perusahaan</option>
												<option value="67">Jiwa</option>
												<option value="68">Point</option>
												<option value="69">opini</option>
												<option value="70">Status</option>
												<option value="71">Angka</option>
												<option value="72">UMKM</option>
												<option value="73">Skor</option>
												<option value="74">Perda/Perbup</option>
												<option value="75">Jumlah</option>
												<option value="76">Trayek</option>
												<option value="77">Orang/ hari </option>
												<option value="78">Ton</option>
												<option value="79">Ekor</option>
												<option value="80">Ribu Ekor</option>
												<option value="81">Objek</option>
												<option value="82">Desa/kelurahan</option>
												<option value="83">Buah</option>
												<option value="84">Kategori</option>
												<option value="85">Instansi</option>
												<option value="86">IKM</option>
												<option value="87">Wilayah</option>
												<option value="88">Koperasi</option>
												<option value="89">Pasar</option>
												<option value="90">Sub Sektor</option>
												<option value="91">Even</option>
												<option value="92">pangaduan</option>
												<option value="94">Level</option>
												<option value="95">nilai</option>
												<option value="96">laporan</option>
												<option value="97">Kelahiran</option>
												<option value="98">Atlet</option>
												<option value="99">Kg</option>
												<option value="100">Produk</option>
												<option value="101">Kegiatan Promosi</option>
												<option value="102">Pelaku Usaha</option>
												<option value="103">Draft</option>
												<option value="104">Risiko Bencana</option>
												<option value="105">OK</option>
												<option value="106">Sistem Informasi</option>
												<option value="107">Sarana Prasarana</option>
												<option value="108">Gedung</option>
												<option value="109">Obyek</option>
												<option value="110">Media Promosi</option>
												<option value="111">Event / Kali</option>
												<option value="112">Raperda</option>
												<option value="113">SKPD</option>
												<option value="114">Raper KDH</option>
												<option value="115">Berita Acara</option>
												<option value="116">Keputusan</option>
												<option value="117">Surat</option>
												<option value="118">Nota Dinas</option>
												<option value="119">Notulensi</option>
												<option value="120">Telaahan Staff</option>
												<option value="121">Berkas</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										<table class="table table-bordered p-t-20">
											...
											<tr>
												...
												<td><input type="text" name="kondisi_awal" class="form-control" placeholder="Masukkan Rupiah"></td>
											</tr>
										</table>
									</div>
									...
									<div class="col-md-6">
										<table class="table table-bordered p-t-20">
											<tr class="active">
												<td colspan="2" style="text-align: center;"><b>Tahun 2021</b></td>
											</tr>
											<tr>
												<td style="text-align: center;"><b>Target</b></td>
												<td style="text-align: center;"><b>Rupiah</b></td>
									...
									<div class="col-md-6">
										<table class="table table-bordered p-t-20">
											<tr class="active">
												<td colspan="2" style="text-align: center;"><b>Tahun 2022</b></td>
											</tr>
											<tr>
												<td style="text-align: center;"><b>Target</b></td>
												<td style="text-align: center;"><b>Rupiah</b></td>
									...
									<div class="col-md-6">
										<table class="table table-bordered p-t-20">
											<tr class="active">
												<td colspan="2" style="text-align: center;"><b>Tahun 2023</b></td>
											</tr>
											<tr>
												<td style="text-align: center;"><b>Target</b></td>
												<td style="text-align: center;"><b>Rupiah</b></td>
									...
									<div class="col-md-6">
										<table class="table table-bordered p-t-20">
											<tr class="active">
												<td colspan="2" style="text-align: center;"><b>Tahun 2024</b></td>
											</tr>
											<tr>
												<td style="text-align: center;"><b>Target</b></td>
												<td style="text-align: center;"><b>Rupiah</b></td>
									...
									<div class="col-md-6">
										<table class="table table-bordered p-t-20">
											<tr class="active">
												<td colspan="2" style="text-align: center;"><b>Tahun 2025</b></td>
											</tr>
											<tr>
												<td style="text-align: center;"><b>Target</b></td>
												<td style="text-align: center;"><b>Rupiah</b></td>
									...
									<div class="form-group">
										<div class="col-md-12">
											...
											<div class="col-sm-12">
												<div class="select2-container select2-container-multi select2" id="s2id_autogen3">
													<ul class="select2-choices">
														<li class="select2-search-field"> <label for="s2id_autogen4" class="select2-offscreen"></label> <input type="text" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" class="select2-input" id="s2id_autogen4" placeholder="" style="width: 27px;"> </li>
													</ul>
												...
												</div><select name="id_skpd[]" class="select2 select2-multiple" multiple="multiple" tabindex="-1" style="display: none;">
													<option value="">Pilih SKPD</option>
													<option value="1">SEKRETARIAT DAERAH</option>
													<option value="2">INSPEKTORAT</option>
													<option value="3">SEKRETARIAT DPRD</option>
													<option value="4">DINAS PENDIDIKAN</option>
													<option value="5">DINAS KESEHATAN</option>
													<option value="6">DINAS PEKERJAAN UMUM DAN PENATAAN RUANG</option>
													<option value="7">DINAS PERUMAHAN, KAWASAN PERMUKIMAN DAN PERTANAHAN</option>
													<option value="8">SATUAN POLISI PAMONG PRAJA</option>
													<option value="9">DINAS SOSIAL, PEMBERDAYAAN PEREMPUAN DAN PERLINDUNGAN ANAK</option>
													<option value="10">DINAS TENAGA KERJA DAN TRANSMIGRASI</option>
													<option value="11">DINAS LINGKUNGAN HIDUP DAN KEHUTANAN</option>
													<option value="12">DINAS KEPENDUDUKAN DAN PENCATATAN SIPIL</option>
													<option value="13">DINAS PEMBERDAYAAN MASYARAKAT DAN DESA</option>
													<option value="14">DINAS PENGENDALIAN PENDUDUK DAN KELUARGA BERENCANA</option>
													<option value="15">DINAS PERHUBUNGAN</option>
													<option value="16">DINAS KOMUNIKASI, INFORMATIKA, PERSANDIAN DAN STATISTIK</option>
													<option value="17">DINAS KOPERASI, USAHA KECIL, MENENGAH, PERDAGANGAN DAN PERINDUSTRIAN</option>
													<option value="18">DINAS PENANAMAN MODAL DAN PELAYANAN TERPADU SATU PINTU</option>
													<option value="19">DINAS PARIWISATA, KEBUDAYAAN, KEPEMUDAAN DAN OLAH RAGA</option>
													<option value="20">DINAS ARSIP DAN PERPUSTAKAAN</option>
													<option value="21">DINAS PERTANIAN DAN KETAHANAN PANGAN</option>
													<option value="22">DINAS PERIKANAN DAN PETERNAKAN</option>
													<option value="23">BADAN PERENCANAAN PEMBANGUNAN, PENELITIAN DAN PENGEMBANGAN DAERAH</option>
													<option value="24">BADAN KEPEGAWAIAN DAN PENGEMBANGAN SUMBER DAYA MANUSIA</option>
													<option value="25">BADAN PENGELOLAAN KEUANGAN DAN ASET DAERAH</option>
													<option value="26">BADAN PENGELOLAAN PENDAPATAN DAERAH</option>
													<option value="30">RUMAH SAKIT UMUM DAERAH</option>
													<option value="33">Kabupaten Sumedang</option>
													<option value="34">DEMO SKPD</option>
													<option value="35">Kantor Kesatuan Bangsa dan Politik</option>
													<option value="36">BADAN PENANGGULANGAN BENCANA DAERAH</option>
													<option value="37">KECAMATAN JATINANGOR</option>
													<option value="38">KECAMATAN CIMANGGUNG</option>
													<option value="39">KECAMATAN TANJUNGSARI</option>
													<option value="40">KECAMATAN PAMULIHAN</option>
													<option value="41">KECAMATAN SUMEDANG SELATAN</option>
													<option value="42">KECAMATAN SUMEDANG UTARA</option>
													<option value="43">KECAMATAN CIMALAKA</option>
													<option value="44">KECAMATAN PASEH</option>
													<option value="45">KECAMATAN DARMARAJA</option>
													<option value="46">KECAMATAN SITURAJA</option>
													<option value="47">KECAMATAN WADO</option>
													<option value="48">KECAMATAN RANCAKALONG</option>
													<option value="49">KECAMATAN TANJUNGKERTA</option>
													<option value="50">KECAMATAN CONGGEANG</option>
													<option value="51">KECAMATAN BUAHDUA</option>
													<option value="52">KECAMATAN JATINUNGGAL</option>
													<option value="53">KECAMATAN JATIGEDE</option>
													<option value="54">KECAMATAN TOMO</option>
													<option value="55">KECAMATAN UJUNGJAYA</option>
													<option value="56">KECAMATAN CISITU</option>
													<option value="57">KECAMATAN SUKASARI</option>
													<option value="58">KECAMATAN GANEAS</option>
													<option value="59">KECAMATAN CISARUA</option>
													<option value="60">KECAMATAN CIBUGEL</option>
													<option value="61">KECAMATAN TANJUNGMEDAR</option>
													<option value="62">KECAMATAN SURIAN</option>
													<option value="63">Akademi Keperawatan</option>
													<option value="64">Badan Narkotika Nasional</option>
													<option value="65">Kelurahan Cipameungpeuk</option>
													<option value="66">Kelurahan Kotakaler</option>
													<option value="67">Kelurahan Kotakulon</option>
													<option value="70">KECAMATAN SUMEDANG UTARA KELURAHAN SITU</option>
													<option value="71">Kelurahan Talun</option>
													<option value="72">Komisi Pemilihan Umum</option>
													<option value="73">Demo SKPD II</option>
													<option value="74">UPT Pusat Kesehatan Masyarakat Sukasari</option>
													<option value="75">UPT Pusat Kesehatan Masyarakat Cimanggung</option>
													<option value="76">UPT Pusat Kesehatan Masyarakat Jatinunggal</option>
													<option value="77">UPT Pusat Kesehatan Masyarakat Ujungjaya</option>
													<option value="78">UPT Pusat Kesehatan Masyarakat Rawat Inap Conggeang</option>
													<option value="79">UPT Pusat Kesehatan Masyarakat Situraja</option>
													<option value="80">UPT Pusat Kesehatan Masyarakat Rawat Inap Darmaraja</option>
													<option value="81">UPT Pusat Kesehatan Masyarakat Cimalaka</option>
													<option value="82">UPT Pusat Kesehatan Masyarakat Cisempur</option>
													<option value="83">UPT Pusat Kesehatan Masyarakat Rawat Inap Jatinangor</option>
													<option value="84">UPT Pusat Kesehatan Masyarakat Sawah Dadap</option>
													<option value="85">UPT Pusat Kesehatan Masyarakat Ganeas</option>
													<option value="86">UPT Pusat Kesehatan Masyarakat Cisitu</option>
													<option value="87">UPT Pusat Kesehatan Masyarakat Rawat Inap Tanjungsari</option>
													<option value="88">UPT Pusat Kesehatan Masyarakat Rawat Inap Sukamantri</option>
													<option value="89">UPT Pusat Kesehatan Masyarakat Buahdua</option>
													<option value="90">UPT Pusat Kesehatan Masyarakat Haurngombong</option>
													<option value="91">UPT Pusat Kesehatan Masyarakat Hariang</option>
													<option value="92">UPT Pusat Kesehatan Masyarakat Sumedang Selatan</option>
													<option value="93">UPT Pusat Kesehatan Masyarakat Paseh</option>
													<option value="94">UPT Pusat Kesehatan Masyarakat Jatigede</option>
													<option value="95">UPT Pusat Kesehatan Masyarakat Rawat Inap Tomo</option>
													<option value="96">UPT Pusat Kesehatan Masyarakat Tanjungkerta</option>
													<option value="97">UPT Pusat Kesehatan Masyarakat Cisarua</option>
													<option value="98">UPT Pusat Kesehatan Masyarakat Situ</option>
													<option value="99">UPT Pusat Kesehatan Masyarakat Margajaya</option>
													<option value="100">UPT Pusat Kesehatan Masyarakat Surian</option>
													<option value="101">UPT Laboratorium Kesehatan Daerah </option>
													<option value="102">UPT Pusat Kesehatan Masyarakat Rancakalong</option>
													<option value="103">UPT Pusat Kesehatan Masyarakat Tanjungmedar</option>
													<option value="104">UPT Pusat Kesehatan Masyarakat Sukagalih</option>
													<option value="105">UPT Pusat Kesehatan Masyarakat Pamulihan</option>
													<option value="106">UPT Pusat Kesehatan Masyarakat Padasuka</option>
													<option value="107">UPT Pusat Kesehatan Masyarakat Cibugel</option>
													<option value="110">KELURAHAN PASANGGRAHAN BARU</option>
													<option value="111">KELURAHAN REGOL WETAN</option>
													<option value="115">UPTD BALAI LATIHAN KERJA</option>
													<option value="116">UPTD METROLOGI</option>
													<option value="117">UPTD Pasar Tanjungsari</option>
													<option value="118">UPTD Pasar Sandang</option>
													<option value="119">UPTD Pasar Conggeang</option>
													<option value="120">UPTD PERIKANAN DAN PETERNAKAN WILAYAH TANJUNGKERTA</option>
													<option value="121">UPTD PASAR HEWAN TANJUNG SARI</option>
													<option value="122">UPTD PERIKANAN DAN PETERNAKAN WILAYAH CONGGEANG</option>
													<option value="123">UPTD PERIKANAN DAN PETERNAKAN WILAYAH SITURAJA</option>
													<option value="124">UPTD BALAI BENIH IKAN</option>
													<option value="125">UPTD PERIKANAN DAN PETERNAKAN WILAYAH WADO</option>
													<option value="126">UPTD PERIKANAN DAN PETERNAKAN WILAYAH TOMO</option>
													<option value="127">UPTD PERIKANAN DAN PETERNAKAN WILAYAH PAMULIHAN</option>
													<option value="128">UPTD PERALATAN DAN PERBENGKELAN</option>
													<option value="129">UPTD LABORATORIUM BAHAN KONSTRUKSI </option>
													<option value="130">UPTD PEKERJAAN UMUM DAN PENATAAN RUANG WILAYAH PAMULIHAN</option>
													<option value="131">UPTD PEKERJAAN UMUM DAN PENATAAN RUANG WILAYAH TANJUNGKERTA</option>
													<option value="132">UPTD PEKERJAAN UMUM DAN PENATAAN RUANG WILAYAH SITURAJA</option>
													<option value="133">UPTD PEKERJAAN UMUM DAN PENATAAN RUANG WILAYAH CIMALAKA</option>
													<option value="134">UPTD PEKERJAAN UMUM DAN PENATAAN RUANG WILAYAH CONGGEANG</option>
													<option value="135">UPTD PEKERJAAN UMUM DAN PENATAAN RUANG WILAYAH WADO</option>
													<option value="136">UPTD PEKERJAAN UMUM DAN PENATAAN RUANG WILAYAH SUMEDANG KOTA</option>
													<option value="137">UPTD PEKERJAAN UMUM DAN PENATAAN RUANG WILAYAH TOMO</option>
													<option value="138">UPTD PEKERJAAN UMUM DAN PENATAAN RUANG WILAYAH TANJUNGSARI</option>
													<option value="139">UPT Gudang Farmasi dan Perbekalan Kesehatan</option>
													<option value="140">Desa Cijati</option>
													<option value="141">Desa Cimanggung</option>
													<option value="142">Desa Cimanggung</option>
													<option value="143">UPT Pusat Kesehatan Masyarakat Kotakaler</option>
													<option value="144">UPT Pusat Kesehatan Masyarakat Wado</option>
													<option value="145">UPT DAMKAR TANJUNGSARI</option>
													<option value="146">UPT DAMKAR DARMARAJA</option>
													<option value="147">UPTD PERTANIAN WILAYAH WADO</option>
													<option value="148">UPTD PERTANIAN WILAYAH CIBUGEL</option>
													<option value="149">UPTD PERTANIAN WILAYAH TOMO</option>
													<option value="150">UPTD PERTANIAN WILAYAH UJUNGJAYA</option>
													<option value="151">UPTD PERTANIAN WILAYAH PASEH</option>
													<option value="152">UPTD PERTANIAN WILAYAH CIMALAKA</option>
													<option value="153">UPTD PERTANIAN WILAYAH CISARUA</option>
													<option value="154">UPTD PERTANIAN WILAYAH TANJUNGKERTA</option>
													<option value="155">UPTD BALAI BENIH HOLTIKULTURA RANCAKALONG</option>
													<option value="156">UPTD AGROBISNIS TEMBAKAU TANJUNGSARI</option>
													<option value="157">UPTD Pertanian Balai Benih Padi dan Palawija </option>
													<option value="158">UPT PENGENDALIAN PENDUDUK WIL WADO</option>
													<option value="159">UPT PENGENDALIAN PENDUDUK WIL SITURAJA</option>
													<option value="160">UPT PENGENDALIAN PENDUDUK WIL DARMARAJA</option>
													<option value="161">UPT PENGENDALIAN PENDUDUK WIL TANJUNGMEDAR</option>
													<option value="162">UPT PENGENDALIAN PENDUDUK WIL BUAHDUA</option>
													<option value="163">UPT PENGENDALIAN PENDUDUK WIL CONGGEANG</option>
													<option value="164">UPT PENGENDALIAN PENDUDUK WIL CIMALAKA</option>
													<option value="165">UPT PENGENDALIAN PENDUDUK WIL SUMEDANG UTARA</option>
													<option value="166">UPT PENGENDALIAN PENDUDUK WIL SUMEDANG SELATAN</option>
													<option value="167">UPT PENGENDALIAN PENDUDUK WIL PAMULIHAN</option>
													<option value="168">UPT PENGENDALIAN PENDUDUK WIL TANJUNGSARI</option>
													<option value="169">UPT PENGENDALIAN PENDUDUK WIL JATINANGOR</option>
													<option value="170">UPT PENGENDALIAN PENDUDUK WIL TOMO</option>
													<option value="171">UPTD Pertanian Kawasan Agroteknobisnis </option>
													<option value="172">UPTD PERTANIAN WILAYAH SURIAN</option>
													<option value="173">UPTD Pertanian Wilayah Buahdua </option>
													<option value="174">UPTD Pertanian Wilayah Conggeang </option>
													<option value="175">UPTD Pertanian wilayah Tanjungmedar </option>
													<option value="177">UPTD Pertanian wilayah Cisitu </option>
													<option value="178">UPTD Pertanian wilayah Situraja </option>
													<option value="179">UPTD Pertanian wilayah Ganeas </option>
													<option value="180">UPTD PERTANIAN WILAYAH SUMEDANG UTARA</option>
													<option value="181">UPTD Pertanian wilAYAH Sumedang Selatan </option>
													<option value="182">UPTD Pertanian wilayah Cimanggung </option>
													<option value="183">UPTD Pertanian wilayah Rancakalong </option>
													<option value="184">UPTD Pertanian wilayah Sukasari </option>
													<option value="185">UPTD Pertanian wilayah Pamulihan </option>
													<option value="186">UPTD Pertanian wilayah Tanjungsari </option>
													<option value="187">UPTD Pertanian wilayah Jatinangor </option>
													<option value="188">UPTD Penerangan Jalan Umum</option>
													<option value="189">UPTD Terminal Wado</option>
													<option value="190">UPTD Pengujian Kendaraan Bermotor</option>
													<option value="191">UPTD Pertanian wil Darmaraja</option>
													<option value="192">UPTD Pertanian wil jatigede</option>
													<option value="193">UPTD Pertanian wil Jatinunggal</option>
													<option value="195">UPTD Perikanan dan Peternakan Wilayah Tanjungsari</option>
													<option value="196">UPTD Perikanan dan Peternakan Wilayah Cimalaka</option>
													<option value="197">SMPN 1 Tanjungkerta</option>
													<option value="198">SMPN 1 Rancakalong</option>
													<option value="199">SMPN 2 Ganeas</option>
													<option value="200">SMPN 1 CISITU</option>
													<option value="201">SMPN 2 TOMO</option>
													<option value="202">SMPN 2 Jatinunggal</option>
													<option value="203">SMPN 2 RANCAKALONG</option>
													<option value="204">SMPN 2 Situraja</option>
													<option value="205">SMPN 2 SUMEDANG</option>
													<option value="206">SMPN 3 Sumedang</option>
													<option value="207">SMPN 2 Cimalaka</option>
													<option value="208">SMPN 1 Jatigede</option>
													<option value="209">SMPN 9 Sumedang</option>
													<option value="210">SMPN 1 CIMALAKA</option>
													<option value="211">SMPN 2 Jatinangor</option>
													<option value="212">SMPN 4 Pamulihan</option>
													<option value="213">SMPN 1 BUAHDUA</option>
													<option value="214">SPNF SKB Sumedang</option>
													<option value="215">UPT Dinas Pendidikan Situraja</option>
													<option value="216">UPT Dinas Pendidikan Paseh</option>
													<option value="217">UPT Dinas Pendidikan Cisitu</option>
													<option value="218">UPT Dinas Pendidikan Pamulihan </option>
													<option value="219">UPT Dinas Pendidikan Cisarua</option>
													<option value="220">UPT Dinas Pendidikan Sukasari</option>
													<option value="221">UPT Dinas Pendidikan Tanjungsari</option>
													<option value="222">Upt Dinas Pendidikan Cimanggung</option>
													<option value="223">UPT Dinas Pendidikan Sumedang Utara</option>
													<option value="224">UPT DInas Pendidikan SURIAN</option>
													<option value="225">SMP Negeri 3 Jatinunggal</option>
													<option value="226">SD Negeri Dayeuhluhur</option>
													<option value="227">SD Negeri Cipacing I</option>
													<option value="228">SD Negeri Ciherang</option>
													<option value="229">SD Negeri Parakanmuncang II</option>
												</select>
											</div>
										</div>
									</div>
		...
		<footer class="footer text-center"> Copyright 2021 © Made with <i class="fa fa-heart text-danger"></i> by Diskominfosanditik Sumedang - versi 2.3</footer>
	</div>
