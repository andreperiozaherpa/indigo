                        ...
                        <div class="white-box">
                            ...
                            <div class="progress m-b-0">
                                <div class="progress-bar progress-bar-info" role="progressbar"
                                    aria-valuenow="<?=$p_aktivitas;?>" aria-valuemin="0" aria-valuemax="100"
                                    style="width:<?=$p_aktivitas;?>%;"> <span class="sr-only"><?=$p_aktivitas;?>%
                                        Complete</span> </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="progress m-b-0">
                                <div class="progress-bar progress-bar-success" role="progressbar"
                                    aria-valuenow="<?=$p_digunakan;?>" aria-valuemin="0" aria-valuemax="100"
                                    style="width:<?=$p_digunakan;?>%;"> <span class="sr-only"><?=$p_digunakan;?>%
                                        Complete</span> </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="panel-body">
                            <div class="row ">
                                ...
                                <div class="col-md-4" style="padding:0px 0px 0px 10px;margin-bottom:10px;">
                                    <select class="form-control select2" id="kddesa_penerima"
                                        onchange="loadPagination(1)">
                                        <option value="">Semua Desa</option>
                                    </select>
                                </div>
                                <div class="col-md-4" style="padding:0px 0px 0px 10px;margin-bottom:10px;">
                                    <input id="search_penerima" onkeyup="loadPagination(1)" type="text"
                                            ...
                                            <div class="col-md-2" style="margin-top:10px">
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-primary">
                                                        <input onclick="loadPagination(1)"
                                                            id="penerima_jenis_bantuan_<?=$val;?>"
                                                            name="penerima_jenis_bantuan[]" type="checkbox">
                                                        <label for="penerima_jenis_bantuan_<?=$val;?>"> <?=$val;?>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="white-box">
                <div class="panel panel-default">
                    <div class="panel-heading">Pelaksanaan Kegiatan
                        <button onclick="add_aktivitas()" class="btn m-b-5 btn-primary pull-right"> <i
                                class="fa fa-plus"></i> Laporkan Aktivitas</button>
                    </div>
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            ...
                            <div class="col-md-12 text-center">
                                <button class="btn btn-outline btn-primary" id="load_more" onclick="load_more()">Muat
                                    lainnya</button>
                            </div>
                        </div>
                    </div>
...
function tambah_realisasi() {
    ...
    var action = '<button onclick="hapus_realisasi(' + i +
        ')" class="btn btn-secondary"><i class="fa fa-trash"></i></button>';


    var row = '<tr id="realisasi_' + i + '">' +
        '<td><input id="nama_kegiatan_' + i +
        '" name="realisasi[nama_kegiatan][]" type="text" class="form-control" placeholder=""></td>' +
        '<td><input onkeyup="kalkulasi(' + i + ')" id="jumlah_' + i +
        '" name="realisasi[jumlah][]" type="number" class="form-control" placeholder=""></td>' +
        '<td><input onkeyup="kalkulasi(' + i + ')" id="harga_' + i +
        '" name="realisasi[harga][]" type="text" class="form-control" placeholder=""></td>' +
        '<td><input id="satuan_' + i +
        '" name="realisasi[satuan][]" type="text" class="form-control" placeholder=""></td>' +
