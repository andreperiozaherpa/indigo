		...
		<div class="row">
			<div class="col-md-12 col-sm-12 col-xs-12">
				...
				<div class="x_content">
                        <div class="row">
                            <div class="col-md-3">
                            	<a href="<?php echo base_url('verifikasi_usulan') ?>">
                                <div class="white-box" style="border-top : solid 4px #22a7f0">
                                    <h3 class="box-title">TOTAL</h3>
                                    <ul class="list-inline two-part">
                                        <li><i class="ti-user text-primary"></i></li>
                                        <li class="text-right"><span class="counter" style="color: #686868"><?=$c_total?></span></li>
                                    </ul>
                                </div>
                            </a>
                            </div>
                            <div class="col-md-3">
                            	<a href="<?php echo '?status=pending' ?>">
                                <div class="white-box" style="border-top : solid 4px #f8c255">
                                    <h3 class="box-title">MENUNGGU VERIFIKASI</h3>
                                    <ul class="list-inline two-part">
                                        <li><i class="ti-time text-warning"></i></li>
                                        <li class="text-right"><span class="counter" style="color: #686868"><?=$c_pending?></span></li>
                                    </ul>
                                </div>
                            </a>
                            </div>
                            <div class="col-md-3">
                            	<a href="<?php echo '?status=terima' ?>">
                                <div class="white-box" style="border-top : solid 4px #00c292">
                                    <h3 class="box-title">DITERIMA</h3>
                                    <ul class="list-inline two-part">
                                        <li><i class="ti-check text-success"></i></li>
                                        <li class="text-right"><span class="counter" style="color: #686868"><?=$c_terima?></span></li>
                                    </ul>
                                </div>
                            </a>
                            </div>
                            <div class="col-md-3">
                            	<a href="<?php echo '?status=tolak' ?>">
                                <div class="white-box" style="border-top : solid 4px #f75b36">
                                    <h3 class="box-title">DITOLAK</h3>
                                    <ul class="list-inline two-part">
                                        <li><i class="ti-close text-danger"></i></li>
                                        <li class="text-right"><span class="counter" style="color: #686868"><?=$c_tolak?></span></li>
                                    </ul>
                                </div>
                            </a>
                            </div>
				...
				if(!empty($_GET['status'])){
					...
					<div class="alert alert-primary">
						<i class="ti-info-alt"></i> Menampilkan Usulan Pensiun yang memiliki status <?=status_text($_GET['status'])?>
					</div>
					<?php
				}
				?>
									...
									<div class="col-md-6">
										<div  style="height: 260px;display: table-cell;vertical-align: middle;width: 999px">
											<div class="usulan-div">
												<div class="text-white" style="display:inline-block;width:130px;font-size:12px;font-weight: 500;background-color: #22A7F0;padding: 5px;text-align: center;">Tanggal Pensiun</div><span style="font-weight: 300;margin-left: 10px"><?=tanggal($l->prediksi_pensiun)?></span>
											</div>
											<div class="usulan-div">
											...
											<a href="<?=base_url('verifikasi_usulan/view/'.$l->id_usulan)?>" class="fcbtn btn btn-outline btn-primary btn-1c btn-block"><i class="ti-arrow-circle-right"></i> Detail Usulan</a>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-md-12 pager">
						<?php
						if($filter_status==false&&$filter==false){
