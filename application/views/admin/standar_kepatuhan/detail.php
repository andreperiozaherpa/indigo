						...
						<div class="panel-body">
							<div class="row m-b">
								<div class="col-md-12">
									...
									?>
									<div class="form-group" style="background-color: #6003c8;border-radius: 20px;">
										<div class="row container">
											<div class="col-12">
												<h5 class="text-white" style="font-weight: bold">Apakah tersedia <?=ucwords(str_replace("_"," ", $value->name))?> ? <?php if ($detail[$value->name] == 'YA') {
											$type = 'success';
										}else{
											$type = 'danger';
										} ?>
										<small class="label label-<?=$type?>">
											<?=$detail[$value->name]?>
										</small></h5>
											</div>
										</div>
