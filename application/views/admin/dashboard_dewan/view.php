<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h4 class="page-title">Details User</h4>
		</div>
		...
		<div class="white-box">
			<div class="user-bg"> <img width="100%" height="100%" alt="user" src="<?php echo base_url(); ?>data/images/header/header2.jpg">
				<div class="overlay-box">
					<div class="col-md-3">
						<div class="user-content" <a href="javascript:void(0)"><img src="<?php echo base_url() . "data/foto/pegawai/user-default.png"; ?>" class="thumb-lg img-circle" style=" object-fit: cover;
										width: 80px;
					...
					<div class="col-md-3" style="border-right: 1px solid grey;border-left: 1px solid grey;">
						...
						<div class="user-content" style="padding-bottom:15px;">
							...
							<h6 class="text-white"><?= isset($data_by_bkd->nama_skpd) ? $data_by_bkd->nama_skpd : '-' ?></h6>
						</div>
					</div>
					<div class="col-md-3" style="border-right: 1px solid grey;">
						...
						<div class="user-content" style="padding-bottom:15px;">
							...
							<h6 class="text-white"><?= isset($data_by_bkd->nama_unit_kerja) ? $data_by_bkd->nama_unit_kerja : '-' ?></h6>
						</div>
					</div>
					<div class="col-md-3">
						<br>
						<div class="user-content" style="padding-bottom:15px;">
							...
							<h6 class="text-white"><?= isset($data_by_bkd->jabatan) ? $data_by_bkd->jabatan : '-' ?></h6>
						</div>
					</div>
		...
		<div class="col-lg-12 col-sm-12 col-xs-12">
			<div class="white-box">
				...
				<ul class="nav customtab nav-tabs" role="tablist">
					<li role="presentation" id="tabs-activebiodata1" class="tanda active"><a href="#biodata1" aria-controls="biodata" role="tab" data-toggle="tab" aria-expanded="true"><span class="visible-xs"><i class="ti-user"></i></span><span class="hidden-xs">Biodata</span></a></li>
					<li role="presentation" id="tabs-activepangkat1" class="tanda "><a href="#pangkat1" aria-controls="pangkat" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-star"></i></span> <span class="hidden-xs">Pangkat</span></a></li>
					<li role="presentation" id="tabs-activejabatan1" class="tanda "><a href="#jabatan1" aria-controls="jabatan" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-id-badge"></i></span> <span class="hidden-xs">Jabatan</span></a></li>
					<li role="presentation" id="tabs-activependidikan1" class="tanda "><a href="#pendidikan1" aria-controls="pendidikan" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-briefcase"></i></span> <span class="hidden-xs">Pendidikan</span></a></li>
					<li role="presentation" id="tabs-activelatihan1" class="tanda "><a href="#latihan1" aria-controls="latihan" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-flag-alt"></i></span> <span class="hidden-xs">Latihan</span></a></li>
					<li role="presentation" id="tabs-activeunit_kerja1" class="tanda "><a href="#unit_kerja1" aria-controls="unit_kerja" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-bookmark"></i></span> <span class="hidden-xs">Unit Kerja</span></a></li>
					<li role="presentation" id="tabs-activepenghargaan1" class="tanda "><a href="#penghargaan1" aria-controls="penghargaan" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-medall"></i></span> <span class="hidden-xs">Penghargaan</span></a></li>
					<li role="presentation" id="tabs-activeabsen1" class="tanda "><a href="#absen1" aria-controls="absen" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-check-box"></i></span> <span class="hidden-xs">Absen</span></a></li>
					<li role="presentation" id="tabs-activebahasa1" class="tanda "><a href="#bahasa1" aria-controls="bahasa" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-themify-favicon"></i></span> <span class="hidden-xs">Bahasa</span></a></li>
					<li role="presentation" id="tabs-activekeluarga1" class="tanda "><a href="#keluarga1" aria-controls="keluarga" role="tab" data-toggle="tab" aria-expanded="false"><span class="visible-xs"><i class="ti-heart"></i></span> <span class="hidden-xs">Keluarga</span></a></li>
									...
									<div class="row">
										<div class="col-md-4">
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" name="cpns_no_sk" value="<?= isset($data_pegawai->cpns_no_sk) ? $data_pegawai->cpns_no_sk : "-" ?>">
											</div>
											<!-- <div class="form-group">
									...
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="pns_no_sk" value="<?= isset($data_pegawai->pns_no_sk) ? $data_pegawai->pns_no_sk : "-" ?>">
											</div>
										</div>
									...
									<tbody>
										<?php foreach ($data_pangkat as $pangkat) : ?>
											<tr>
												...
												<td><?= isset($pangkat) ? tanggal($pangkat->tgl_sk) : "" ?></td>
												<td>
													<?php if ($pangkat->verifikasi_bkd == "true") : ?>
												...
												<td>
													<?php if ($pangkat->verifikasi_pegawai == "true") : ?>
														<span class="label label-success"><i class="ti ti-check"></i></span>
													<?php else : ?>
														<span class="label label-danger"><i class="ti ti-close"></i> </span>
													<?php endif; ?>
												</td>
												<td><a href="<?= base_url() ?>data/berkas/pangkat/<?= $user_id ?>/<?= $pangkat->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($pangkat) ? $pangkat->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($pangkat->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_pangkat<?= $pangkat->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_pangkat">Verifikasi</button>
															</form>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_pangkat<?= $pangkat->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														...
														<div class="modal-body">
															Apakah anda yakin akan membatalkan verifikasi data ini ?
														</div>
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_pangkat" value="<?= $pangkat->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_pangkat">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-waring waves-effect text-left" name="catat_pangkat">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
						...
						<div id="form_riwayat_pangkat">
							...
							<form method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="file" name="berkas" value="" required>
								</div>
								<hr>
									...
									<tbody>
										<?php foreach ($data_jabatan as $jabatan) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/jabatan/<?= $user_id ?>/<?= $jabatan->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($jabatan) ? $jabatan->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($jabatan->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_jabatan<?= $jabatan->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_jabatan">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_jabatan<?= $jabatan->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_jabatan" value="<?= $jabatan->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_jabatan">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_jabatan">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_pendidikan as $pendidikan) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/pendidikan/<?= $user_id ?>/<?= $pendidikan->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($pendidikan) ? $pendidikan->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($pendidikan->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_pendidikan<?= $pendidikan->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_pendidikan">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_pendidikan<?= $pendidikan->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_pendidikan" value="<?= $pendidikan->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_penugasan">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_pendidikan">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_diklat as $diklat) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/diklat/<?= $user_id ?>/<?= $diklat->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($diklat) ? $diklat->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($diklat->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_diklat<?= $diklat->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_diklat">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_diklat<?= $diklat->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_diklat" value="<?= $diklat->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_diklat">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_diklat">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_penataran as $penataran) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/penataran/<?= $user_id ?>/<?= $penataran->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($penataran) ? $penataran->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($penataran->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_penataran<?= $penataran->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_penataran">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_penataran<?= $penataran->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_penataran" value="<?= $penataran->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_penataran">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_penataran">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_seminar as $seminar) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/seminar/<?= $user_id ?>/<?= $seminar->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($seminar) ? $seminar->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($seminar->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_seminar<?= $seminar->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_seminar">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_seminar<?= $seminar->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_seminar" value="<?= $seminar->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_seminar">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_seminar">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_kursus as $kursus) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/kursus/<?= $user_id ?>/<?= $kursus->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($kursus) ? $kursus->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($kursus->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_kursus<?= $kursus->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_kursus">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_kursus<?= $kursus->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_kursus" value="<?= $kursus->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_kursus">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_kursus">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_unit_kerja as $unit_kerja) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/unit_kerja/<?= $user_id ?>/<?= $unit_kerja->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($unit_kerja) ? $unit_kerja->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($unit_kerja->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_unit_kerja<?= $unit_kerja->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_unit_kerja">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_unit_kerja<?= $unit_kerja->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_unit_kerja" value="<?= $unit_kerja->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_unit_kerja">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_unit_kerja">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
						...
						<div id="form_riwayat_unit_kerja">
							...
							<form method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="no_sk_awal" value="">
								</div>
								<div class="form-group">
									<label for="">No. SK Akhir</label>
									<input type="text" class="form-control" name="no_sk_akhir" value="">
								</div>
								<div class="form-group">
									<label for="">File Lampiran</label>
									<input type="file" name="berkas" value="" required>
									...
									<tbody>
										<?php foreach ($data_penghargaan as $penghargaan) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/penghargaan/<?= $user_id ?>/<?= $penghargaan->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($penghargaan) ? $penghargaan->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($penghargaan->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_penghargaan<?= $penghargaan->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_penghargaan">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_penghargaan<?= $penghargaan->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_penghargaan" value="<?= $penghargaan->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_penghargaan">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_penghargaan">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_penugasan as $penugasan) : ?>
											<tr>
												...
												<td>
													<?php if ($penugasan->verifikasi_bkd == "true") : ?>
														<span class="label label-success"><i class="ti ti-check"></i></span>
													<?php else : ?>
														<span class="label label-danger"><i class="ti ti-close"></i> </span>
													<?php endif; ?>
												...
												<td>
													<?php if ($penugasan->verifikasi_pegawai == "true") : ?>
														<span class="label label-success"><i class="ti ti-check"></i></span>
													<?php else : ?>
														<span class="label label-danger"><i class="ti ti-close"></i> </span>
													<?php endif; ?>
												</td>
												<td><a href="<?= base_url() ?>data/berkas/penugasan/<?= $user_id ?>/<?= $penugasan->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($penugasan) ? $penugasan->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($penugasan->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_penugasan<?= $penugasan->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_penugasan">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_penugasan<?= $penugasan->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_penugasan">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
						...
						<div id="form_riwayat_penugasan">
							...
							<form method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="nomer_sk" value="">
								</div>
								<div class="form-group">
									<label for="">Tgl. SK</label>
									<input type="date" class="form-control" name="tgl_sk" value="">
									...
									<tbody>
										<?php foreach ($data_cuti as $cuti) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/cuti/<?= $user_id ?>/<?= $cuti->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($cuti) ? $cuti->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($cuti->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_cuti<?= $cuti->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_cuti">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_cuti<?= $cuti->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_cuti" value="<?= $cuti->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_cuti">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_cuti">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_hukuman as $hukuman) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/hukuman/<?= $user_id ?>/<?= $hukuman->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($hukuman) ? $hukuman->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($hukuman->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_hukuman<?= $hukuman->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_hukuman">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_hukuman<?= $hukuman->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_hukuman" value="<?= $hukuman->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_hukuman">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_hukuman">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_bahasa as $bahasa) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/bahasa/<?= $user_id ?>/<?= $bahasa->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($bahasa) ? $bahasa->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($bahasa->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_bahasa<?= $bahasa->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_bahasa">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_bahasa<?= $bahasa->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_bahasa" value="<?= $bahasa->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_bahasa">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_bahasa">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_bahasa_asing as $bahasa_asing) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/bahasa_asing/<?= $user_id ?>/<?= $bahasa_asing->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($bahasa_asing) ? $bahasa_asing->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($bahasa_asing->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_bahasa_asing<?= $bahasa_asing->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_bahasa_asing">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_bahasa_asing<?= $bahasa_asing->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_bahasa_asing" value="<?= $bahasa_asing->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_bahasa_asing">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_bahasa_asing">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_pernikahan as $pernikahan) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/pernikahan/<?= $user_id ?>/<?= $pernikahan->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($pernikahan) ? $pernikahan->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($pernikahan->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_pernikahan<?= $pernikahan->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_pernikahan">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_pernikahan<?= $pernikahan->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_pernikahan" value="<?= $pernikahan->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_pernikahan">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_pernikahan">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_anak as $anak) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/anak/<?= $user_id ?>/<?= $anak->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($anak) ? $anak->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($anak->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_anak<?= $anak->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_anak">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_anak<?= $anak->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_anak" value="<?= $anak->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_anak">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_anak">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_orangtua as $orangtua) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/orangtua/<?= $user_id ?>/<?= $orangtua->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($orangtua) ? $orangtua->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($orangtua->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_orangtua<?= $orangtua->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_orangtua">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_orangtua<?= $orangtua->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_orangtua" value="<?= $orangtua->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_orangtua">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_orangtua">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
									...
									<tbody>
										<?php foreach ($data_mertua as $mertua) : ?>
											<tr>
												...
												<td><a href="<?= base_url() ?>data/berkas/mertua/<?= $user_id ?>/<?= $mertua->berkas ?>" title="Download" download><i class="ti ti-download"></i></a> </td>
												<td><?= isset($mertua) ? $mertua->catatan_verifikasi : "" ?></td>
												<td>
													<?php if ($mertua->verifikasi_pegawai == null) : ?>
													...
													<?php else : ?>
														<button type="submit" class="btn btn-warning btn-sm btn-rounded" data-toggle="modal" data-target="#unverif_mertua<?= $mertua->id ?>"> <i class="ti-back-left"></i> </button>
													<?php endif; ?>
												</td>
											</tr>
											<!-- verif row -->
													...
													<div class="modal-content">
														...
														<div class="modal-footer">
															<form method="post">
																...
																<button type="submit" class="btn btn-info waves-effect text-left" name="verif_mertua">Verifikasi</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
											...
											<!-- unverif row -->
											<div class="modal fade bs-example-modal-sm" id="unverif_mertua<?= $mertua->id ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
												<div class="modal-dialog modal-sm">
													<div class="modal-content">
														<div class="modal-header" style="background-color:#f0ad4e">
															<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
														...
														<div class="modal-footer">
															<form method="post">
																<input type="hidden" name="id_mertua" value="<?= $mertua->id ?>">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="unverif_mertua">Unverif</button>
															</form>
															<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
														</div>
													</div>
												...
												<div class="modal-dialog modal-md">
													<div class="modal-content">
														...
														<form method="post">
															...
															<div class="modal-footer">
																<button type="submit" class="btn btn-warning waves-effect text-left" name="catat_mertua">Kirim</button>
																<button type="button" class="btn btn-default waves-effect text-left" data-dismiss="modal">Batal</button>
															</div>
														</form>
													</div>
