      <div class="container-fluid">
        <div class="row bg-title">
          <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Ref. Jurusan</h4>
          </div>
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
              <ol class="breadcrumb">
                <li class="active">Ref. Jurusan</li>
              </ol>
              </div>
            </div>
<div class="col-md-4 col-xs-12">
                <div class="x_panel white-box">
                  ...
                  <div class="x_content">
                    <br />
                    <form class="form-horizontal form-label-left" method="post" action="<?php echo base_url();?>ref_jurusan/add">
                  ...
                  <div class="x_content">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="<?php echo base_url(). "ref_jurusan/edit/".$key->id_jurusan ;?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                           <a   title='Delete' onclick='delete_(<?php echo $key->id_jurusan;?>)' class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
					...
					<div class='row'>
						...
						<?php
							...
							$config['base_url'] = base_url(). 'ref_jurusan/index/';
...
<script type="text/javascript">
	function delete_(id)
	{
		if (confirm('Apakah anda yakin akan menghapus data?')){
			window.location.href= "<?= base_url();?>ref_jurusan/delete/"+id;
		}
	}
</script>