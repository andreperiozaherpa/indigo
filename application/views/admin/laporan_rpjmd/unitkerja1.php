...
<div class="container-fluid">
	...
	<?php
		...
		$unit0 = $CI->ref_unit_kerja_model->getUnit(array('level_unit_kerja' => -1));
...
<?php
$unit = $CI->ref_unit_kerja_model->getUnit(null,"level_unit_kerja in ('-1','0') ");
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						if($row->level_unit_kerja==0){
							$paramS = array(
								'sasaran_strategis.id_unit'	=> $row->id_unit_kerja,
								'sasaran_strategis.tahun'		=> $tahun_rkt
							);
						...
						elseif($row->level_unit_kerja==1){
							$paramS = array(
								'sasaran_program.id_unit'	=> $row->id_unit_kerja,
								'sasaran_program.tahun'		=> $tahun_rkt
							);
							...
							$paramS = array(
								'sasaran_kegiatan.id_unit'	=> $row->id_unit_kerja,
								'sasaran_kegiatan.tahun'		=> $tahun_rkt
							);
				...
				<div class="modal-footer">
					<a class="btn btn-default" href="'.base_url().'laporan_rpjmd/unitkerja2/'.$row->id_unit_kerja.'/'.$tahun_rkt.'" target="blank">Detail Cascading</a>				
					<a class="btn btn-default" href="'.base_url().'laporan_rpjmd/detail_unitkerja/'.$row->id_unit_kerja.'/'.$tahun_rkt.'" target="blank">Detail unit kerja</a>
