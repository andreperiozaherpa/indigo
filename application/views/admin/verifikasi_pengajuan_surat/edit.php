                    ...
                    <form method="post" enctype="multipart/form-data">
						...
						<div class="top-form" style="display:none">
							...
							<div class="form-group">
								...
								<input type="file" id="input-file-disable-remove" name="surat_usulan_opd" data-show-remove="false" data-default-file="<?=base_url('data/pengajuan_surat/'.$pengajuan_surat->surat_usulan_opd)?>" data-max-file-size="2M" data-allowed-file-extensions="pdf" class="dropify" required/>
							...
							<div class="form-group">
								...
								<input type="file" name="sk_tidak_dijatuhi_hukuman_disiplin" data-show-remove="false" data-default-file="<?=base_url('data/pengajuan_surat/'.$pengajuan_surat->sk_tidak_dijatuhi_hukuman_disiplin)?>" id="input-file-disable-remove" data-max-file-size="2M" data-allowed-file-extensions="pdf" class="dropify" required/>
								<small style="color:red;font-weight:bold;">Format file PDF</small>
							</div>
							<div class="form-group">
								<label for="">SK Pangkat Terakhir.</label>
								<input type="file" name="sk_pangkat_terakhir" data-show-remove="false" data-default-file="<?=base_url('data/pengajuan_surat/'.$pengajuan_surat->sk_pangkat_terakhir)?>" id="input-file-disable-remove" data-max-file-size="2M" data-allowed-file-extensions="pdf" class="dropify" required/>
								<small style="color:red;font-weight:bold;">Format file PDF</small>
							</div>
