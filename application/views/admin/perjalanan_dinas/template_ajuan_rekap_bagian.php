...
<body>
    <div class="judul" style="position:relative">
        <div>
            <span style="display: block;">DAFTAR AJUAN REKAPITULASI PERJALANAN DINAS <?= !empty($jenis_perjalanan) ? strtoupper(normal_string($jenis_perjalanan)) : null ?></span>
            <span style="display: block;"><?= strtoupper($uk->nama_unit_kerja) ?> KABUPATEN SUMEDANG</span>
    ...
    <table border="1" class="utama">
        ...
        <tbody>
            <?php
            $no = 1;
            $jumlah_transport_t = 0;
            $jumlah_refresentasi_t = 0;
            $jumlah_uh_t = 0;
            $jumlah_total_uh_t = 0;
            $jumlah_bp_t = 0;
            $jumlah_total_bp_t = 0;
            ...
            ?>
                    <tr>
                        ...
                        if ($k == 0) {
                        ?>
                            <td rowspan="<?= count($pembiayaan) ?>" style="text-align: center;"><?= $no ?></td><?php
                                                                                                            }
                                                                                                                ?>
                ...
                <tr style="background-color: #F6F6F6;">
                    <td></td>
                    <td colspan="4" style="font-weight: bold;">Nomor Rekening : <?= $detail->nomor_rekening ?></td>
            ...
            <?php
             $jumlah_transport_t += $jumlah_transport;
             $jumlah_refresentasi_t += $jumlah_refresentasi;
             $jumlah_uh_t += $jumlah_uh;
             $jumlah_total_uh_t += $jumlah_total_uh;
             $jumlah_bp_t += $jumlah_bp;
             $jumlah_total_bp_t += $jumlah_total_bp;
             $jumlah_total_t += $jumlah_total;
                $no += 1;
            } ?>
            ...
            <tr style="background-color: #cdcdcd;">
                    ...
                    <td style="font-weight: bold;text-align: right;"><?= number_format($jumlah_transport_t, 0, ',', '.') ?></td>
                    <td style="font-weight: bold;text-align: right;"><?= number_format($jumlah_refresentasi_t, 0, ',', '.') ?></td>
                    <td></td>
                    <td style="font-weight: bold;text-align: right;"><?= number_format($jumlah_uh_t, 0, ',', '.') ?></td>
                    <td style="font-weight: bold;text-align: right;"><?= number_format($jumlah_total_uh_t, 0, ',', '.') ?></td>
                    <td></td>
                    <td style="font-weight: bold;text-align: right;"><?= number_format($jumlah_bp_t, 0, ',', '.') ?></td>
                    <td style="font-weight: bold;text-align: right;"><?= number_format($jumlah_total_bp_t, 0, ',', '.') ?></td>
                    <td style="font-weight: bold;text-align: right;"><?= number_format($jumlah_total_t, 0, ',', '.') ?></td>
                </tr>
        </tbody>
    </table>
