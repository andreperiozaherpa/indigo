							...
							<div class="overlay-box">
								...
								<div class="col-md-3">
									...
									<div class="user-content" style="padding-bottom:15px;">
										...
										<h6 class="text-white"><?=isset($data_by_bkd->nama_jabatan) ? $data_by_bkd->nama_jabatan : '-' ?></h6>
									</div>
								</div>
																		...
																		<tbody>
																			<?php foreach ($data_pangkat as $pangkat): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/pangkat/<?=$this->uri->segment(3)?>/<?=$pangkat->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($pangkat) ? $pangkat->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($pangkat->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_jabatan as $jabatan): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/jabatan/<?=$this->uri->segment(3)?>/<?=$jabatan->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($jabatan) ? $jabatan->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($jabatan->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_pendidikan as $pendidikan): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/pendidikan/<?=$this->uri->segment(3)?>/<?=$pendidikan->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($pendidikan) ? $pendidikan->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($pendidikan->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_diklat as $diklat): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/diklat/<?=$this->uri->segment(3)?>/<?=$diklat->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($diklat) ? $diklat->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($diklat->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_penataran as $penataran): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/penataran/<?=$this->uri->segment(3)?>/<?=$penataran->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($penataran) ? $penataran->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($penataran->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_seminar as $seminar): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/seminar/<?=$this->uri->segment(3)?>/<?=$seminar->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($seminar) ? $seminar->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($seminar->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_kursus as $kursus): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/kursus/<?=$this->uri->segment(3)?>/<?=$kursus->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($kursus) ? $kursus->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($kursus->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_unit_kerja as $unit_kerja): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/unit_kerja/<?=$this->uri->segment(3)?>/<?=$unit_kerja->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($unit_kerja) ? $unit_kerja->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($unit_kerja->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_penghargaan as $penghargaan): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/penghargaan/<?=$this->uri->segment(3)?>/<?=$penghargaan->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($penghargaan) ? $penghargaan->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($penghargaan->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_penugasan as $penugasan): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/penugasan/<?=$this->uri->segment(3)?>/<?=$penugasan->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($penugasan) ? $penugasan->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($penugasan->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_cuti as $cuti): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/cuti/<?=$this->uri->segment(3)?>/<?=$cuti->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($cuti) ? $cuti->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($cuti->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_hukuman as $hukuman): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/hukuman/<?=$this->uri->segment(3)?>/<?=$hukuman->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($hukuman) ? $hukuman->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($hukuman->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_bahasa as $bahasa): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/bahasa/<?=$this->uri->segment(3)?>/<?=$bahasa->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($bahasa) ? $bahasa->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($bahasa->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_bahasa_asing as $bahasa_asing): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/bahasa_asing/<?=$this->uri->segment(3)?>/<?=$bahasa_asing->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($bahasa_asing) ? $bahasa_asing->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($bahasa_asing->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_pernikahan as $pernikahan): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/pernikahan/<?=$this->uri->segment(3)?>/<?=$pernikahan->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($pernikahan) ? $pernikahan->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($pernikahan->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_anak as $anak): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/anak/<?=$this->uri->segment(3)?>/<?=$anak->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($anak) ? $anak->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($anak->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_orangtua as $orangtua): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/orangtua/<?=$this->uri->segment(3)?>/<?=$orangtua->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($orangtua) ? $orangtua->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($orangtua->verifikasi_bkd == null): ?>
																		...
																		<tbody>
																			<?php foreach ($data_mertua as $mertua): ?>
																				<tr>
																						...
																						<td><a href="<?=base_url()?>data/berkas/mertua/<?=$this->uri->segment(3)?>/<?=$mertua->berkas?>" title="Download" download><i class="ti ti-download"></i></a> </td>
																						<td><?=isset($mertua) ? $mertua->catatan_verifikasi : "" ?></td>
																						<td>
																							<?php if ($mertua->verifikasi_bkd == null): ?>
