            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Semua Gambar Header</h4>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title"><a href="<?php echo base_url();?>manage_media/add_img_header" class="btn btn-primary btn-sm waves-effect waves-light" type="button"><span class="btn-label"><i class="fa fa-plus"></i></span>Tambah Baru</a></h3>
...
<script type="text/javascript">
	function delete_(id)
	{
		swal({   
        	...
        	window.location = "<?php echo base_url();?>manage_media/delete_img_header/"+id;
