			...
			<div class="panel-body">
				...
				<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?= $this->security->get_csrf_hash();?>" />
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name='url' value='<?php echo $url;?>' placeholder="">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							...
							<div class='member-img'>
								<img src='".base_url()."data/images/banner/$gambar' class='img-rounded' style='max-width:200px' />
								
							</div><br>
							";?>
							<input type="file"  name='userfile' class="class="dropify" id="input-file-now-custom-3" data-label="<i class='glyphicon glyphicon-file'></i> Browse" />
							<p>
								Max : 2000px | 2MB
							</p>
						</div>
