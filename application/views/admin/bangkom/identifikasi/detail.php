<div class="container-fluid">
	...
	<div class="row bg-title">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<h4 class="page-title">Form Penilaian Kompetensi Bawahan</h4>
    </div>

		</div>

<form method="post" action="<?=base_url();?>bangkom/identifikasi/submit_identifikasi">
  <div class="row">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                          <div class='checkbox m-t-0 m-b-0'>
                            <input <?= ($detail->status==9) ? "" : "disabled" ;?> type='checkbox'  <?= ($row->status=="Y") ? "checked" :"" ;?> class='checkbox' value='<?=$row->id_indikator;?>' id='checkbox<?=$no;?>' name='centang_indikator[]' >
...
<?php
if($dt_diklat->num_rows()>0 && $detail->status==1):?>
<div class="col-md-12">
    <div class="white-box">
      <div class="row">
      <div class="col-xs-12">
...
<?php
if(!empty($training) && $training->num_rows()>0 && $detail->status==9):?>
<div class="col-md-12">
    <div class="white-box">
      <div class="row">
      <div class="col-xs-12">
         <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><strong>Rekomendasi Pengembangan Kompetensi PNS</strong></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body table-responsive">
               <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php foreach ($training->result() as $key => $row) {?>
                      <tr>
                        <td class="text-center"><?= ($key+1) ;?></td>
                        <td><label for='checkbox_<?=$key;?>'><?=$row->nama_diklat;?></label></td>
                        <td><?=$row->kategori_diklat;?> <?= ($row->jenis_pelatihan) ? " - ".$row->jenis_pelatihan : "" ;?></td>
                        <td class="text-center">
                          <div class='checkbox m-t-0 m-b-0'>
                            <input  type='checkbox'  class='checkbox' value='<?=$row->id_diklat;?>' id="checkbox_<?=$key;?>" name='centang[]' >
         ...
         <button type="submit" value="submit" class="btn pull-right mt-3  btn-primary">Identifikasi</button>
         <!-- /.box -->
      </div>
          ...
          <div class="box-footer">
             <div class="row">
                <div class="col-md-6">
                  ...
                  <a href="<?=base_url();?>bangkom/identifikasi" class="btn btn-default">Kembali</a>
                </div>
             </div>
          </div>
       </div>
