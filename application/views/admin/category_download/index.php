<div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Semua Kategori E-Modul</h4>
                    </div>
 ...
 <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title"><a href="<?php echo base_url();?>manage_category_download/add" class="btn btn-primary btn-sm waves-effect waves-light" type="button"><span class="btn-label"><i class="fa fa-plus"></i></span>Tambah Baru</a></h3>
			...
			foreach ($query as $row) {
				echo"
					<tr>
						...
						<td>
							<a href='".base_url()."manage_category_download/edit/$row->category_id' class='btn-xs' title='Edit' data-toggle=\"tooltip\" data-original-title=\"Edit\">
										
										<i class=\"fa fa-pencil text-inverse m-r-10\"></i> 
									</a>
									<a class='btn-xs' title='Delete'  onclick='delete_(\"$row->category_id\")' data-toggle=\"tooltip\" data-original-title=\"Close\">
...
<script type="text/javascript">
	function delete_(id)
	{
		swal({   
        	...
        	window.location = "<?php echo base_url();?>manage_category_download/delete/"+id;
