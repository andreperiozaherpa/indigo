<div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Kategori E-Modul</h4>
                    </div>
			...
			<div class="panel-body">
				...
				<form role="form" class="form-horizontal " method='post' enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type='hidden'  value='<?php echo $category_download_name;?>'  name='old_category_download' />
							<input type="text" id='category_download_name' value='<?php echo $category_download_name;?>' class="form-control" name='category_download_name' placeholder="">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-2">
							...
							<select name="category_download_status" class="form-control" data-first-option="false">
								...
								<?php
									if ($category_download_status=="Active"){
										echo "
...
$('#category_download_name').on('input', function() {
    var permalink;
    // Trim empty space
