...
class Parser
{
    ...
    public function fromHTML($html, $wrapContent = true, $styles = []) {
        ...
        $html = str_replace("<w:p><w:r><w:t xml:space='preserve'>", "<w:p><w:r><w:rPr><w:rFonts w:asciiTheme=\"majorBidi\" w:hAnsiTheme=\"majorBidi\" w:cstheme=\"majorBidi\" /><w:sz w:val=\"24\" /><w:szCs w:val=\"24\" /></w:rPr><w:t xml:space='preserve'>", $html);
        // $html = str_replace("", "", $html);
        // $html = str_replace("</w:t></w:r></w:p>", "", $html);
        return $html;
