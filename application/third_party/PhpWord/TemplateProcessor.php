...
class TemplateProcessor
{
     ...
     * @param int $limit
     */
    public function setValue($search, $replace, $limit = null,$acceptXML=false)
    {
        if(is_null($limit)){
        ...
        $this->tempDocumentHeaders = $this->setValueForPart($search, $replace, $this->tempDocumentHeaders, $limit,$acceptXML);
        $this->tempDocumentMainPart = $this->setValueForPart($search, $replace, $this->tempDocumentMainPart, $limit,$acceptXML);
        $this->tempDocumentFooters = $this->setValueForPart($search, $replace, $this->tempDocumentFooters, $limit,$acceptXML);
    }
    ...
    public function setImageValue($search, $replace)
    {
        ...
        $delete = $this->zipClass->deleteName('word/media/'.$search);
        if (!$delete) {
            return false;
        }
     ...
     * @return string
     */
    protected function setValueForPart($search, $replace, $documentPartXML, $limit,$acceptXML='')
    {
