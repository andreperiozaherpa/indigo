...
$(document).ready(function(){
	...
	$('#menulogo').removeClass('faded');


    // Smooth scrolling using scrollto.js
	$('#lighting a, a.listing-address, .star-rating a').on('click', function(e) {
        e.preventDefault();
        $('html,body').scrollTo(this.hash, this.hash, { gap: {y: -20} }); 
    });

	$("#lighting li:first-child a, a.add-review-btn, a[href='#add-review']").on('click', function(e) {
        e.preventDefault();
	...
	$(window).on('load resize', function() {
		var aChildren = $("#lighting li").children();
		var aArray = [];
