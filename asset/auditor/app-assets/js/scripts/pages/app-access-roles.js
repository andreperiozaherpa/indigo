$(function () {
  ...
  roleAdd.on("click", function () {
    roleTitle.text("Tambah Penugasan"); // reset text
  });
  roleEdit.on("click", function () {
    roleTitle.text("Ubah Penugasan");
  });

  // On edit role click, update text
  var pkptEdit = $(".pkpt-edit-modal"),
    pkptAdd = $(".add-new-pkpt"),
    roleTitle = $(".role-title");

  pkptAdd.on("click", function () {
    roleTitle.text("Tambah PKPT"); // reset text
  });
  pkptEdit.on("click", function () {
    roleTitle.text("Ubah PKPT");
  });
});
