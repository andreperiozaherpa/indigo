...
$base_url="http://imcreativestudio.com"; //url base of site if you want only relative url leave empty
$upload_dir = '/data/upload/'; // path from base_url to upload base dir
$current_path = '../../../../data/upload/'; // relative path from filemanager folder to upload files folder
$MaxSizeUpload=50; //Mb
